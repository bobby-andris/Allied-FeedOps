-- Migration 031: Backfill Job Infrastructure Tables
-- (Re-numbered from 026 to resolve naming conflict with existing 026_* migrations)
--
...
--
-- Original: 2026-02-13, applied as 031 on 2026-02-19 (026 naming conflict)
...
CREATE INDEX IF NOT EXISTS idx_backfill_jobs_type ON backfill_jobs (job_type, created_at DESC);
...
CREATE TABLE IF NOT EXISTS backfill_job_errors (
...
CREATE INDEX IF NOT EXISTS idx_backfill_job_errors_job ON backfill_job_errors (job_id, created_at DESC);
