...
**Generated:** 2026-02-03T18:32:59.736652
**Status:** APPROVED
...
**Description (662 chars):**
```
This 18.75-inch shower basket in Matte Black adds bold, refined contrast while keeping bath essentials organized and off the shower floor. Solid brass construction and rust-proof, heavy-gauge ventilated wires drain quickly for corrosion-free performance in daily use. The wall mount design saves space and creates a clean, built-in look, enhanced by a concealed screw mounting system. Sized at 18.75 x 2.25 x 4.13 inches, this oval combination basket holds shampoo, soap, and accessories with timeless traditional style. Choose from 28 finishes to coordinate with classic bath accessories and traditional bathroom hardware. Backed by a limited lifetime warranty.
```
...
**Token Usage:** Prompt tokens: 8081, Completion tokens: 1539, Cached tokens: 7680 (95% cache hit)
**Estimated Cost:** $0.028968
...
- Basket includes concealed screw mounting hardware. (source: bullet_2=Concealed screw mounting hardware makes installation easy)
- Ventilated wires are rust proof solid brass. (source: bullet_3=Rust Proof Solid Brass Wires)
- Finish described includes Matte Black. (source: current_description=Matte Black, a rich black satin-like finish that makes a bold, dramatic statement)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 88.25% | 87.50% | 87.50% | 92.50% |  |
| 2 | 0 | 83.25% | 82.50% | 82.50% | 87.50% |  |
| 3 | 1 | 82.62% | 80.00% | 85.00% | 92.50% |  |

### Soft-Gate Warnings (selected candidate)

- Google: Few measurable specs detected

Soft-gate penalty: 1.05
