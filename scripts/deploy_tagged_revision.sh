...
SERVICE_URL="https://${REVISION_TAG}---${SERVICE_NAME}-6253381786.${REGION}.run.app"
...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --set-env-vars "GOOGLE_ADS_CUSTOMER_ID=6253381786,GOOGLE_ADS_API_ENABLED=1,FEEDOPS_ENV_CONTRACT_STRICT=1" \
