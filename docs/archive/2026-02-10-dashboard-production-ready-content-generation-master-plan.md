...
| 2026-02-11 | Phase 7 | Master SKU alias hardening for hyphen/slash variants across generation, regenerate, publish, variant expansion, and monitoring paths | DONE | Routes/modules touched: `src/feedops/api/main.py`, `src/feedops/api/hybrid_generation.py`, `src/feedops/api/supabase_loader.py`, `src/feedops/api/multi_sku_detection.py`, `src/feedops/api/performance_baseline.py`, `src/feedops/api/search_insights.py`, `dashboard/src/app/api/sku-selection/generate/route.ts`, `dashboard/src/app/api/sku-selection/generate-hybrid/route.ts`, `dashboard/src/app/api/regenerate/route.ts`, `dashboard/src/app/api/regenerate/batch/route.ts`, `dashboard/src/app/api/regenerate/revert/route.ts`, `dashboard/src/app/api/publish/sku/route.ts`, `dashboard/src/app/api/publish/google/route.ts`, `dashboard/src/app/api/publish/shopify/route.ts`, `dashboard/src/lib/publishing/expand-variants.ts`; tests: `.venv/bin/pytest -q tests/api/test_master_sku_alias_resolution.py tests/api/test_multi_sku_detection.py tests/api/test_main_master_sku_alias_runtime.py tests/api/test_dashboard_master_sku_alias_contract.py tests/api/test_master_sku_alias_additional_runtime.py` (pass: `29 passed`), `.venv/bin/pytest -q` (pass: `451 passed, 1 skipped`), `RUN_SUPABASE_CANARY=1 bash scripts/verify_phase_0.sh` (pass: `SUPABASE_CANARY_OK`, `catalog_count=75770`, `probe_sku=1031/30`, `probe_variant_count=28`, `prompt_hash=530a11ec32d54c46`, dashboard lint/build `OK`); representative SKU alias verified in tests: `WP-2TB-16-GAL` -> canonical `WP-2TB/16-GAL` |
