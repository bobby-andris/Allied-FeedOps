...
Plans:
- [ ] 09-01-PLAN.md — Remove 8 orphan functions and re-exports (DEAD-01)
- [ ] 09-02-PLAN.md — Remove FEEDOPS_VARIANT_AT_LLM_TIME feature flag block (DEAD-05)
...
| 11. Test-Import Cleanup and Re-export Removal | 1/2 | In Progress|  | - |
