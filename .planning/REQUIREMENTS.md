...
- [ ] **GOOG-01**: Deep research into Google Shopping ranking factors — what signals drive product surfacing in Shopping results (feed quality, bid strategy, seller ratings, product data completeness, structured data, historical performance, landing page quality)
...
- [ ] **GOOG-03**: Generate actionable checklist of Google Shopping optimization factors with priority ranking — which factors are within feed control vs require account-level changes
