...
**Generated:** 2026-01-29T10:38:25.624085
**Status:** APPROVED
...
**Title (90 chars):**
```
Multi Hook, 6 Position Wall Mount, 15.5-Inch Solid Brass, Mercury Collection, Allied Brass
```

**Description (1032 chars):**
```
Stop piling towels and robes on the counter—create a dedicated, wall-mounted spot for everyday bathroom essentials. This Mercury Collection multi hook adds six hanging positions in one streamlined piece, keeping robes, towels, and jackets organized while saving space.

Highlights:
- Keep busy bathrooms organized with 6 hanging positions for towels, robes, and more
- Maintain a clean, finished look with concealed screw mounting hardware
- Use wall space efficiently with a wall mount design that frees up floor and counter space
- Count on enduring construction crafted from solid brass materials
- Coordinate your bath with the Mercury Collection for matching Mercury, transitional bathroom hardware
...
**Token Usage:** Prompt tokens: 5992, Completion tokens: 1383
**Estimated Cost:** $0.029848
...
- 6 position multi hook from the Mercury Collection (source: current_title=Mercury Collection 6 Position Tie and Belt Rack)
...
- 4 inches (source: product_width=4 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 77.67% | 76.67% | 73.33% | 86.67% |  |
| 2 | 0 | 83.67% | 86.67% | 80.00% | 73.33% | shopify_title must end with Allied Brass |
| 3 | 2 | 82.33% | 83.33% | 80.00% | 80.00% | bing_title must end with Allied Brass |
