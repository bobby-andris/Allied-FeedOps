...
**Generated:** 2026-01-30T14:51:37.717566
**Status:** APPROVED
...
**Title (87 chars):**
```
Robe Hook, 2-Inch Wall Mount Solid Brass Bathroom Hook, Malibu Collection, Allied Brass
```

**Description (602 chars):**
```
Robe hook with 2 in L x 2 in H and 2.64 in projection for bathroom robe and towel hanging. Wall mount hook in brass with contemporary Malibu collection styling; solid brass construction and color coordinated mounting hardware included. Supports up to 2 lb and ships at 0.5 lb product weight. Assembly required: no. Designed as designer bathroom hardware for contemporary bath accessories and statement bath accessories; coordinate with matching Malibu pieces for a cohesive look. Available in a wide variety of lifetime designer finishes and covered by a limited lifetime warranty. Allied Brass Malibu.
```
...
**Token Usage:** Prompt tokens: 6437, Completion tokens: 1433, Cached tokens: 5632 (87% cache hit)
**Estimated Cost:** $0.026399
...
- Product type: robe hook (source: current_title=Malibu Robe Hook)
- Collection: Malibu (source: collection=Malibu)
- Mounting type: Wall Mount (source: mounting_type=Wall Mount)
- Material: Brass (source: material=Brass)
- Constructed of solid brass materials (source: current_description=The Malibu Robe Hook is constructed of the finest solid brass materials to provide a sturdy hook for your robes and towels.)
- Dimensions: 2 in L x 2 in H x 2.64 in W (source: current_description=Product dimensions, in. (LxHxW): 2x2x2.64)
- Projection: 2.64 in (source: projection=2.64 in)
...
- Product weight: 0.5 lb (source: product_weight=0.5 lb)
- Contemporary style (source: style=Contemporary)
- Available in a wide variety of lifetime designer finishes (source: bullet_2=Available in a wide variety of lifetime designer finishes)
- 2-Inch (source: product_length=2 in)
- 2.64 in (source: product_width=2.64 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 91.00% | 90.00% | 93.33% | 93.33% |  |
| 2 | 2 | 90.00% | 90.00% | 86.67% | 93.33% |  |
| 3 | 0 | 88.67% | 86.67% | 93.33% | 93.33% |  |
