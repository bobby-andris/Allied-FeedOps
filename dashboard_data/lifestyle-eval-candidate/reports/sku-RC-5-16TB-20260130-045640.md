...
**Generated:** 2026-01-30T04:56:40.203827
**Status:** APPROVED
...
**Title (94 chars):**
```
Glass Shelf With Towel Bar, 16 X 5-Inch Wall Mount, Solid Brass & Tempered Glass, Allied Brass
```

**Description (685 chars):**
```
Glass shelf with integrated towel bar, 16 x 5 inches, wall mount design with tempered beveled-edge glass (3/8-inch thick) and solid brass hardware for bathroom storage and towel hanging. Triple tier shelf format adds vertical organization for toiletries, decor, and daily essentials while keeping towels within reach. Concealed screw mounting creates a clean, finished look. Overall size 16 in length x 5 in depth x 18 in height; supports up to 6 lb. Includes glass shelf and all installation hardware (#8 x 1 1/4" screws). Traditional style accessory for traditional bathroom hardware, classic bath accessories, and heritage bathroom fixtures. Limited lifetime warranty. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6411, Completion tokens: 1519, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.030245
...
- Product type is a triple tier glass shelf with an integrated towel bar. (source: current_title=Triple Tiered Glass Shelf with Integrated Towel Bar)
...
- Glass is tempered and 3/8-inch thick (0.38 in). (source: thickness=0.38 in)
- Hardware material is brass / solid brass materials. (source: bullet_1=Crafted from the finest solid brass materials)
- Overall dimensions are 16 in length x 5 in width (depth) x 18 in height. (source: current_description=Length, in Depth, in Height, in Weight, lbs 16 Inch 16 5 18 12.8)
...
- Available finishes include multiple options (28 listed). (source: available_finishes=Antique Brass, Antique Bronze, Brushed Bronze, Matte Black, Antique Copper, Matte Gray, Oil Rubbed Bronze, Polished Brass, Polished Chrome, Antique Pewter, Polished Nickel, Satin Brass, Satin Chrome, Satin Nickel, Unlacquered Brass, Venetian Bronze, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
...
| 2 | 1 | 80.00% | 80.00% | 83.33% | 76.67% | shopify_title must end with Allied Brass |
