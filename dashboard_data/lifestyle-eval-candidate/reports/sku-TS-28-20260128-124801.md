...
**Generated:** 2026-01-28T12:48:01.349661
**Status:** APPROVED
...
**Title (107 chars):**
```
Toilet Paper Stand 26-Inch Solid Brass Freestanding European Style | Best Sellers Collection | Allied Brass
```

**Description (902 chars):**
```
Need a toilet paper holder where wall space is limited? This freestanding toilet paper stand adds convenient roll storage right beside the toilet, with European styling for quick, easy roll changes.

Highlights:
- Place it anywhere you need it: freestanding design is ideal for bathrooms where you don’t want to drill into walls
- Keep it steady on the floor: heavy base is designed to help prevent tipping
- Change rolls fast: European-style hook makes swapping a roll quick and easy
- Coordinate your space: part of the Best Sellers Collection for a cohesive look with transitional bathroom hardware and versatile bath accessories
- Built for lasting use: crafted from solid brass and offered in multiple designer finish options

Specs & Details:
- Product dimensions (L x H x W): 6.75 in x 26 in x 5.5 in
...
**Image URL:** https://cdn.shopify.com/s/files/1/0287/8658/9828/products/TS28-ABR.jpg?v=1666558061
...
| gtin | 013895238199 | gtin |
| upc | 013895238199 | upc |
| main_image_url | https://cdn.shopify.com/s/files/1/0287/8658/9828/products/TS28-ABR.jpg?v=1666558061 | main_image_url |
...
| design_intent_keywords | best sellers collection, transitional bathroom hardware, versatile bath accessories | enrichment_keywords |
...
- Freestanding European style toilet tissue holder/stand. (source: current_title=Free Standing European Style Toilet Tissue Holder)
- Designed for bathrooms where wall space is at a premium. (source: current_description=This toilet tissue stand is a great product when wall space is at a premium.)
- Crafted from solid brass materials. (source: current_description=Crafted from the finest solid brass materials)
- Heavy base designed to help prevent tipping. (source: current_description=Heavy base will help prevent tipping)
...
- Shipping weight is 6 lb. (source: current_description=Shipping weight, lbs: 6)
- Includes a Limited Lifetime Warranty. (source: current_description=Limited Lifetime Warranty)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 57.67% | 56.67% | 60.00% | 60.00% |  |
| 2 | 1 | 56.67% | 56.67% | 56.67% | 56.67% |  |
| 3 | 2 | 57.17% | 56.67% | 56.67% | 60.00% | google_description missing 2 description term(s); found 1 |
