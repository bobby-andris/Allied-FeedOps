...
**Generated:** 2026-01-29T02:31:07.863369
**Status:** APPROVED
...
**Title (101 chars):**
```
Wall-Mounted Soap Dish, 4.5 X 3 X 3.5-Inch, Solid Brass, Brass Soap Dishes Collection, | Allied Brass
```

**Description (854 chars):**
```
Clear countertop clutter and keep bar soap within easy reach with a wall-mounted soap dish designed for everyday bathroom use.

Highlights:
- Keep surfaces cleaner: wall mount installation lifts soap off the counter and away from standing water
- Built for long-term use: solid brass construction with a lifetime finish designed to never rust
- Coordinate your look: part of the Brass Soap Dishes collection for a cohesive set of versatile bath accessories
- Fits transitional spaces: classic, balanced styling suited to transitional bathroom hardware
...
- Lifetime finish designed to never rust. (source: current_description=provided with a lifetime finsh to insure products will never rust)
...
| 2 | 2 | 74.33% | 73.33% | 80.00% | 73.33% |  |
| 3 | 0 | 66.67% | 66.67% | 66.67% | 66.67% | bing_title must end with Allied Brass |
