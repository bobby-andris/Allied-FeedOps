...
**Generated:** 2026-01-30T04:29:30.744088
**Status:** APPROVED
...
**Title (91 chars):**
```
Towel Bar, 30-Inch Wall Mount Solid Brass Straight Bar, Carolina Collection -, Allied Brass
```

**Description (662 chars):**
```
30-inch wall mount towel bar with solid brass construction for bathroom towel storage and drying. Straight bar design with 30 in center-to-center sizing, 0.75 in diameter, and concealed screw mounting for a clean traditional look. Includes towel bar, mounting plates, and all installation hardware; uses #8 x 1 1/4 in screws. Wall-mounted installation saves space and supports up to 10 lb. Finish-neutral MasterSKU with multiple designer finish options available. Limited Lifetime Warranty. Ideal for traditional bathroom hardware and classic bath accessories; coordinate matching Carolina pieces for heritage bathroom fixtures. Allied Brass Carolina collection.
```
...
**Token Usage:** Prompt tokens: 6428, Completion tokens: 1545, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.030639
...
- Product type is a towel bar with a straight bar design. (source: category=Towel Bars)
- Product type is a towel bar with a straight bar design. (source: shape=straight bar)
- Wall mount mounting type. (source: mounting_type=Wall mount)
- Made from brass materials. (source: material=Brass)
...
- Carolina collection context is Traditional/Classic with classical elegance and timeless styling. (source: collection_context=Carolina (Traditional/Classic) - classical elegance, timeless)
- Overall dimensions for the 30 Inch size are 30 length x 2 depth x 3.5 height. (source: current_description=Length, in Depth, in Height, in Weight, lbs 18 Inch 20 2 3.5 2.4 24 Inch 26 2 3.5 3.2 30 Inch 30 2 3.5 3.2 36 Inch 36 2 3.5 4)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 84.33% | 83.33% | 83.33% | 90.00% |  |
| 2 | 1 | 82.00% | 80.00% | 83.33% | 90.00% |  |
| 3 | 2 | 82.00% | 80.00% | 83.33% | 90.00% |  |
