...
**Generated:** 2026-01-25T15:33:40.316484
**Status:** APPROVED
...
**Title (91 chars):**
```
4-Tier Ladder Towel Bar 30-Inch Wall Mount Solid Brass | Carolina Collection | Allied Brass
```

**Description (1028 chars):**
```
Upgrade towel storage with a 30-Inch wall mount ladder towel bar designed to save space while keeping towels organized. This 4-tier design from the Carolina Collection brings traditional bathroom hardware styling to your bath and coordinates easily with matching Carolina pieces.

Highlights:
- 4 horizontal bars at varying heights provide room to stack and hang multiple towels
- Wall mount installation helps keep bathroom space efficient
- Crafted of solid brass with a durable designer finish
- Concealed screw mounting hardware for a clean, refined look
- Available in a wide variety of lifetime designer finishes, including statement options

Specs:
- Collection: Carolina (traditional/classic)
- Type/Shape: Vertical ladder towel bar
- Center-to-center: 30 in
- Overall size: 30 in L x 35 in H x 3.3 in projection
- Bar diameter: 0.75 in
- Weight capacity: 20 lb
- Material: Brass
- Includes: Ladder towel bar and installation hardware (screw size #8 x 1 1/4)
...
| statement_finishes | glokzin teal, pink, spanish gold, autumn sparkle, unlacquered brass | enrichment_finishes |
...
| design_intent_keywords | carolina collection, matching carolina, traditional bathroom hardware, classic bath accessories, heritage bathroom fixtures, wall mount, glokzin teal bathroom hardware, pink bathroom hardware, spanish gold bathroom hardware, autumn sparkle bathroom hardware | enrichment_keywords |
...
- Claim rejected: 'Available in a wide variety of lifetime designer finishes (25 options)' - Field 'finish_variety' not found in source data
- Claim rejected: 'Part of the Carolina collection (traditional/classic)' - Field 'collection_context' not found in source data
- Claim rejected: 'Solid Brass' - Claimed 'Solid Brass' but actual value is 'Brass'

### Verified Claims

- 4-tier ladder towel bar with four horizontal bars at varying heights (source: current_description=The 4 horizontal bars at varying heights make it fun to stack your favorite towels while allowing this accessory to be user friendly at all heights.)
- Wall mount installation (source: mounting_type=Wall mount)
- 30-inch center-to-center (source: center_to_center=30 in)
- Crafted of solid brass (source: bullet_1=Crafted of solid brass and a durable designer finish)
...
- Overall dimensions: 30 in L x 35 in H with 3.3 in projection (source: product_height=35 in)
...
| 2 | 2 | 95.67% | 96.67% | 93.33% | 93.33% | shopify_description missing description term in first 150 chars |
| 3 | 1 | 93.33% | 93.33% | 93.33% | 93.33% | shopify_description missing description term in first 150 chars |
