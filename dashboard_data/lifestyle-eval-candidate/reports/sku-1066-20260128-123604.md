...
**Generated:** 2026-01-28T12:36:04.349006
**Status:** REJECTED
...
**Title (92 chars):**
```
Vanity Top Toilet Tissue Holder 5.5-Inch Solid Brass | Vanity Top Accessories | Allied Brass
```

**Description (663 chars):**
```
Keep toilet paper within easy reach when wall space is limited—this vanity top toilet tissue holder adds convenient storage right on the counter.

Highlights
- Save wall space in smaller bathrooms with a countertop vanity top design
- Keep a toilet paper roll accessible beside the sink for everyday use
- Choose long-lasting durability with solid brass construction
- Coordinate your look with the vanity top accessories collection and multiple designer finish options

Specs & Installation
- Product dimensions (L x H x W): 5.5 x 6 x 5 in.
- Box dimensions (L x H x W): 12 x 10 x 6 in.
...
- Designed for situations where wall space is limited. (source: current_description=great product where wall space is limited)
- Product dimensions are 5.5 x 6 x 5 in. (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 5.5x6x5)
