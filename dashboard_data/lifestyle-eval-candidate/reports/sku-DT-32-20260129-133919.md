...
**Generated:** 2026-01-29T13:39:19.662881
**Status:** APPROVED
...
**Title (82 chars):**
```
Wall-Mounted Soap Dish, 4.5-Inch, Solid Brass, Dottingham Collection, Allied Brass
```

**Description (999 chars):**
```
Keep bar soap off the counter and close at hand with a wall-mounted soap dish that keeps your bathroom sink area cleaner and less cluttered.

Highlights:
- Clear your countertop with a wall mount design that uses vertical space
- Count on enduring strength with solid brass construction
- Get a clean, finished look with concealed screw mounting hardware
- Coordinate your space with the Dottingham collection for matching Dottingham pieces and a cohesive set of transitional bath accessories
- Install with confidence—hardware is included and assembly is not required

Specs & Installation:
- Product dimensions (L x H x W): 4.5 x 3 x 3.5 inches
- Projection: 5 inches
- Weight capacity: 2 lb
- Product weight: 1.6 lb
- Mounting: wall-mounted
- Included: brass soap dish holder and all installation hardware (screw size #8 x 1 1/4")
- Warranty: Limited Lifetime Warranty
- Available in a wide variety of designer finishes to complement transitional bathroom hardware and versatile bath accessories.
```
...
**Token Usage:** Prompt tokens: 5956, Completion tokens: 1480
**Estimated Cost:** $0.031143
...
- Product type: wall mounted soap dish (source: current_title=Wall Mounted Soap Dish)
- Material: brass (solid brass construction) (source: material=Brass)
- Mounting type: wall mount (source: mounting_type=Wall mount)
- Product dimensions (L x H x W): 4.5 x 3 x 3.5 inches (source: current_description=Product dimensions, in. (LxHxW): 4.5x3x3.5)
- Projection: 5 inches (source: projection=5 in)
- Weight capacity: 2 lb (source: weight_capacity=2 lb)
- Included items: brass soap dish holder and all installation hardware (source: included_items=Brass soap dish holder and all installation hardware.)
...
- Collection: Dottingham (source: collection=Dottingham)
...
- 3.5 inches (source: product_width=3.5 in)
...
| 2 | 1 | 87.17% | 86.67% | 86.67% | 90.00% |  |
| 3 | 0 | 86.67% | 86.67% | 86.67% | 86.67% |  |
