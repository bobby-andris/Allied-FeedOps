...
**Generated:** 2026-01-29T11:46:39.398100
**Status:** APPROVED
...
**Title (90 chars):**
```
Shower Door Handle Pull, 9-Inch, Solid Brass & Acrylic, Clearview Collection, Allied Brass
```

**Description (958 chars):**
```
Get a secure, comfortable grip for opening and closing your glass shower door while keeping a clean, modern look.

Highlights:
- Open your shower door confidently with a sturdy U-shaped pull crafted from solid brass
- Keep the design crisp and architectural with clear acrylic accents from the Clearview collection
- Maintain a clean, finished appearance with concealed screw mounting hardware
- Coordinate across modern bathroom hardware and contemporary bath accessories with multiple designer finish options
- Install with less guesswork—shower door pull includes installation hardware and instructions

Specs & Installation:
- Product type: Single side shower door pull / shower door handle
- Material: Brass with acrylic accents
- Mounting: Shower door mount; concealed screw mounting
- Dimensions (L x H x W): 9 x 3.9 x 1.7 inches
...
**Token Usage:** Prompt tokens: 5973, Completion tokens: 1463
**Estimated Cost:** $0.030935
...
- Product is a single side shower door pull in the Clearview Collection. (source: current_title=Clearview Collection Single Side Shower Door Pull with Smooth Accents)
- Crafted from solid brass with acrylic accents. (source: current_description=Made from high quality solid brass with accents of clear acrylic)
...
- Dimensions are 9 x 3.9 x 1.7 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 13x3.9x1.7)
- Product length is 9 inches; height 3.9 inches; width 1.7 inches. (source: product_length=9 in)
...
- 1.7 inches (source: product_width=1.7 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 76.67% | 76.67% | 80.00% | 73.33% |  |
| 2 | 1 | 83.83% | 83.33% | 86.67% | 83.33% | bing_title must end with Allied Brass |
| 3 | 0 | 75.67% | 76.67% | 73.33% | 73.33% | bing_title must end with Allied Brass |
