...
**Generated:** 2026-01-29T12:46:36.541025
**Status:** APPROVED
...
**Title (108 chars):**
```
Glass Shelf With Towel Bar, 16 X 5-Inch Tempered Glass, Solid Brass, Wall Mount, Waverly Place, Allied Brass
```

**Description (989 chars):**
```
Clear counter clutter and keep towels within reach with a wall-mounted glass shelf that adds storage right where you need it. This Waverly Place Collection design pairs a tempered, beveled-edge glass shelf with an integrated towel bar and solid brass hardware for enduring bathroom organization.

Highlights:
- Add storage above the vanity with a 16 x 5-inch tempered glass shelf
- Keep a hand towel ready with the integrated towel bar beneath the shelf
- Coordinate your space with the Waverly Place Collection for matching Waverly Place accessories
- Built for daily bathroom use with solid brass construction and 3/8-inch thick glass

Specs & Installation:
- Glass dimensions: 16 x 5 inches
- Glass thickness: 3/8 inch (0.38 in)
...
**Token Usage:** Prompt tokens: 6020, Completion tokens: 1528
**Estimated Cost:** $0.031927
...
- Shelf is wall mount. (source: mounting_type=Wall mount)
- Hardware material is brass / solid brass materials. (source: material=Brass)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 88.00% | 90.00% | 80.00% | 86.67% |  |
| 2 | 2 | 87.00% | 90.00% | 80.00% | 80.00% |  |
| 3 | 0 | 83.33% | 83.33% | 86.67% | 80.00% |  |
