...
**Generated:** 2026-01-28T11:53:46.458434
**Status:** REJECTED
...
**Title (82 chars):**
```
Toilet Paper Stand 26-Inch Solid Brass European Hook | Best Sellers | Allied Brass
```

**Description (824 chars):**
```
Keep toilet paper within easy reach when wall space is limited. This freestanding toilet paper stand brings European-style convenience to your bathroom with a quick-change hook design and a stable, heavy base.

Highlights:
- Stay flexible in small bathrooms: freestanding design fits where wall mounting isn’t an option
- Change rolls fast: European-style hook makes replacement quick and easy
- Keep it steady on the floor: heavy base is designed to help prevent tipping
- Coordinate your space: part of the Best Sellers collection for a cohesive look
...
- Claim rejected: 'Heavy base designed to help prevent tipping and keep the stand secure.' - Claimed 'Heavy base will help prevent tipping... with a sturdy base that will keep the stand secure.' but actual value is 'This elegant free standing toilet tissue stand provides a decorative touch to your bathroom. European styling makes changing the roll quick and easy. This toilet tissue stand is a great product when wall space is at a premium. Made of the finest solid brass materials with a sturdy base that will keep the stand secure. Designer finishes will provide a lifetime of use. Crafted from the finest solid brass materials Heavy base will help prevent tipping European style hook makes changing the roll quick and easy Available in a wide variety of lifetime designer finishes Limited Lifetime Warranty Assembled in the USA Specification & Documentation Product dimensions, in. (LxHxW): 6.75x26x5.5 Box dimensions, in. (LxHxW): 9x9x29 Shipping weight, lbs: 6'
...
- Multiple designer finish options available (28 finishes, including statement colors). (source: key_differentiators=Part of coordinated Best Sellers collection; 28 finish options including statement colors)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 58.00% | 60.00% | 53.33% | 53.33% | google_description missing 2 description term(s); found 1 |
| 2 | 0 | 57.67% | 56.67% | 60.00% | 60.00% | google_description missing 2 description term(s); found 1 |
| 3 | 2 | 56.17% | 56.67% | 56.67% | 53.33% | google_description missing 2 description term(s); found 1; shopify_description missing 2 description term(s); found 1 |
