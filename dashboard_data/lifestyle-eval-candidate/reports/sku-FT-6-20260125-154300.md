...
**Generated:** 2026-01-25T15:43:00.396808
**Status:** APPROVED
...
**Title (86 chars):**
```
3-Tier Corner glass shelf 8-Inch x 8-Inch Wall Mount Solid Brass Hardware Allied Brass
```

**Description (974 chars):**
```
Add vertical storage to tight bathroom corners with a 3-tier corner glass shelf built with solid brass hardware and thick tempered glass. Designed for wall-mounted installation, this piece helps keep daily essentials organized while keeping the floor and vanity area clear. A coordinated option for the foxtrot collection and matching foxtrot bath layouts, it pairs well with textured bathroom hardware and other designer bath accessories.

Highlights:
- Three-tier corner shelf design adds storage and organization in compact spaces
...
Specs:
- Dimensions: 8-Inch L x 8-Inch W x 15-Inch H
...
| statement_finishes | fire engine red, antique pewter, pink, venetian bronze, lavender | enrichment_finishes |
...
| design_intent_keywords | foxtrot collection, matching foxtrot, textured bathroom hardware, designer bath accessories, designer bathroom hardware, statement bath accessories, sculptural fixtures, wall mount, fire engine red bathroom hardware, antique pewter bathroom hardware | enrichment_keywords |
...
- Claim rejected: 'Available in a wide variety of lifetime designer finishes (28 finishes; includes statement colors)' - Field 'finish_variety' not found in source data
...
- Three-tier corner glass shelf design (source: current_title=Foxtrot Collection Three Tier Corner Glass Shelf)
...
- Mounting hardware included; includes glass shelf and installation hardware (source: included_items=Glass shelf and all installation hardware.)
...
| 2 | 0 | 93.33% | 93.33% | 90.00% | 96.67% | google_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
