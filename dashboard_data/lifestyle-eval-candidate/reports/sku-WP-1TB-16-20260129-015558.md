...
**Generated:** 2026-01-29T01:55:58.857823
**Status:** REJECTED
...
**Title (108 chars):**
```
Glass Shelf With Towel Bar, 16-Inch, Wall Mount, Tempered Glass & Solid Brass, Waverly Place, | Allied Brass
```

**Description (1019 chars):**
```
Clear counter clutter and keep towels within reach with one wall-mounted piece that adds storage above the vanity. This 16-Inch glass shelf features a clever integrated towel bar and traditional-to-transitional styling for a coordinated look in the bathroom.

Highlights:
- Add usable bathroom storage fast—16 x 5-Inch tempered, beveled-edge glass shelf
- Keep a hand towel ready—integrated towel bar built into the design
- Dependable everyday support—crafted with solid brass hardware
- Coordinate your space—part of the Waverly Place collection for matching Waverly Place accessories and transitional bath accessories
- Built for long-term use—designer finishes are made for corrosion-free and rust-free performance

Specs & Installation:
- Shelf size: 16 x 5 Inches
- Glass thickness: 3/8-Inch (0.38 in)
- Projection: 5 in
- Weight capacity: 2 lb
- Mounting: wall mount
- Assembly: no assembly required
- Included: glass shelf and all installation hardware (#8 x 1 1/4" screws)
...
- 16-inch glass vanity shelf with integrated towel bar (source: current_title=Waverly Place 16 Inch Glass Vanity Shelf with Integrated Towel Bar)
- 3/8-inch thick tempered, beveled-edged glass (source: current_description=Featuring tempered, beveled-edged glass)
- Solid brass hardware (source: current_description=solid brass hardware)
- Glass shelf dimensions are 16 x 5 inches (source: bullet_4=Glass Dimensions: 16 x 5 Inches)
