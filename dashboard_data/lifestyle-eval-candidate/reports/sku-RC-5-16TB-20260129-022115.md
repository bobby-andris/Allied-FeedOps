...
**Generated:** 2026-01-29T02:21:15.136699
**Status:** APPROVED
...
**Title (88 chars):**
```
Glass Shelf With Towel Bar, 16-Inch Triple Tier, Solid Brass, Wall Mount, | Allied Brass
```

**Description (994 chars):**
```
Keep everyday bathroom essentials organized while adding display space in one wall-mounted piece. This triple-tier glass shelf includes an integrated towel bar for neatly hanging hand towels or decorative towels.

Highlights:
- Store more within reach—three tiers create layered storage for toiletries and decor
- Hang towels neatly—integrated towel bar keeps a towel ready at the sink or vanity
- Built for lasting support—solid brass hardware paired with 3/8-inch thick tempered, beveled-edge glass
- Clean, finished look—concealed screw mounting hardware
- Coordinate your space—available in multiple designer finish options including statement colors

Specs & Installation:
- Glass dimensions: 16 x 5 inches
- Overall size: 16 inches L x 5 inches W x 18 inches H
- Glass thickness: 0.38 inches (3/8-inch)
...
- Overall dimensions are 16 in L x 5 in W x 18 in H (source: product_height=18 in)
- Limited Lifetime Warranty (source: bullet_6=Limited Lifetime Warranty)
- Multiple designer finish options available including statement colors (source: competitive_edge=28 finish options including statement colors)
