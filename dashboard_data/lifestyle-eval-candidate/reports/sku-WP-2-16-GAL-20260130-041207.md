...
**Generated:** 2026-01-30T04:12:07.184826
**Status:** APPROVED
...
**Title (109 chars):**
```
Glass Shelf, 16-Inch Double Tempered Glass With Gallery Rail, Wall Mount Solid Brass Hardware -, Allied Brass
```

**Description (647 chars):**
```
Double glass shelf, 16 x 5 inches, with 3/8-inch thick tempered glass and solid brass hardware for bathroom storage and display. Wall mount design with concealed screw mounting hardware creates a clean, finished look while saving space. Gallery rail helps keep toiletries and decor items secure on each shelf. Ideal for transitional bathroom hardware layouts and versatile bath accessories where you want added organization without clutter. Includes glass shelf and all installation hardware. Weight capacity: 4 lb. Overall size: 16 in L x 5 in projection x 8 in H; product weight 10.4 lb. Lifetime warranty. Allied Brass Waverly Place collection.
```
...
**Token Usage:** Prompt tokens: 6531, Completion tokens: 1473, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.029811
...
- Hardware is made of solid brass. (source: current_description=Tempered glass is 3/8 Inches thick and all of the hardware is made of solid brass and finished with the highest quality materials to provide a lifetime of beauty.)
- Mounting type is wall mount. (source: mounting_type=Wall mount)
- Concealed screw mounting hardware is used. (source: bullet_3=Concealed screw mounting hardware makes installation easy)
- Weight capacity is 4 lb. (source: weight_capacity=4 lb)
- Overall dimensions are 16 in length, 5 in width/projection, 8 in height. (source: current_description=Length, in Depth, in Height, in Weight, lbs 16 Inch 16 5 8 10.4)
