...
**Generated:** 2026-01-30T15:19:44.100719
**Status:** APPROVED
...
**Title (85 chars):**
```
Recessed Toilet Paper Holder, 6.125-Inch Square, Brass, In-Wall Mount -, Allied Brass
```

**Description (671 chars):**
```
Recessed toilet paper holder with 6.125 in x 6.125 in face and 4 in projection, brass construction for a built-in, space-saving bathroom tissue holder installation. In-wall recessed mounting type creates a streamlined look, while concealed screw mounting hardware keeps the finished appearance clean. Traditional style coordinates with classic bath accessories and heritage bathroom fixtures. Includes recessed toilet paper holder and all installation hardware for bathroom use. Corrosion-free, rust-free designer finish performance and limited lifetime warranty. Part of the Carolina collection for matching Carolina traditional bathroom hardware. Allied Brass Carolina.
```
...
**Token Usage:** Prompt tokens: 6445, Completion tokens: 1256, Cached tokens: 5632 (87% cache hit)
**Estimated Cost:** $0.023935
...
- Product is a recessed toilet paper holder. (source: current_title=Carolina Collection Recessed Toilet Paper Holder)
- Mounting type is recessed (in-wall). (source: mounting_type=Recessed)
- Material is brass. (source: material=Brass)
- Product dimensions are 6.125 in x 6.125 in x 4 in (LxHxW). (source: current_description=Product dimensions, in. (LxHxW): 6.125x6.125x4)
...
- All mounting/installation hardware is included. (source: included_items=Recessed toilet paper holder and all installation hardware.)
...
- Available in multiple designer finish options (list provided). (source: available_finishes=Antique Brass, Antique Bronze, Brushed Bronze, Matte Black, Antique Copper, Matte Gray, Oil Rubbed Bronze, Polished Brass, Polished Chrome, Antique Pewter, Polished Nickel, Satin Brass, Satin Chrome, Satin Nickel, Unlacquered Brass, Venetian Bronze, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 84.67% | 86.67% | 83.33% | 76.67% |  |
| 2 | 0 | 82.83% | 83.33% | 86.67% | 76.67% |  |
| 3 | 1 | 82.83% | 83.33% | 83.33% | 80.00% |  |

### Generation Errors

- Candidate 0 retry: google_title under 60 chars
