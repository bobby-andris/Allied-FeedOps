...
**Generated:** 2026-01-29T12:20:57.572463
**Status:** APPROVED
...
**Title (92 chars):**
```
Tumbler Toothbrush Holder, Wall Mount, Solid Brass, 4.5-Inch, Mambo Collection, Allied Brass
```

**Description (918 chars):**
```
Clear your bathroom counter and keep daily essentials within reach with a wall-mounted tumbler toothbrush holder.

Highlights:
- Save space at the sink with a wall-mounted design that keeps toothbrushes and a tumbler off the countertop
- Keep the look clean and finished with concealed screw mounting hardware
- Count on enduring strength from solid brass construction
- Coordinate a statement look with the Mambo collection and its designer bath accessories, including matching Mambo pieces
...
- Included: Toothbrush holder and all installation hardware (#8 x 1 1/4 in screws)
...
**Token Usage:** Prompt tokens: 6022, Completion tokens: 1555
**Estimated Cost:** $0.032308
...
- Product dimensions are 4.5 x 4.7 x 3.5 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 4.5x4.7x3.5)
- Projection is 5 inches. (source: projection=5 in)
