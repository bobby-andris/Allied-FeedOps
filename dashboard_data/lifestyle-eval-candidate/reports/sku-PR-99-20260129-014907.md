...
**Generated:** 2026-01-29T01:49:07.599672
**Status:** REJECTED
...
**Title (117 chars):**
```
Shower Curtain Rod Brackets For 1-Inch Rod, Solid Brass, Pair, Shower Curtain Rod Brackets Collection, | Allied Brass
```

**Description (945 chars):**
```
Finish your shower curtain rod installation with matching brackets that secure a 1-inch diameter rod and complete the look of your bathroom.

Highlights:
- Get a coordinated, built-in look: designed for use with any 1-inch diameter shower curtain rod
- Rely on enduring construction: crafted of solid brass materials
- Create a cohesive bath design: part of the shower curtain rod brackets collection with transitional style
- Choose the right look for your space: available in multiple designer finish options
- Install with confidence: sold as a pair; shower rod is purchased separately

Specs & Installation:
- Includes: (2) shower curtain rod brackets (pair)
- Compatible with: 1-inch diameter shower rod (rod sold separately)
- Material: solid brass
- Product dimensions (L x H x W): 3 x 2.25 x 3 in.
- Box dimensions (L x H x W): 6 x 6 x 6 in.
...
- Claim rejected: 'Product dimensions are 3 x 2.25 x 3 inches (L x H x W) and shipping weight is 2 lbs.' - Claimed 'Product dimensions, in. (LxHxW): 3x2.25x3 ... Shipping weight, lbs: 2' but actual value is 'Add the finishing touch to your bathroom with these elegant shower curtain rod brackets. Made of the finest solid brass materials and will never rust or corrode. Brackets are completed with one of our wide variety of lifetime designer finishes. These items are sold as a pair and are manufactured to be used with a 1 inch diameter shower rod. Shower rod sold separately. For use with any 1 Inch diameter shower rod Crafted of the Finest Solid Brass Materials Sold as a pair. Shower Rod must be purchased separately. Products are provided with a limited lifetime warranty Assembled in the USA Specification & Documentation Product dimensions, in. (LxHxW): 3x2.25x3 Box dimensions, in. (LxHxW): 6x6x6 Shipping weight, lbs: 2 Installation Instruction Technical Specification PR99-Installation.PDF PR99-Specification.PDF'
...
- Designed for use with any 1-inch diameter shower rod; shower rod sold separately. (source: current_description=manufactured to be used with a 1 inch diameter shower rod. Shower rod sold separately. For use with any 1 Inch diameter shower rod)
- Crafted of solid brass materials. (source: current_description=Crafted of the Finest Solid Brass Materials)
- Multiple designer finish options available (28 finish options listed). (source: available_finishes=Antique Brass, Antique Bronze, Brushed Bronze, Matte Black, Antique Copper, Matte Gray, Oil Rubbed Bronze, Polished Brass, Polished Chrome, Antique Pewter, Polished Nickel, Satin Brass, Satin Chrome, Satin Nickel, Unlacquered Brass, Venetian Bronze, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
- Limited lifetime warranty and assembled in the USA. (source: current_description=Products are provided with a limited lifetime warranty Assembled in the USA)
