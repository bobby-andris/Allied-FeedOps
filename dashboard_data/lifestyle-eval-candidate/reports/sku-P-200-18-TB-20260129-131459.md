...
**Generated:** 2026-01-29T13:14:59.935625
**Status:** APPROVED
...
```
Keep bath towels within easy reach and off the counter with a wall-mounted towel bar designed for an industrial, pipe-style look.

Highlights:
- Create an organized towel spot at the sink or shower with an 18-inch straight bar
- Match loft-inspired decor with pipe-style bath accessories from the Pipeline collection
- Count on lasting daily use with durable powder-coated iron construction
- Maintain a clean, decorative look with a powder-coated finish designed to resist corrosion and rust
- Install securely with included mounting plates and color-coordinated hardware
...
- Overall dimensions (L x H x W): 18 x 3 x 3.3 in (projection 3.3 in)
- Weight capacity: 10 lb
- Included: Towel bar, mounting plates, and all installation hardware
...
**Token Usage:** Prompt tokens: 6049, Completion tokens: 1435
**Estimated Cost:** $0.030676
...
- Product is a wall-mounted towel bar in the Pipeline collection. (source: current_title=Pipeline Collection Towel Bar)
- Center-to-center measurement is 18 inches. (source: center_to_center=18 in)
...
- Overall product dimensions are 18 x 3 x 3.3 inches (L x H x W), with 3.3-inch projection. (source: current_description=Product dimensions, in. (LxHxW): 18x3x3.3)
- Includes towel bar, mounting plates, and all installation hardware with color-coordinated mounting hardware. (source: included_items=Towel bar, mounting plates and all installation hardware.)
...
| 2 | 0 | 83.33% | 83.33% | 83.33% | 83.33% | bing_title must end with Allied Brass |
| 3 | 1 | 83.33% | 83.33% | 83.33% | 83.33% | bing_title must end with Allied Brass |
