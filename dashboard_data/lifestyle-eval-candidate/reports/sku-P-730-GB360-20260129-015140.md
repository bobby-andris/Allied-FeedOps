...
**Generated:** 2026-01-29T01:51:40.365456
**Status:** REJECTED
...
**Title (85 chars):**
```
Extended 3-Post Grab Bar, 60-Inch, ADA Compliant, Pipeline Collection, | Allied Brass
```

**Description (976 chars):**
```
Get a steady, secure handhold where you need it most in the bathroom—along the tub, inside the shower, or beside the toilet. The Pipeline Extended 3 Post Grab Bar is designed for added stability with a third center bracket and a long 60-inch span, pairing safety-focused function with a distinctive pipe-inspired look.

Highlights:
- Feel more secure stepping in and out of the shower or tub—ADA compliant design with a third center bracket for stability
- Cover a longer section of wall—extended 60-inch grab bar length for flexible placement
- Coordinate a cohesive bathroom look—part of the grab bars collection with a transitional, versatile style
- Enjoy lasting performance—corrosion-free and rust-free materials for a clean decorative finish
- Match your space—multiple designer finish options available, including statement colors

Specs & Installation:
- Product dimensions (L x H x W): 63 x 3 x 3.58 in.
...
**Image URL:** https://cdn.shopify.com/s/files/1/0287/8658/9828/products/P730GB360-ABZ.jpg?v=1677080535
...
| category | Grab Bar | category |
| collection | Grab Bars | collection |
...
| gtin | 013895553032 | gtin |
| upc | 013895553032 | upc |
| main_image_url | https://cdn.shopify.com/s/files/1/0287/8658/9828/products/P730GB360-ABZ.jpg?v=1677080535 | main_image_url |
| collection_context | Grab Bars (Unknown) - distinctive design | enrichment_collection |
...
| key_differentiators | Part of coordinated Grab Bars collection; 19 finish options including statement colors | enrichment_competitive |
| design_intent_keywords | grab bars collection, transitional bathroom hardware, versatile bath accessories | enrichment_keywords |
...
Primary search term (include naturally in the title; adapt wording to accurately describe THIS product): pipeline extended 3 post grab bar - 60 inch
Google short title must include: pipeline extended 3 post grab bar - 60 inch

Description terms (include at least 2 naturally in the description):
- grab bars collection
...
- Product is an extended length 3-post grab bar in the Pipeline collection. (source: current_title=Pipeline Extended 3 Post Grab Bar - 60 inch)
- ADA compliant and includes a third center bracket for stability. (source: current_description=ADA Compliant Bars feature a third center bracket to ensure stability)
- Corrosion-free and rust-free performance is stated. (source: current_description=Designer finish will provide Corrosion-free and rust-free performance)
- Multiple designer finish options are available, including 19 finishes. (source: key_differentiators=19 finish options including statement colors)
- Product dimensions are 63 x 3 x 3.58 in. (source: current_description=Product dimensions, in. (LxHxW): 63x3x3.58)
- Shipping weight is 6 lbs. (source: current_description=Shipping weight, lbs: 6)
- Limited lifetime warranty is provided. (source: current_description=Provided with a limited lifetime warranty)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 79.50% | 80.00% | 80.00% | 76.67% |  |
| 2 | 0 | 70.00% | 70.00% | 70.00% | 70.00% |  |
| 3 | 2 | 80.50% | 80.00% | 83.33% | 80.00% | google_description missing 2 description term(s); found 1 |
