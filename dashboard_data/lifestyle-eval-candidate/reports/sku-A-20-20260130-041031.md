...
**Generated:** 2026-01-30T04:10:31.106383
**Status:** APPROVED
...
**Title (102 chars):**
```
Cabinet Pull, 3.9-Inch Center-To-Center, Solid Brass, Cabinet Mount, Traditional Style -, Allied Brass
```

**Description (591 chars):**
```
Cabinet pull with 3.9 in length and 1 in projection, made from solid brass for cabinet-mount installation on kitchen or bathroom cabinetry. Traditional style pull sized for drawers and cabinet doors; includes cabinet pull and all installation hardware. Product dimensions: 3.9 in L x 1.6 in H x 0.9 in W; product weight 0.8 lb. Supports up to 2 lb. Offered in multiple lifetime designer finish options and covered by a limited lifetime warranty. Coordinates with traditional bathroom hardware, classic bath accessories, and heritage bathroom fixtures across Allied Brass decorative hardware.
```
...
**Token Usage:** Prompt tokens: 6308, Completion tokens: 1415, Cached tokens: 2560 (40% cache hit)
**Estimated Cost:** $0.028609
...
- All mounting hardware is included. (source: bullet_3=All mounting hardware included)
- Included items are the cabinet pull and all installation hardware. (source: included_items=Cabinet pull and all installation hardware.)
- Product dimensions are 3.9 in (L) x 1.6 in (H) x 0.9 in (W). (source: product_length=3.9 in)
- Product height is 1.6 in. (source: product_height=1.6 in)
- Product width is 0.9 in. (source: product_width=0.9 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 70.50% | 70.00% | 70.00% | 73.33% | shopify_description missing 2 description term(s); found 1 |
