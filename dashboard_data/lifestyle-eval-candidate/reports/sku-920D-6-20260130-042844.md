...
**Generated:** 2026-01-30T04:28:44.380572
**Status:** APPROVED
...
**Title (90 chars):**
```
Multi Hook, 15.5-Inch Wall Mount Solid Brass 6-Hook Rack, Mercury Collection, Allied Brass
```

**Description (711 chars):**
```
Multi hook, 15.5 in L x 3.2 in H x 4 in W, solid brass wall mount 6-position hook rack for bathroom storage of robes, towels, and accessories. Concealed screw mounting hardware provides a clean, finished look and space-saving wall-mounted installation. Contemporary/transitional styling from the Mercury Collection (refined texture, versatile) pairs with transitional bathroom hardware and versatile bath accessories, including matching Mercury pieces. Includes multi hook and all installation hardware; uses #8 x 1 1/4 in screws. Weight capacity 2 lb. Finished with a lifetime designer finish for corrosion-free, rust-free performance and backed by a limited lifetime warranty. Allied Brass Mercury Collection.
```
...
**Token Usage:** Prompt tokens: 6441, Completion tokens: 1412, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.028800
...
- Crafted from solid brass / brass material. (source: material=Brass)
...
| 3 | 2 | 73.83% | 73.33% | 73.33% | 76.67% | shopify_title must end with Allied Brass |
