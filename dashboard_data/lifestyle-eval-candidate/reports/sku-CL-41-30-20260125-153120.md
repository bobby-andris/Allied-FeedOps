...
**Generated:** 2026-01-25T15:31:20.101036
**Status:** APPROVED
...
**Title (100 chars):**
```
Wall Mount Towel Bar 30-Inch Solid Brass Traditional Straight Bar | Carolina Collection Allied Brass
```

**Description (861 chars):**
```
Upgrade daily towel storage with a 30-Inch wall mount towel bar crafted from solid brass for enduring performance. Designed in the Carolina Collection, it brings traditional bathroom hardware style with a refined, classic silhouette that coordinates easily with matching Carolina pieces.
...
- Offered in a wide variety of lifetime designer finishes, including statement options

Specs:
- Collection: Carolina (Traditional)
...
| statement_finishes | unlacquered brass, autumn sparkle, venetian bronze, pink, spanish gold | enrichment_finishes |
...
| design_intent_keywords | carolina collection, matching carolina, traditional bathroom hardware, classic bath accessories, heritage bathroom fixtures, wall mount, unlacquered brass bathroom hardware, autumn sparkle bathroom hardware, venetian bronze bathroom hardware, pink bathroom hardware | enrichment_keywords |
...
- Traditional style, straight bar design (source: style=Traditional)
...
- Dimensions: 30 in L x 3.5 in H x 2 in W; projection 2 in (source: product_height=3.5 in)
