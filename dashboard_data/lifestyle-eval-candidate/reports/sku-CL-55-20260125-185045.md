...
**Generated:** 2026-01-25T18:50:45.974924
**Status:** APPROVED
...
**Description (1040 chars):**
```
Upgrade your countertop with a freestanding paper towel holder crafted from solid brass with a space-saving upright design and a weighted base for stability. Designed in the Carolina collection for a traditional, refined look that coordinates with classic bath accessories.

Highlights:
- Freestanding design requires no wall mounting and keeps your counter organized
- Upright, space-saving stand holds a standard paper towel roll on the countertop
- Weighted base helps keep the holder stable while tearing off sheets
- Felt pad helps prevent scratching on countertop surfaces
- Designer finish is made for corrosion-free and rust-free performance

Specs:
- Collection: Carolina (traditional/classic)
- Material: Solid brass
- Mounting type: Freestanding
- Dimensions: 6.5-Inch L x 6.5-Inch W x 14.4-Inch H (projection 6.5-Inch)
...
- Product is a paper towel holder/stand for countertop use (source: category=Paper Towel Holders)
...
- Space saving upright design (source: current_description=The roll in the stand sits upright on the counter top allowing for space saving.)
- Weighted base for stability (source: current_description=It has a weight in the base to keep the unit stable as you tear off the sheets.)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 83.83% | 83.33% | 83.33% | 86.67% |  |
| 2 | 1 | 82.83% | 83.33% | 80.00% | 83.33% |  |
| 3 | 0 | 81.83% | 83.33% | 83.33% | 73.33% | shopify_title must end with Allied Brass |
