...
**Generated:** 2026-01-29T13:36:08.988519
**Status:** APPROVED
...
**Title (95 chars):**
```
Recessed Toilet Paper Holder, 6.125-Inch Square, Solid Brass, Carolina Collection, Allied Brass
```

**Description (861 chars):**
```
Get a clean, built-in look while saving space around the toilet with a recessed toilet paper holder designed to sit in the wall.

Highlights:
- Streamlined, space-saving installation with an in-wall recessed design
- Coordinated traditional style with classic design elements for timeless bathrooms
- Clean finished appearance with concealed screw mounting hardware
- Enduring brass construction for a substantial feel
- Easy setup with all mounting hardware included

Specs & Installation:
- Type: Recessed toilet paper holder (in-wall)
- Material: Brass
- Collection: Carolina (Traditional/Classic)
- Dimensions (L x H x W): 6.125 in x 6.125 in x 4 in (projection)
- Product weight: 2.4 lb
- Included: Recessed toilet paper holder and all installation hardware
...
**Token Usage:** Prompt tokens: 5969, Completion tokens: 1468
**Estimated Cost:** $0.030998
...
- Product is a recessed toilet paper holder with an in-wall design. (source: current_title=Carolina Collection Recessed Toilet Paper Holder)
- Made of brass. (source: material=Brass)
- Traditional style design. (source: style=Traditional)
- Recessed mounting type. (source: mounting_type=Recessed)
- Concealed screw mounting hardware. (source: bullet_3=Concealed screw mounting hardware makes installation easy)
- All mounting hardware included. (source: included_items=Recessed toilet paper holder and all installation hardware.)
- Dimensions are 6.125 in (L) x 6.125 in (H) x 4 in (W/projection). (source: current_description=Product dimensions, in. (LxHxW): 6.125x6.125x4)
...
| 2 | 1 | 86.17% | 86.67% | 86.67% | 83.33% | bing_title must end with Allied Brass |
