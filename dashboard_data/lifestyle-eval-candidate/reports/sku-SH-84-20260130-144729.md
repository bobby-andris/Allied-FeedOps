...
**Generated:** 2026-01-30T14:47:29.887843
**Status:** APPROVED
...
**Title (99 chars):**
```
Freestanding 4 Pivoting Swing Arm Towel Stand, 49-Inch Solid Brass, Soho Collection -, Allied Brass
```

**Description (614 chars):**
```
Freestanding 4 pivoting swing arm towel stand, 49-inch tall with 12 in x 9.25 in footprint, solid brass construction for bathroom towel storage and drying. Modern, clean-lined Soho Collection design in a vertical stand format; four pivoting arms maximize space and separate towels for faster drying. Heavy weighted base helps prevent tipping and includes a felt pad to protect floors and countertops. Corrosion-resistant, rust-free performance with a designer lifetime finish. Supports up to 20 lb. Some assembly required. Includes towel stand. Backed by a limited lifetime warranty. Allied Brass, Soho collection.
```
...
**Token Usage:** Prompt tokens: 6468, Completion tokens: 1492, Cached tokens: 4480 (69% cache hit)
**Estimated Cost:** $0.028287
...
- Heavy/weighted base helps prevent tipping. (source: current_description=Large base is weighted to help prevent tipping.)
- Felt pad prevents scratching on surfaces. (source: bullet_2=Felt pad will prevent scratching on any surface)
- Product dimensions are 12 in x 49 in x 9.25 in (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 12x49x9.25)
- Diameter is 1 inch. (source: diameter=1 in)
...
- 9.25 in (source: product_width=9.25 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 81.50% | 80.00% | 86.67% | 83.33% |  |
| 2 | 0 | 77.67% | 76.67% | 83.33% | 76.67% |  |
| 3 | 1 | 77.67% | 76.67% | 86.67% | 73.33% |  |
