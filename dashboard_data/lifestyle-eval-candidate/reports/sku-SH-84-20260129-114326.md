...
**Generated:** 2026-01-29T11:43:26.818784
**Status:** APPROVED
...
```
Keep bath towels organized without drilling into walls. This freestanding 4 pivoting swing arm towel stand gives you four arms to separate towels and rotate them for easy access, while the heavy base is weighted to help prevent tipping.

Highlights:
- Create organized space for multiple towels with 4 pivoting swing arms
- Place it anywhere in the bathroom with a freestanding design (no wall mounting)
- Protect floors and counters with a felt pad on the base
- Choose a look that coordinates with transitional bathroom hardware, with multiple designer finish options
- Coordinate with the Soho collection for a matching Soho bathroom setup

Specs & Installation:
- Material: brass construction (solid brass)
- Overall size: 12 in L x 49 in H x 9.25 in W
- Base/rod diameter: 1 in
- Weight capacity: 20 lb
- Mounting type: freestanding vertical stand
- Assembly: some assembly required
- Includes: towel stand
...
**Token Usage:** Prompt tokens: 5992, Completion tokens: 1458
**Estimated Cost:** $0.030898
...
- Freestanding towel stand with 4 pivoting swing arms (source: current_title=Freestanding 4 Pivoting Swing Arm Towel Stand)
- Made of solid brass (brass material) (source: material=Brass)
- Weighted/heavy base helps prevent tipping (source: bullet_4=Heavy solid brass base will help prevent tipping)
- Felt pad prevents scratching on surfaces (source: bullet_2=Felt pad will prevent scratching on any surface)
- Overall dimensions are 12 in L x 49 in H x 9.25 in W (source: current_description=Product dimensions, in. (LxHxW): 12x49x9.25)
