...
**Generated:** 2026-01-30T04:46:01.320699
**Status:** APPROVED
...
**Title (104 chars):**
```
Shower Basket, 18.75-Inch Wall Mount Solid Brass Oval Combination Basket, Concealed Screws, Allied Brass
```

**Description (640 chars):**
```
Shower basket with 18.75 in length x 2.25 in height x 4.13 in projection/width, solid brass construction, wall mount installation for organizing shampoo, soap, and bath essentials in the shower. Oval combination shower basket with ventilated, rust proof solid brass wires and a concealed screw mounting system for a clean, traditional look. Designer finish provides corrosion-free and rust-free performance. Includes basket and all installation hardware; no assembly required. Limited lifetime warranty. Ideal for traditional bathroom hardware, classic bath accessories, and heritage bathroom fixtures with wall mount styling. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6366, Completion tokens: 1423, Cached tokens: 4352 (68% cache hit)
...
- Constructed from solid brass. (source: current_description=This decorative basket is made of solid brass to provide a lifetime of superior performance and durability.)
...
- Ventilated wires are rust proof solid brass and will never rust. (source: current_description=Ventilated wires are made of heavy gauge solid brass material that will never rust.)
...
- 4.13 in (source: product_width=4.13 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 83.33% | 83.33% | 76.67% | 90.00% |  |
| 2 | 1 | 82.33% | 83.33% | 76.67% | 83.33% | shopify_title must end with Allied Brass |
| 3 | 0 | 81.33% | 83.33% | 73.33% | 80.00% | shopify_title must end with Allied Brass |
