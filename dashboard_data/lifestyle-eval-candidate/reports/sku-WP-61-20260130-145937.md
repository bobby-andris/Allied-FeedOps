...
**Generated:** 2026-01-30T14:59:37.206108
**Status:** APPROVED
...
**Title (79 chars):**
```
Vanity Top Soap Dispenser, 7-Inch H Countertop Solid Brass Pump -, Allied Brass
```

**Description (682 chars):**
```
Vanity top soap dispenser, 3 in L x 7 in H x 5 in W, solid brass countertop dispenser for bathroom soap, lotion, or hand sanitizer at the sink. Traditional/transitional styling with classic design elements and a space-saving footprint. Includes soap dispenser; generous 5 ounce capacity bottle. Mount type: countertop (vanity top). Projection: 4 in. Weight capacity: 5 lb. No assembly required. Available in a wide variety of lifetime designer finishes and backed by a limited lifetime warranty. Part of the Waverly Place collection for matching Waverly Place, grooved bathroom hardware, transitional bath accessories, and transitional bathroom hardware. Allied Brass Waverly Place.
```
...
**Token Usage:** Prompt tokens: 6414, Completion tokens: 1462, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.029452
...
- Product type: vanity top soap dispenser (source: current_title=Vanity Top Soap Dispenser)
- Countertop mounting type (source: mounting_type=Countertop)
- Made of solid brass / brass material (source: current_description=Made of solid brass)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 84.83% | 83.33% | 86.67% | 90.00% |  |
| 2 | 2 | 84.33% | 83.33% | 83.33% | 90.00% |  |
| 3 | 0 | 80.50% | 80.00% | 80.00% | 83.33% |  |
