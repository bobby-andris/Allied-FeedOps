...
**Generated:** 2026-01-29T12:10:32.214616
**Status:** APPROVED
...
**Title (94 chars):**
```
Towel Bar, 18-Inch Center-To-Center, Solid Brass Wall Mount, Carolina Collection, Allied Brass
```

**Description (990 chars):**
```
Get a dedicated, wall-mounted spot to hang and dry bath towels while keeping your bathroom layout clean and uncluttered. The Carolina Collection towel bar pairs traditional styling with solid brass construction and a straight-bar profile for everyday use.

Highlights:
- Keep towels within easy reach: 18-Inch center-to-center bar fits standard bath towel placement
- Maintain a clean, finished look: concealed screw mounting hardware
- Save space on the vanity and floor: wall mount design
- Install with confidence: mounting plates and all installation hardware included

Specs & Installation:
- Collection: Carolina Collection
- Style: Traditional; shape: straight bar
- Material: Brass
...
**Token Usage:** Prompt tokens: 5979, Completion tokens: 1450
**Estimated Cost:** $0.030763
...
- 18-inch center-to-center dimension. (source: center_to_center=18 in)
- Bar diameter is 0.75 inch. (source: diameter=0.75 in)
- Weight capacity is 10 lb. (source: weight_capacity=10 lb)
- Includes towel bar, mounting plates, and all installation hardware; assembly not required. (source: included_items=Towel bar, mounting plates and all installation hardware.)
...
| 2 | 0 | 88.50% | 90.00% | 90.00% | 80.00% |  |
| 3 | 1 | 89.50% | 90.00% | 90.00% | 86.67% | bing_title must end with Allied Brass |
