...
**Generated:** 2026-01-30T14:43:31.852266
**Status:** APPROVED
...
**Title (105 chars):**
```
Multi Hook, 15.5-Inch Wall Mount Solid Brass 6 Position Tie & Belt Rack, Mercury Collection, Allied Brass
```

**Description (622 chars):**
```
Multi hook, 15.5-inch wall mount solid brass 6 position tie and belt rack for bathroom storage and organization. Contemporary/transitional design with concealed screw mounting hardware for a clean, finished look on the wall. Use as a bathroom hook rack for robes, towels, jackets, belts, and ties while saving floor space. Includes multi hook and all installation hardware; uses #8 x 1 1/4" screws. Product dimensions: 15.5 in L x 3.2 in H x 4 in W; weight capacity 2 lb; product weight 3 lb. Corrosion-free and rust-free performance with a designer finish; limited lifetime warranty. Mercury collection, matching Mercury.
```
...
**Token Usage:** Prompt tokens: 6468, Completion tokens: 1389, Cached tokens: 5632 (87% cache hit)
**Estimated Cost:** $0.025837
...
- Crafted from solid brass materials (brass). (source: material=Brass)
- Product dimensions are 15.5 x 3.2 x 4 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 15.5x3.2x4)
- Product length is 15.5 inches. (source: product_length=15.5 in)
- Weight capacity is 2 lb. (source: weight_capacity=2 lb)
- Includes multi hook and all installation hardware. (source: included_items=Multi hook and all installation hardware.)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 83.33% | 83.33% | 86.67% | 80.00% |  |
| 2 | 1 | 82.83% | 83.33% | 86.67% | 76.67% |  |
| 3 | 2 | 80.00% | 80.00% | 83.33% | 76.67% |  |

### Generation Errors

- Candidate 0 retry: google_title, bing_title under 60 chars
