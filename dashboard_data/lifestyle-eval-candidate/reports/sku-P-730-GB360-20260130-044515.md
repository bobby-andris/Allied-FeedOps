...
**Generated:** 2026-01-30T04:45:15.909467
**Status:** APPROVED
...
**Title (76 chars):**
```
Grab Bar, 63-Inch 3-Post Wall Mount Iron Pipe, ADA Compliant -, Allied Brass
```

**Description (659 chars):**
```
Grab bar with 63-inch length, wall mount installation, and iron pipe construction for bathroom safety and accessibility. Extended 3-post design adds a third center bracket for stability; ADA compliant for accessible bath layouts. Industrial, pipe-style look suits loft bathroom fixtures and industrial bathroom hardware, and pairs with matching pipeline collection pieces and pipe-style bath accessories. Protected with a highly durable powder coat finish for corrosion-free and rust-free performance. Overall dimensions: 63 in L x 3 in H x 3.58 in W with 3.58 in projection; supports up to 250 lb. Limited lifetime warranty. Allied Brass Pipeline collection.
```
...
**Token Usage:** Prompt tokens: 6511, Completion tokens: 1516, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.030378
...
- Product is an extended length 3 post grab bar. (source: current_title=Pipeline Extended 3 Post Grab Bar - 60 inch)
- Product length is 63 inches. (source: product_length=63 in)
- Mounting type is wall mount. (source: mounting_type=Wall mount)
- Material is iron pipe. (source: material=Iron Pipe)
- ADA compliant. (source: bullet_2=ADA Compliant)
- Features a third center bracket for stability. (source: bullet_3=Bars feature a third center bracket to ensure stability)
- Protected using a highly durable powder coat finish. (source: bullet_4=Protected using highly durable powder coat finish)
- Corrosion-free and rust-free performance is stated. (source: bullet_5=Designer finish will provide Corrosion-free and rust-free performance)
- Weight capacity is 250 lb. (source: weight_capacity=250 lb)
- Overall dimensions are 63 x 3 x 3.58 inches (L x H x W). (source: current_description=Specification & Documentation Product dimensions, in. (LxHxW): 63x3x3.58)
- Projection is 3.58 inches. (source: projection=3.58 in)
- Warranty is a limited lifetime warranty. (source: bullet_6=Provided with a limited lifetime warranty)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 76.67% | 76.67% | 73.33% | 80.00% |  |
| 2 | 0 | 74.33% | 73.33% | 76.67% | 76.67% | shopify_title must end with Allied Brass |
| 3 | 2 | 71.00% | 70.00% | 73.33% | 73.33% | shopify_title must end with Allied Brass |
