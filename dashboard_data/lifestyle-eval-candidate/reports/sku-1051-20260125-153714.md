...
**Generated:** 2026-01-25T15:37:14.650471
**Status:** APPROVED
...
```
Upgrade countertop organization with a freestanding paper towel holder crafted from solid brass and designed to help keep surfaces tidy without wall mounting. Its weighted base helps prevent tipping, while a felt pad helps protect countertops from scratches—ideal for contemporary bath accessories and modern bathroom hardware looks that carry into the kitchen.

Highlights:
- Freestanding design requires no wall mounting
- Crafted from solid brass for enduring everyday use
- Weighted base helps prevent tipping during tear-off
...
| statement_finishes | antique pewter, mediterranean blue, autumn sparkle, glokzin teal, pink | enrichment_finishes |
...
| design_intent_keywords | modern bathroom hardware, contemporary bath accessories, minimalist bathroom fixtures, freestanding, antique pewter bathroom hardware, mediterranean blue bathroom hardware, autumn sparkle bathroom hardware, glokzin teal bathroom hardware, pink bathroom hardware, golden yellow bathroom hardware | enrichment_keywords |
...
- Dimensions are 5 inches long x 5 inches wide x 14 inches high (source: product_height=14 in)
...
| 2 | 1 | 84.67% | 86.67% | 83.33% | 76.67% | shopify_title must end with Allied Brass; shopify_description missing 2 description term(s); found 1 |
| 3 | 0 | 82.83% | 83.33% | 80.00% | 83.33% | shopify_description missing 2 description term(s); found 1 |
