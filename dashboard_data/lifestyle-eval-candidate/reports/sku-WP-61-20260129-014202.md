...
**Generated:** 2026-01-29T01:42:02.026231
**Status:** REJECTED
...
**Title (91 chars):**
```
Vanity Top Soap Dispenser, 5 Oz, Solid Brass, Brass & Glass Soap Dispensers, | Allied Brass
```

**Description (825 chars):**
```
Stop cluttering your vanity with disposable bottles—keep soap, lotion, or hand sanitizer ready with a built-in vanity top soap dispenser.

Highlights:
- Keeps your countertop neat and coordinated with a vanity top-mounted dispenser design
- Holds more between refills with a generous 5 ounce bottle capacity
- Delivers lasting durability with solid brass construction
- Matches your space with multiple designer finish options for transitional bathroom hardware and other versatile bath accessories
- Backed for long-term ownership with a limited lifetime warranty
...
- Dispenses soap, lotion, or hand sanitizer. (source: current_description=Vanity Top Dispenser for Soap, Lotion or Hand Sanitizer.)
- Includes a 5 ounce capacity bottle. (source: current_description=Generous 5 ounce capacity bottle holds plenty of your favorite soap, lotion or hand sanitizer.)
- Multiple designer finish options are available. (source: finish_variety=Multiple designer finish options available)
- Dimensions are 3 x 7 x 5 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 3x7x5)
- Shipping weight is 3 lbs. (source: current_description=Shipping weight, lbs: 3)
- Backed by a limited lifetime warranty. (source: current_description=Products are provided with a limited lifetime warranty)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 77.17% | 76.67% | 80.00% | 76.67% |  |
| 2 | 0 | 82.33% | 83.33% | 76.67% | 83.33% | google_description missing 2 description term(s); found 1 |
| 3 | 2 | 67.67% | 66.67% | 66.67% | 73.33% | shopify_description missing 2 description term(s); found 1 |
