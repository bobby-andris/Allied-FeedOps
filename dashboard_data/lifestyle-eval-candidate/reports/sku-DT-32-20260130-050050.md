...
**Generated:** 2026-01-30T05:00:50.669544
**Status:** APPROVED
...
**Title (77 chars):**
```
Soap Dish, 4.5-Inch Wall Mount Solid Brass Holder, Dottingham -, Allied Brass
```

**Description (688 chars):**
```
Wall-mounted soap dish, 4.5 in L x 3 in H x 3.5 in W with 5 in projection, solid brass bathroom soap holder designed to keep bar soap off the countertop and reduce sink-side clutter. Traditional/transitional styling in the Dottingham collection with concealed screw mounting for a clean look. Includes brass soap dish holder and installation hardware; uses #8 x 1 1/4 in screws. Supports up to 2 lb weight capacity. Assembly not required. Available in multiple designer finishes. Limited Lifetime Warranty. Ideal for transitional bath accessories and transitional bathroom hardware layouts; coordinate with matching Dottingham and beaded bathroom hardware pieces. Allied Brass Dottingham.
```
...
**Token Usage:** Prompt tokens: 6405, Completion tokens: 1480, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.029689
...
| current_title | Wall Mounted Soap Dish | current_title |
| current_description | Complete your décor with this finely crafted soap dish. Keep your countertop clean and clutter free while adding the finishing touch to your space. Made of solid brass and provided with a lifetime finsh to insure products will never rust. Classic design will compliment your décor Made of Solid Brass Available in a variety of designer finishes Assembled in the U.S.A. Specification & Documentation Product dimensions, in. (LxHxW): 4.5x3x3.5 Box dimensions, in. (LxHxW): 10x6x4 Shipping weight, lbs: 2 Installation Instruction Technical Specification DT32-Installation.PDF DT32-Specification.PDF | current_description |
...
| collection_context | Dottingham (Transitional) - subtle sophistication | enrichment_collection |
...
| design_intent_keywords | dottingham collection, matching dottingham, beaded bathroom hardware, transitional bath accessories, transitional bathroom hardware, versatile bath accessories, wall mount | enrichment_keywords |
...
Primary search term (include naturally in the title; adapt wording to accurately describe THIS product): soap dish
...
- Product type is a wall mounted soap dish. (source: current_title=Wall Mounted Soap Dish)
- Made of solid brass / brass construction. (source: current_description=Made of solid brass)
- Mounting type is wall mount with concealed screw mounting. (source: mounting_type=Wall mount)
...
- Product dimensions are 4.5 in (L) x 3 in (H) x 3.5 in (W). (source: current_description=Product dimensions, in. (LxHxW): 4.5x3x3.5)
- Projection is 5 in. (source: projection=5 in)
- Weight capacity is 2 lb. (source: weight_capacity=2 lb)
- Includes brass soap dish holder and all installation hardware. (source: included_items=Brass soap dish holder and all installation hardware.)
...
- Collection is Dottingham. (source: collection=Dottingham)
...
| 2 | 0 | 83.33% | 83.33% | 83.33% | 83.33% | shopify_title must end with Allied Brass |
| 3 | 2 | 79.83% | 83.33% | 83.33% | 60.00% | shopify_title missing title anchor in first 70 chars: soap dish; shopify_title must end with Allied Brass |
