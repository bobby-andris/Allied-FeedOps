...
**Generated:** 2026-01-29T13:11:43.094200
**Status:** APPROVED
...
**Title (124 chars):**
```
Modern Retractable Wall Hook, 2-1/2-Inch Pull-Out, Solid Brass, Wall Mount, Retractable Hooks And Garment Rods, Allied Brass
```

**Description (1142 chars):**
```
Keep towels, robes, and clothing within reach without a hook sticking out into your bathroom. This modern retractable wall hook pulls out to create 2-1/2 inches of hanging space, then pushes back in when not in use—ideal for tight layouts and clean sightlines.

Highlights:
- Save space when you’re done: retractable rod stores flush to reduce snagging in smaller bathrooms
- Hang everyday essentials securely: supports up to 15 lb for robes, towels, and coats
- Coordinate your hardware: part of the retractable hooks and garment rods collection with multiple designer finish options available
- Match existing knobs: removable knob tip lets you swap in your own cabinet knob
- Install with confidence: wall mount design for standard interior walls; mounting hardware included

Specs & Installation:
- Material: brass
- Mounting: wall mount
- Hanging space (pull-out): 2-1/2 in
- Product dimensions (L x H x W): 2 in x 2 in x 3.75 in
- Projection: 1 in
- Weight capacity: 15 lb
- Installation notes: requires drilling a 3/4 in diameter hole through drywall plus three small holes; includes toggle bolts (6/32 toggles)
...
**Token Usage:** Prompt tokens: 6112, Completion tokens: 1777
**Estimated Cost:** $0.035574
...
| design_intent_keywords | retractable hooks and garment rods collection, transitional bathroom hardware, versatile bath accessories, wall mount | enrichment_keywords |
...
- Product is a modern retractable wall hook. (source: current_title=Modern Retractable Wall Hook)
- Pull-out provides 2-1/2 inches of hanging space and retracts when not in use. (source: current_description=The rod pulls out to provide 2-1/2'' of hanging space, then can be pushed back in so it's out of the way when not in use.)
...
- Option to remove supplied knob tip and replace with a cabinet knob of your own. (source: bullet_1=Gives you the option to remove the knob tip supplied with the item and replace it with a cabinet knob of your own, allowing you to match existing ones in the room!)
- Fits standard interior walls. (source: bullet_3=Fits standard interior walls)
- Installation requires drilling a 3/4" diameter hole through drywall and three small holes around. (source: bullet_4=Installation does require drilling a 3/4" dia. hole through drywall and 3 small holes around)
- All mounting hardware included. (source: bullet_6=All mounting hardware included)
- Dimensions are 2 in (L) x 2 in (H) x 3.75 in (W); projection is 1 in. (source: current_description=Product dimensions, in. (LxHxW): 2x2x3.75)
- 2 in (source: product_length=2 in)
- 3.75 in (source: product_width=3.75 in)
- 1 in (source: projection=1 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 76.67% | 76.67% | 76.67% | 76.67% |  |
| 2 | 0 | 72.33% | 73.33% | 73.33% | 66.67% |  |
| 3 | 1 | 72.33% | 73.33% | 73.33% | 66.67% |  |
