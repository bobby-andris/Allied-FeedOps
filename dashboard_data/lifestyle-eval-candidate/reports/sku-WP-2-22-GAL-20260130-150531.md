...
**Generated:** 2026-01-30T15:05:31.845569
**Status:** APPROVED
...
**Title (105 chars):**
```
Double Glass Shelf 22-Inch, Wall Mount Solid Brass Gallery Rail, Waverly Place Collection -, Allied Brass
```

**Description (621 chars):**
```
Double glass shelf, 22-inch wide x 5-inch deep x 8-inch high, wall mount bathroom storage with solid brass hardware and a gallery rail to keep items secure. Features two tempered glass shelves made from 3/8-in (0.38 in) thick glass for safety and strength. Concealed screw mounting creates a clean look and installs with included hardware; #8 x 1 1/4" screws specified. Use as a bathroom wall shelf for toiletries, bottles, and decor in a transitional/traditional space. Rated 4 lb weight capacity. Includes glass shelf and all installation hardware. Backed by a lifetime warranty. Allied Brass, Waverly Place collection.
```
...
**Token Usage:** Prompt tokens: 6556, Completion tokens: 1572, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.031241
...
- Overall size is 22 in length x 5 in width/projection x 8 in height. (source: current_description=Length, in Depth, in Height, in Weight, lbs 16 Inch 16 5 8 10.4 22 Inch 22 5 8 12)
- Mounting type is wall mount. (source: mounting_type=Wall mount)
- Tempered glass thickness is 3/8 in (0.38 in). (source: thickness=0.38 in)
...
- Backed by a lifetime warranty. (source: current_description=finished with the highest quality materials to provide a lifetime of beauty.)
...
| 2 | 0 | 85.17% | 86.67% | 83.33% | 80.00% |  |
| 3 | 2 | 83.33% | 83.33% | 86.67% | 80.00% |  |
