...
**Generated:** 2026-01-29T01:02:44.676729
**Status:** APPROVED
...
```
Keep bath towels close at hand without drilling into the wall. This freestanding 4 pivoting swing arm towel stand creates flexible hanging space so you can separate towels for faster drying and a tidier bathroom.

Highlights:
- Organize multiple towels at once—4 pivoting swing arms let you spread towels out or fold arms in to save space
- Place it anywhere—freestanding design requires no wall mounting, ideal beside a shower, tub, or vanity
- Stay stable on the floor—large weighted base is designed to help prevent tipping
- Built for daily bathroom use—crafted from solid brass materials
- Coordinate your look—available in multiple designer finish options to match versatile bath accessories

Specs & Installation:
- Overall dimensions (L x H x W): 12 in. x 49 in. x 9.25 in.
...
- Claim rejected: 'Crafted from solid brass materials.' - Claimed 'Towel stand is made of the finest solid brass materials so that it will not rust or corrode...' but actual value is 'This elegantly designed freestanding swing arm towel stand provides a convenient and stylish space to hang your favorite towels. Towel stand has 4 pivoting arms so that you can maximize your space. Large base is weighted to help prevent tipping. Towel stand is made of the finest solid brass materials so that it will not rust or corrode and is provided with one of our designer lifetime finishes. Crafted of the Finest Solid Brass Materials Heavy base will help prevent tipping Available in a variety of lifetime designer finishes Products are provided with a limited lifetime warranty Some assembly required Assembled in the USA Specification & Documentation Product dimensions, in. (LxHxW): 12x49x9.25 Box dimensions, in. (LxHxW): 20x12x54 Shipping weight, lbs: 17'
...
- Towel stand has 4 pivoting arms. (source: current_description=Towel stand has 4 pivoting arms so that you can maximize your space.)
...
- Dimensions are 12 x 49 x 9.25 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 12x49x9.25)
- Shipping weight is 17 lbs. (source: current_description=Shipping weight, lbs: 17)
- Includes a limited lifetime warranty. (source: current_description=Products are provided with a limited lifetime warranty)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 79.50% | 80.00% | 76.67% | 80.00% |  |
| 2 | 1 | 79.50% | 80.00% | 76.67% | 80.00% |  |
