...
**Generated:** 2026-01-29T12:13:51.950971
**Status:** APPROVED
...
**Title (104 chars):**
```
Towel Shelf With Drying Rack, 24.7-Inch, Solid Brass, Wall Mount, Towel Shelves Collection, Allied Brass
```

**Description (933 chars):**
```
Get towels off the counter and keep them ready to use with a wall-mounted towel shelf that adds organized storage in one spot.

Highlights:
- Create instant storage for folded towels with a three-tier hotel-style towel shelf design
- Dry and hang towels efficiently with the integrated drying rack below
- Keep a clean, finished look on the wall with concealed screw mounting hardware
- Fit more function into less space with a space-saving, versatile design—ideal for guest baths and shared bathrooms
- Coordinate your bathroom with multiple designer finish options in the Towel Shelves collection

Specs & Installation:
- Material: brass
- Mounting: wall mount (concealed screw mounting)
- Assembly: some assembly required
- Dimensions (L x H x W): 24.7 in x 10.4 in x 8.9 in
- Projection: 3.5 in
- Product weight: 5.6 lb
- Included: towel shelf arms (3), back plate, and installation hardware
...
**Token Usage:** Prompt tokens: 5924, Completion tokens: 1488
**Estimated Cost:** $0.031199
...
| collection | Towel Shelves | collection |
...
| collection_context | Towel Shelves (Unknown) - distinctive design | enrichment_collection |
...
| key_differentiators | Part of coordinated Towel Shelves collection; 28 finish options including statement colors | enrichment_competitive |
| design_intent_keywords | towel shelves collection, transitional bathroom hardware, versatile bath accessories, wall mount | enrichment_keywords |
...
- Includes towel shelf arms (3), back plate, and all installation hardware (source: included_items=Towel shelf arms (3), back plate and all installation hardware.)
- Dimensions are 24.7 in (L) x 10.4 in (H) x 8.9 in (W) (source: product_length=24.7 in)
