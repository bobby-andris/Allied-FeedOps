...
**Generated:** 2026-01-25T19:44:33.632098
**Status:** APPROVED
...
**Title (94 chars):**
```
retractable hooks and garment rod Wall Mount 2-1/2-Inch Hanging Space Solid Brass Allied Brass
```

**Description (1158 chars):**
```
Add compact hanging space with a wall mount retractable hook and garment rod that pulls out for 2-1/2-Inch of hanging space and pushes back in when not needed. Crafted from solid brass, it’s designed for modern bathroom hardware layouts where a clean, architectural look matters.

Highlights:
- Retractable rod pulls out to provide 2-1/2-Inch of hanging space, then retracts to stay out of the way
- Wall mount design helps keep storage off floors for a minimalist, space-saving setup
- Solid brass construction for enduring everyday use
- Supports up to 15 lb for coats, robes, or towels
- Knob tip can be removed and replaced with a cabinet knob of your choice to coordinate with existing room hardware

Specs & Installation:
- Mounting: Wall mount
- Material: Brass
- Overall size: 3.75 in W x 2 in H x 2 in L; 1 in projection
- Weight capacity: 15 lb
- Hardware: Includes toggle bolts (6/32 toggles)
- Wall requirement: Fits standard interior walls; installation requires drilling a 3/4 in diameter hole through drywall and 3 small holes around
...
- Claim rejected: 'Rod pulls out to provide 2-1/2 inches of hanging space and retracts when not in use.' - Claimed 'Avondale Decor's retractable wall hook is a unique and space-saving solution... The rod pulls out to provide 2-1/2" of hanging space, then can be pushed back in so it's out of the way when not in use.' but actual value is 'Avondale Decor's retractable wall hook is a unique and space-saving solution for hanging coats, robes, towels, or any other items you need to keep within reach. The hook installs quickly and easily without the need for additional support on or built into the wall — just drill a hole and use the included toggle bolts to fasten it in place. The rod pulls out to provide 2-1/2" of hanging space, then can be pushed back in so it's out of the way when not in use. Choose from 17 stylish finishes and four different models to match your decor.'
...
- Overall dimensions are 3.75 in wide x 2 in high x 2 in long with 1 in projection. (source: product_width=3.75 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 78.50% | 80.00% | 73.33% | 76.67% |  |
| 2 | 2 | 76.67% | 76.67% | 73.33% | 80.00% | bing_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
| 3 | 0 | 75.67% | 76.67% | 73.33% | 73.33% | bing_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
