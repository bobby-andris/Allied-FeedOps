...
**Generated:** 2026-01-30T15:02:57.275810
**Status:** APPROVED
...
```
Grab bar, 63-inch extended length with 3-post wall mount, iron pipe construction, ADA compliant support bar for safer bathroom accessibility. This bathroom grab bar uses a third center bracket for added stability and a powder coat finish for corrosion-free, rust-free performance. Industrial, pipe-style design matches loft bathroom fixtures and industrial bathroom hardware, ideal for seniors, caregivers, and accessible bath layouts. Dimensions: 63 in L x 3 in H x 3.58 in projection. Rated 250 lb weight capacity. Part of the Pipeline collection for matching pipeline, pipe-style bath accessories and pipe-style accessories. Limited lifetime warranty. Allied Brass Pipeline.
```
...
**Token Usage:** Prompt tokens: 6603, Completion tokens: 1443, Cached tokens: 5632 (85% cache hit)
**Estimated Cost:** $0.026829
...
- Product is a grab bar with extended length and 3-post design. (source: current_title=Pipeline Extended 3 Post Grab Bar - 60 inch)
- ADA compliant grab bar. (source: bullet_2=ADA Compliant)
- Third center bracket provides added stability. (source: bullet_3=Bars feature a third center bracket to ensure stability)
- Wall mount installation. (source: mounting_type=Wall mount)
- Material is iron pipe. (source: material=Iron Pipe)
- Protected with a highly durable powder coat finish. (source: bullet_4=Protected using highly durable powder coat finish)
...
- Rated 250 lb weight capacity. (source: weight_capacity=250 lb)
- Product dimensions are 63 in L x 3 in H x 3.58 in W/projection. (source: current_description=Product dimensions, in. (LxHxW): 63x3x3.58)
- Projection is 3.58 in. (source: projection=3.58 in)
- Part of the Pipeline collection with industrial, pipe-style design intent. (source: collection_context=Pipeline (Contemporary Specialty) - authentic industrial, loft-style)
...
| 2 | 0 | 79.83% | 83.33% | 86.67% | 56.67% |  |
| 3 | 1 | 78.00% | 80.00% | 86.67% | 60.00% |  |
