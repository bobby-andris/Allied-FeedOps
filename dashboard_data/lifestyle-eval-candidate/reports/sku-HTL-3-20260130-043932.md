...
**Generated:** 2026-01-30T04:39:32.405262
**Status:** APPROVED
...
**Title (110 chars):**
```
Hotel-Style Towel Shelf, 24.7-Inch Wall Mount Brass 3-Tier Drying Rack, Traditional Bath Storage, Allied Brass
```

**Description (610 chars):**
```
Hotel-style towel shelf with drying rack, 24.7 in L x 10.4 in H x 8.9 in W, brass construction, wall mount bathroom storage for folded towels and daily linens. Three-tier train rack design maximizes vertical space while keeping towels organized and accessible. Traditional style accessory for classic bath accessories and heritage bathroom fixtures. Concealed screw mounting hardware supports a clean, built-in look; includes back plate and all installation hardware. Some assembly required. Offered in a wide variety of lifetime designer finishes and backed by a Limited Lifetime Warranty. Allied Brass HTL-3.
```
...
**Token Usage:** Prompt tokens: 6333, Completion tokens: 1499, Cached tokens: 4352 (68% cache hit)
**Estimated Cost:** $0.028261
...
- Dimensions are 24.7 in (L) x 10.4 in (H) x 8.9 in (W). (source: current_description=Product dimensions, in. (LxHxW): 23x10x9)
- Product length is 24.7 in, height 10.4 in, width 8.9 in. (source: product_length=24.7 in)
...
| 2 | 2 | 79.50% | 80.00% | 80.00% | 76.67% | shopify_title must end with Allied Brass |
| 3 | 1 | 78.50% | 80.00% | 76.67% | 73.33% | shopify_title must end with Allied Brass |
