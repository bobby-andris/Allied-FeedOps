...
**Generated:** 2026-01-30T04:30:17.020618
**Status:** APPROVED
...
```
Wall-mounted paper towel holder, 15.5 in L x 3 in H x 4 in W, powder-coated iron pipe-style design for kitchen paper towel storage and dispensing. Industrial modern look inspired by pipe fittings; contemporary design with rustic influences for loft-style kitchens. Wall mount installation saves counter space and keeps a roll within reach; mounts firmly with color-coordinated mounting hardware (screw size #8 x 1 1/4). Corrosion-free and rust-free performance with a highly durable powder coat finish. Includes paper towel holder and all installation hardware; no assembly required. Weight capacity 250 lb. Limited Lifetime Warranty. Allied Brass Pipeline collection.
```
...
**Token Usage:** Prompt tokens: 6469, Completion tokens: 1490, Cached tokens: 4480 (69% cache hit)
...
- Collection name is Pipeline. (source: collection=Pipeline)
- Material is iron. (source: material=Iron)
- Mounting type is wall mount. (source: mounting_type=Wall mount)
- Product dimensions are 15.5 in (L) x 3 in (H) x 4 in (W). (source: current_description=Product dimensions, in. (LxHxW): 15.5x3x4)
- Projection is 4 in. (source: projection=4 in)
- Assembly is not required. (source: assembly_required=False)
- Included items are paper towel holder and all installation hardware. (source: included_items=Paper towel holder and all installation hardware.)
- Mounting screw size is #8 X1 1/4". (source: screw_size=#8 X1 1/4")
- Weight capacity is 250 lb. (source: weight_capacity=250 lb)
- Product is protected using a highly durable powder coat and uses powder coated pipe for a clean finish. (source: bullet_2=Protected using highly durable powder coat)
- Product has a Limited Lifetime Warranty. (source: bullet_5=Limited Lifetime Warranty)
...
| 2 | 2 | 76.67% | 76.67% | 76.67% | 76.67% | shopify_title must end with Allied Brass |
| 3 | 0 | 76.17% | 76.67% | 76.67% | 73.33% | shopify_title must end with Allied Brass |
