...
**Generated:** 2026-01-29T02:13:28.481422
**Status:** REJECTED
...
**Title (126 chars):**
```
Modern Retractable Wall Hook, 2-1/2-Inch Extension, Holds 15 Lb, Retractable Hooks And Garment Rods Collection, | Allied Brass
```

**Description (1043 chars):**
```
Need hanging space without a hook sticking out all the time? This modern retractable wall hook extends when you need it and pushes back in for a clean, low-profile look.

Highlights:
- Keep robes, towels, and coats within reach, then tuck it away—retractable rod pulls out 2-1/2-Inch and pushes back in
- Reduce clutter in tight bathroom layouts—space-saving design is ideal behind doors or near vanities
- Hang everyday essentials with confidence—rated to hold up to 15 lb
- Coordinate your room’s look—part of the retractable hooks and garment rods collection with multiple designer finish options available
- Personalize the detail—option to remove the supplied knob tip and replace it with your own cabinet knob

Specs & Installation:
- Extension (hanging space): 2-1/2-Inch
- Product dimensions (L x H x W): 2 x 2 x 3.75 in.
- Weight capacity: up to 15 lb
- Wall type: fits standard interior walls
- Installation: drill a 3/4-Inch diameter hole through drywall plus three small holes around it; includes toggle bolts and mounting hardware
```
...
- Retractable wall hook extends to provide 2-1/2 inches of hanging space and pushes back in when not in use. (source: current_description=The rod pulls out to provide 2-1/2'' of hanging space, then can be pushed back in so it's out of the way when not in use.)
- Holds up to 15 pounds. (source: current_description=Can hold up to 15 pounds)
- Installation requires drilling a 3/4-inch diameter hole through drywall plus three small holes around it. (source: current_description=Installation does require drilling a 3/4'' dia. hole through drywall and 3 small holes around)
- Option to remove the supplied knob tip and replace it with your own cabinet knob. (source: current_description=Gives you the option to remove the knob tip supplied with the item and replace it with a cabinet knob of your own)
- Product dimensions are 2 x 2 x 3.75 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 2x2x3.75)
- Available in multiple designer finish options (28 finishes including statement colors). (source: key_differentiators=28 finish options including statement colors)
