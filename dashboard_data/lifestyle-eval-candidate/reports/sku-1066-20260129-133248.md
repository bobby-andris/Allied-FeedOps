...
**Generated:** 2026-01-29T13:32:48.342660
**Status:** APPROVED
...
**Title (105 chars):**
```
Vanity Top Toilet Tissue Holder, 6-Inch H X 5.5-Inch L, Solid Brass, Vanity Top Accessories, Allied Brass
```

**Description (815 chars):**
```
Keep toilet paper within easy reach when wall space is limited—right on the vanity top or countertop.

Highlights:
- Save wall space with a countertop vanity top toilet tissue holder designed for compact bathrooms
- Stay stable during everyday use with a solid brass weighted base that prevents tipping
- Protect your surfaces with a felt pad on the base to prevent scratching
- Coordinate your look with multiple designer finish options from the Vanity Top Accessories collection
- Count on enduring construction with solid brass materials and a Limited Lifetime Warranty

Specs & Installation:
- Product type: Vanity top toilet tissue holder (countertop)
- Material: Brass
- Dimensions (L x H x W): 5.5 in x 6 in x 5 in
- Product weight: 4 lb
...
**Token Usage:** Prompt tokens: 5874, Completion tokens: 1365
**Estimated Cost:** $0.029389
...
- Countertop mounting / freestanding vanity-top use. (source: mounting_type=Countertop)
...
- Dimensions are 5.5 in L x 6 in H x 5 in W. (source: current_description=Product dimensions, in. (LxHxW): 5.5x6x5)
...
- Limited Lifetime Warranty included. (source: bullet_6=Limited Lifetime Warranty)
- 6-Inch (source: product_height=6 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 85.17% | 86.67% | 83.33% | 80.00% |  |
| 2 | 1 | 80.50% | 80.00% | 83.33% | 80.00% |  |
| 3 | 2 | 84.33% | 83.33% | 86.67% | 86.67% | google_description missing 2 description term(s); found 1 |
