...
**Generated:** 2026-01-30T04:53:17.516246
**Status:** APPROVED
...
**Title (90 chars):**
```
Modern Retractable Wall Hook, 2-1/2-Inch Pull-Out, Wall Mount Brass Hardware, Allied Brass
```

**Description (662 chars):**
```
Modern retractable wall hook with 2-1/2 inch pull-out hanging space in brass construction for bathroom storage of towels, robes, and clothing. Wall mount design retracts back into the wall to keep a clean, minimalist look when not in use. Installs in standard interior walls; requires drilling a 3/4 inch diameter hole through drywall plus 3 small holes, and includes 6/32 toggle fasteners and mounting hardware. Rated to hold up to 15 lb. Optional removable knob tip lets you swap in your own cabinet knob to match existing bathroom hardware. Modern bathroom hardware for contemporary bath accessories and minimalist bathroom fixtures, wall mount. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6500, Completion tokens: 1639, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.032081
...
- Pull-out hanging space is 2-1/2 inches. (source: current_description=The rod pulls out to provide 2-1/2'' of hanging space)
...
- Installation requires drilling a 3/4 inch diameter hole through drywall and 3 small holes. (source: bullet_4=Installation does require drilling a 3/4" dia. hole through drywall and 3 small holes around)
...
- Overall product dimensions are 2 in (L) x 2 in (H) x 3.75 in (W). (source: current_description=Product dimensions, in. (LxHxW): 2x2x3.75)
- Projection is 1 inch. (source: projection=1 in)
- Assembly is not required. (source: assembly_required=False)
- The supplied knob tip can be removed and replaced with a cabinet knob of your own. (source: bullet_1=Gives you the option to remove the knob tip supplied with the item and replace it with a cabinet knob of your own, allowing you to match existing ones in the room!)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 68.17% | 66.67% | 66.67% | 76.67% |  |
| 2 | 2 | 67.67% | 66.67% | 66.67% | 73.33% |  |
| 3 | 0 | 65.83% | 63.33% | 66.67% | 76.67% |  |
