...
**Generated:** 2026-01-29T01:11:29.428807
**Status:** APPROVED
...
```
Keep a hand towel within easy reach at the sink while maintaining a clean, coordinated bathroom look. This Foxtrot towel ring is crafted from solid brass with concealed mounting hardware for a finished appearance.

Highlights:
- Keep daily hand towels accessible by the vanity with a 6-inch diameter ring
- Create a clean wall profile with concealed screw mounting hardware
- Count on enduring construction made from solid brass
- Coordinate your space with the towel rings collection and multiple designer finish options

Specs & Installation:
- Product type: Bathroom towel ring
- Material: Solid brass
- Diameter: 6 inches
- Overall dimensions (L x H x W): 6 x 6 x 6 in.
- Mounting: Concealed screw wall mount hardware
...
- Product is a towel ring from the Foxtrot collection. (source: current_title=Foxtrot Towel Ring)
- Constructed of solid brass. (source: current_description=Towel ring is constructed of solid brass)
- Ring is 6 inches in diameter. (source: current_description=ideal six inches in diameter)
- Concealed screw mounting hardware. (source: current_description=Concealed screw mounting hardware installs easily)
- Available in a variety of designer finishes (28 options including statement colors). (source: key_differentiators=28 finish options including statement colors)
- Assembled in the U.S.A. (source: current_description=Assembled in the U.S.A.)
- Overall product dimensions are 6 x 6 x 6 in. (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 6x6x6)
- Box dimensions are 10 x 6 x 4 in. (L x H x W). (source: current_description=Box dimensions, in. (LxHxW): 10x6x4)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 86.17% | 86.67% | 86.67% | 83.33% |  |
| 2 | 0 | 83.33% | 83.33% | 83.33% | 83.33% |  |
| 3 | 1 | 79.50% | 80.00% | 80.00% | 76.67% |  |
