...
**Generated:** 2026-01-30T04:04:38.219150
**Status:** APPROVED
...
**Title (110 chars):**
```
Shower Curtain Rod Brackets, 3-Inch Wall Mount Solid Brass Pair For 1-Inch Rod, Prestige Regal -, Allied Brass
```

**Description (651 chars):**
```
Shower curtain rod brackets for 1-inch diameter shower rods, 3 in L x 2.25 in H x 3 in W, solid brass construction for wall-mount bathroom installations. Includes a pair of brackets with concealed screw mounting and all installation hardware; shower rod sold separately. Traditional style bracket set designed to support a shower curtain rod while keeping the look clean and refined. Projection: 2 in. Weight capacity: 2 lb. Assembly required: no. Available in multiple designer finishes. Limited lifetime warranty. Part of the Prestige Regal collection for matching Prestige Regal and classic bath accessories in luxury traditional bathroom hardware.
```
...
**Token Usage:** Prompt tokens: 6460, Completion tokens: 1384, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.028441
...
- Product is shower curtain rod brackets (sold as a pair). (source: current_title=Shower Curtain Rod Brackets)
...
- For use with any 1-inch diameter shower rod. (source: bullet_1=For use with any 1-in diameter shower rod)
...
- Shower rod is sold separately. (source: included_items=Shower curtain rod brackets and all installation hardware. Shower rod sold separately!)
- Assembly required: False (no assembly required). (source: assembly_required=False)
- Limited lifetime warranty. (source: bullet_6=Limited Lifetime Warranty)
- Part of the Prestige Regal collection. (source: collection=Prestige Regal)
