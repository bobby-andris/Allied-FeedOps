...
**Generated:** 2026-01-30T04:19:36.928231
**Status:** APPROVED
...
**Title (86 chars):**
```
Soap Dish, 4.5-Inch Wall Mount Solid Brass Bathroom Holder, Dottingham -, Allied Brass
```

**Description (615 chars):**
```
Wall mounted soap dish, 4.5 in L x 3 in H x 3.5 in W with 5 in projection, solid brass bathroom soap holder designed to keep soap off the countertop and reduce sink-side clutter. Wall mount installation with concealed screw mounting hardware; includes brass soap dish holder and all installation hardware (#8 x 1 1/4" screws). Traditional design suited to transitional bath accessories and transitional bathroom hardware layouts; part of the Dottingham collection for matching Dottingham and beaded bathroom hardware coordination. Weight capacity 2 lb. Limited Lifetime Warranty. Allied Brass Dottingham collection.
```
...
**Token Usage:** Prompt tokens: 6405, Completion tokens: 1279, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.026875
...
- Material: brass (solid brass construction) (source: current_description=Made of solid brass)
- Dimensions: 4.5 in L x 3 in H x 3.5 in W (source: current_description=Product dimensions, in. (LxHxW): 4.5x3x3.5)
