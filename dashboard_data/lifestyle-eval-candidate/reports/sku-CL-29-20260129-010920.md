...
**Generated:** 2026-01-29T01:09:20.145002
**Status:** APPROVED
...
**Title (102 chars):**
```
Toilet Paper Stand, 27-Inch Freestanding Euro Holder, Solid Brass, Carolina Collection, | Allied Brass
```

**Description (897 chars):**
```
Need a toilet paper roll within easy reach when wall space is limited? This freestanding toilet paper stand brings classic, traditional styling to your bathroom while keeping a roll ready beside the toilet.

Highlights:
- Place it anywhere you need it—freestanding design with a heavy base that helps prevent tipping
- Change rolls faster—Euro-style open hook makes replacing the roll quick and easy
- Built for daily use—crafted from solid brass materials for enduring strength
- Coordinate your bathroom look—part of the Carolina Collection for matching Carolina and other classic bath accessories
- Finish options to suit your space—available in a variety of designer finishes
...
- Freestanding Euro-style toilet tissue stand (source: current_description=Add the finishing touch to your bathroom with this elegant free standing European style toilet tissue stand.)
- Crafted from solid brass materials (source: current_description=Crafted of the Finest Solid Brass Materials)
- Heavy base helps prevent tipping (source: current_description=Heavy base will help prevent tipping)
- Euro-style hook makes changing the roll quick and easy (source: current_description=European style hook makes changing the roll quick and easy)
- Product dimensions: 8 x 27 x 6 in. (L x H x W) (source: current_description=Product dimensions, in. (LxHxW): 8x27x6)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 85.17% | 86.67% | 83.33% | 80.00% |  |
| 2 | 2 | 80.00% | 80.00% | 83.33% | 76.67% |  |
| 3 | 0 | 74.17% | 76.67% | 76.67% | 60.00% |  |
