...
**Generated:** 2026-01-30T15:08:06.636589
**Status:** APPROVED
...
**Title (102 chars):**
```
Retractable Wall Hook, 2-1/2-Inch Pull-Out, Wall Mount Brass - Carolina (Patent Pending), Allied Brass
```

**Description (630 chars):**
```
Retractable wall hook with 2-1/2" pull-out hanging space and wall-mount brass construction for bathroom coats, robes, and towels. Installs in standard interior walls using included toggle bolts; requires drilling a 3/4" diameter hole through drywall plus three small holes around. Rod pulls out for use and pushes back in when not needed for a space-saving profile. Rated to hold up to 15 lb. Includes a removable knob tip that can be replaced with a cabinet knob of your choice to match existing hardware. Product size: 1.75" L x 1.75" H x 3.75" W; 1" projection. Backed by a lifetime warranty. Allied Brass, Carolina collection.
```
...
**Token Usage:** Prompt tokens: 6686, Completion tokens: 1629, Cached tokens: 2560 (38% cache hit)
**Estimated Cost:** $0.032267
...
- Provides 2-1/2 inches of hanging space (pull-out rod). (source: current_description=The rod pulls out to provide 2-1/2" of hanging space, then can be pushed back in so it's out of the way when not in use.)
- Holds up to 15 pounds. (source: weight_capacity=15 lb)
- Fits standard interior walls. (source: bullet_3=Fits standard interior walls)
- Installation requires drilling a 3/4-inch diameter hole through drywall plus three small holes around. (source: current_description=Installation does require drilling a 3/4" dia. hole through drywall and 3 small holes around)
- Includes toggle bolts / all mounting hardware included. (source: bullet_6=All mounting hardware included)
- Removable knob tip can be replaced with a cabinet knob of your choice. (source: bullet_1=Gives you the option to remove the knob tip supplied with the item and replace it with a cabinet knob of your own, allowing you to match existing ones in the room!)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 77.17% | 76.67% | 80.00% | 76.67% |  |
| 2 | 1 | 74.83% | 73.33% | 80.00% | 76.67% |  |
| 3 | 2 | 69.67% | 66.67% | 73.33% | 80.00% |  |
