...
**Generated:** 2026-01-30T04:42:49.701735
**Status:** APPROVED
...
**Title (112 chars):**
```
Freestanding Coat Rack, 60-Inch Solid Brass With 8 Pivoting Pegs, Weighted Base, Traditional Style, Allied Brass
```

**Description (646 chars):**
```
Freestanding coat rack with eight pivoting pegs, 60-inch tall with a 10-inch x 10-inch footprint, solid brass construction for bathroom organization. Freestanding design requires no wall mounting; weighted base improves stability and helps prevent tipping; felt pad helps protect floors. Traditional style with contemporary design elements for classic bath accessories and heritage bathroom fixtures. Holds coats, hats, robes, and towels; some assembly required. Dimensions: 10 in L x 60 in H x 10 in W. Weight capacity: 18 lb. Product weight: 14.4 lb. Available in multiple designer finish options. Includes freestanding coat rack. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6438, Completion tokens: 1422, Cached tokens: 4480 (69% cache hit)
**Estimated Cost:** $0.027255
...
- Product is a freestanding coat rack with eight pivoting pegs. (source: current_title=Freestanding Coat Rack with Eight Pivoting Pegs)
- Material is brass and described as solid brass materials. (source: bullet_1=Crafted from the finest solid brass materials)
- Freestanding design requires no wall mounting. (source: feature_benefits=freestanding design requires no wall mounting)
...
- Felt pad helps prevent scratching on any surface. (source: bullet_4=Felt pad will prevent scratching on any surface)
- Overall product dimensions are 10 in L x 60 in H x 10 in W. (source: current_description=Product dimensions, in. (LxHxW): 10x60x10)
...
- Included item is a freestanding coat rack. (source: included_items=Freestanding coat rack.)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 74.33% | 73.33% | 73.33% | 80.00% |  |
| 2 | 0 | 77.17% | 76.67% | 80.00% | 76.67% | shopify_title must end with Allied Brass |
| 3 | 1 | 71.00% | 70.00% | 70.00% | 76.67% | shopify_title must end with Allied Brass |
