...
**Generated:** 2026-01-25T05:31:42.999084
**Status:** APPROVED
...
**Title (73 chars):**
```
Wall Mount towel bar Hand Towel Holder 6.65-Inch Solid Brass Allied Brass
```

**Description (981 chars):**
```
Add refined, wall mount storage at the sink with this solid brass hand towel holder—crafted to keep guest towels and washcloths within easy reach. Designed in the classic Essex collection for a traditional, timeless bathroom look.

Highlights:
- Wall-mounted design helps save floor space and keeps towels accessible
- Solid brass construction for an enduring, substantial feel
- Classic styling to complement traditional bathroom hardware and classic bath accessories
- Mounting hardware included
- Available in a wide variety of lifetime designer finishes, including statement options like Venetian Bronze, Pink, Autumn Sparkle, and Antique Pewter
...
| statement_finishes | venetian bronze, pink, autumn sparkle, antique pewter, lavender | enrichment_finishes |
...
| design_intent_keywords | essex collection, matching essex, traditional bathroom hardware, classic bath accessories, heritage bathroom fixtures, wall mount, venetian bronze bathroom hardware, pink bathroom hardware, autumn sparkle bathroom hardware, antique pewter bathroom hardware | enrichment_keywords |
...
**Verified:** 21/23 claims

### Rejected Claims

- Claim rejected: 'Statement finish examples include venetian bronze, pink, autumn sparkle, antique pewter, and lavender.' - Field 'statement_finishes' not found in source data
- Claim rejected: 'Solid Brass' - Claimed 'Solid Brass' but actual value is 'Brass'

### Verified Claims

- Product is a wall-mounted hand towel holder in the Towel Bars category. (source: category=Towel Bars)
- Collection name is Essex. (source: collection=Essex)
...
- Product length is 6.65 inches. (source: product_length=6.65 in)
- Projection is 3.39 inches and product width is 3.39 inches. (source: projection=3.39 in)
- Product height is 2.1 inches. (source: product_height=2.1 in)
...
| 3 | 0 | 92.33% | 93.33% | 90.00% | 90.00% | shopify_title must end with Allied Brass |
