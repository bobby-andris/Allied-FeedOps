...
**Generated:** 2026-01-30T04:44:23.265942
**Status:** APPROVED
...
**Title (89 chars):**
```
Shower Curtain Rod Wall Brackets, 1-Inch Rod, Solid Brass Wall Mount Pair -, Allied Brass
```

**Description (638 chars):**
```
Shower curtain rod wall brackets for 1-inch diameter shower rods, solid brass construction, wall mount pair for bathroom shower curtain rod installation. Designed to support a shower rod (rod sold separately) and includes installation hardware with concealed screw mounting for a clean traditional look. Brackets measure 3 in L x 2.25 in H x 3 in W with 2 in projection; product weight 1.6 lb and weight capacity 2 lb. Finish-neutral MasterSKU with multiple designer finish options available. Ideal for classic bath accessories and traditional bathroom hardware updates. Limited lifetime warranty. Allied Brass, Prestige Regal collection.
```
...
**Token Usage:** Prompt tokens: 6460, Completion tokens: 1491, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.029939
...
- Claim rejected: 'Product type is shower curtain rod brackets (sold as a pair).' - Claimed 'Shower Curtain Rod Brackets... These items are sold as a pair' but actual value is 'Add the finishing touch to your bathroom with these elegant shower curtain rod brackets. Made of the finest solid brass materials and will never rust or corrode. Brackets are completed with one of our wide variety of lifetime designer finishes. These items are sold as a pair and are manufactured to be used with a 1 inch diameter shower rod. Shower rod sold separately. For use with any 1 Inch diameter shower rod Crafted of the Finest Solid Brass Materials Sold as a pair. Shower Rod must be purchased separately. Products are provided with a limited lifetime warranty Assembled in the USA Specification & Documentation Product dimensions, in. (LxHxW): 3x2.25x3 Box dimensions, in. (LxHxW): 6x6x6 Shipping weight, lbs: 2 Installation Instruction Technical Specification PR99-Installation.PDF PR99-Specification.PDF'
...
- Designed for use with any 1-inch diameter shower rod; shower rod sold separately. (source: current_description=manufactured to be used with a 1 inch diameter shower rod. Shower rod sold separately.)
- Wall mount installation with concealed screw mounting hardware. (source: bullet_4=Concealed screw mounting hardware makes installation easy)
- Crafted from solid brass materials. (source: bullet_2=Crafted from the finest solid brass materials)
- Includes shower curtain rod brackets and all installation hardware; shower rod not included. (source: included_items=Shower curtain rod brackets and all installation hardware. Shower rod sold separately!)
- Product dimensions are 3 in (L) x 2.25 in (H) x 3 in (W). (source: current_description=Product dimensions, in. (LxHxW): 3x2.25x3)
...
- Part of the Prestige Regal collection with traditional style context. (source: collection=Prestige Regal)
...
| 2 | 1 | 81.00% | 80.00% | 83.33% | 83.33% |  |
| 3 | 2 | 79.00% | 80.00% | 70.00% | 83.33% |  |
