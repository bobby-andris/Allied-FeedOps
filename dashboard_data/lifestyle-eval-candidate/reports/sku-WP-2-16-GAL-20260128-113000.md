...
**Generated:** 2026-01-28T11:30:00.107997
**Status:** APPROVED
...
```
Stop clutter from taking over your bathroom vanity—add double-tier wall storage that keeps everyday items organized and secure. This Waverly Place collection glass shelf features a gallery rail designed to keep items in place, with two levels to maximize space in one wall-mounted accessory.

Highlights:
- Keep toiletries secure: gallery rail helps prevent items from sliding off the shelf
- Add more storage without crowding: double shelf design is an ideal use of space
- Choose strength for daily use: 3/8-inch thick tempered glass for safety and durability
- Built for enduring hardware performance: solid brass construction
- Clean, finished look on the wall: concealed screw mounting hardware

Specs & Installation:
- Glass size (each shelf): 16 x 5 inches
- Overall dimensions: 16 in L x 8 in H; projection: 5 in
...
- Part of the Waverly Place collection for matching Waverly Place and other transitional bath accessories and transitional bathroom hardware.
```
...
- Hardware made of solid brass (source: current_description=Tempered glass is 3/8 Inches thick and all of the hardware is made of solid brass and finished with the highest quality materials to provide a lifetime of beauty.)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 80.00% | 80.00% | 80.00% | 80.00% |  |
| 2 | 0 | 79.50% | 80.00% | 80.00% | 76.67% |  |
| 3 | 2 | 77.67% | 76.67% | 80.00% | 80.00% |  |
