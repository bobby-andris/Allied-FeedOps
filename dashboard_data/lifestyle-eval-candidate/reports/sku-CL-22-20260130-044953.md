...
**Generated:** 2026-01-30T04:49:53.552218
**Status:** APPROVED
...
**Title (92 chars):**
```
Retractable Wall Hook (Patent Pending), 2-1/2-Inch Wall Mount Brass - Carolina, Allied Brass
```

**Description (641 chars):**
```
Retractable wall hook (patent pending) with 2-1/2" hanging space and wall mount installation for bathroom robes, towels, and garments. Brass construction with traditional styling; rod pulls out to provide hanging space and pushes back in when not in use. Fits standard interior walls; installs by drilling a 3/4" diameter hole through drywall plus 3 small holes around, then fastening with included toggle bolts (6/32 toggles). Includes all mounting hardware. Product size 1.75" L x 1.75" H x 3.75" W with 1" projection; holds up to 15 lb. Compatible with optional knob-tip swap using your own cabinet knob. Allied Brass Carolina collection.
```
...
**Token Usage:** Prompt tokens: 6578, Completion tokens: 1769, Cached tokens: 2560 (38% cache hit)
**Estimated Cost:** $0.034037
...
**Verified:** 16/16 claims

### Verified Claims

- Product is a retractable wall hook (patent pending). (source: current_title=Carolina Retractable Wall Hook (Patent Pending))
- Wall mount installation. (source: mounting_type=Wall mount)
- Brass material. (source: material=Brass)
- Provides 2-1/2 inches of hanging space when pulled out. (source: bullet_5=2 1/2" of hanging space)
...
- Installation requires drilling a 3/4" diameter hole through drywall and 3 small holes around. (source: bullet_4=Installation does require drilling a 3/4" dia. hole through drywall and 3 small holes around)
- All mounting hardware included. (source: bullet_6=All mounting hardware included)
- Uses 6/32 toggles. (source: screw_size=6/32 toggles)
- Option to remove the supplied knob tip and replace it with a cabinet knob of your own. (source: bullet_1=Gives you the option to remove the knob tip supplied with the item and replace it with a cabinet knob of your own, allowing you to match existing ones in the room!)
- Product dimensions are 1.75 in L x 1.75 in H x 3.75 in W. (source: current_description=Product dimensions, in. (LxHxW): 1.75x1.75x3.75)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 67.67% | 66.67% | 63.33% | 76.67% |  |
| 2 | 1 | 68.67% | 66.67% | 66.67% | 80.00% | google_title missing title anchor in first 70 chars: carolina retractable wall hook (patent pending); bing_title missing title anchor in first 70 chars: carolina retractable wall hook (patent pending) |
| 3 | 0 | 66.17% | 66.67% | 66.67% | 63.33% | google_title missing title anchor in first 70 chars: carolina retractable wall hook (patent pending); bing_title missing title anchor in first 70 chars: carolina retractable wall hook (patent pending); shopify_title must end with Allied Brass |
