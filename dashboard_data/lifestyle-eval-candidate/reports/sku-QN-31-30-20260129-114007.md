...
**Generated:** 2026-01-29T11:40:07.688709
**Status:** APPROVED
...
```
End the daily scramble for a dry towel with a wall-mounted bar that keeps bath towels hung neatly and within reach. From the Que New collection, this transitional towel bar coordinates easily with matching Que New pieces for a pulled-together bathroom.

Highlights:
- Keep towels organized and off the counter with a straight, wall-mounted towel bar
- Enjoy an enduring, rust-resistant build with solid brass construction
- Get a clean, finished look with concealed screw mounting hardware
- Coordinate a cohesive bath with Que New collection styling and grooved bathroom hardware-inspired detailing
- Choose the look you want with multiple designer finish options
...
- Included: towel bar, mounting plates, and all installation hardware (screw size #8 x 1 1/4")
...
**Token Usage:** Prompt tokens: 5984, Completion tokens: 1350
**Estimated Cost:** $0.029372
...
- Product type is a towel bar with a straight bar shape. (source: shape=straight bar)
- 30-inch center-to-center measurement. (source: center_to_center=30 in)
- Made of brass (solid brass construction referenced in provided content). (source: material=Brass)
...
- Part of the Que New collection. (source: collection=Que New)
...
| 2 | 1 | 94.67% | 96.67% | 90.00% | 90.00% | bing_title must end with Allied Brass |
| 3 | 2 | 90.00% | 90.00% | 90.00% | 90.00% | bing_title must end with Allied Brass |
