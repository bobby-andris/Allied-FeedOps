...
**Generated:** 2026-01-28T03:13:11.345317
**Status:** REJECTED
...
**Title (88 chars):**
```
Shower Basket 18.75-Inch Oval Solid Brass Wall Mount | Baskets Collection | Allied Brass
```

**Description (988 chars):**
```
Stop bottles and soap from crowding the shower ledge—this shower basket creates organized, easy-to-reach storage with a distinctive, transitional look.

Highlights:
- Keep shower essentials contained: long oval basket stores shampoo, conditioner, and body wash in one place
- Drain and dry faster: ventilated heavy-gauge wire design lets water flow through
- Built for humid bathrooms: solid brass construction is designed to never rust
- Clean, finished installation: concealed screw mounting system hides hardware
- Coordinate your bath: part of the Baskets collection for a cohesive set of versatile bath accessories

Specs & Installation:
- Product dimensions (L x H x W): 18.75 x 2.25 x 4.125 in.
- Box dimensions (L x H x W): 24 x 8 x 8 in.
- Shipping weight: 6 lbs
- Mounting: wall mounted; concealed screw mounting system
- Material: solid brass
- Style context: transitional bathroom hardware
...
- Claim rejected: 'Made of solid brass with heavy-gauge ventilated wires designed to never rust.' - Claimed 'This decorative basket is made of solid brass... Ventilated wires are made of heavy gauge solid brass material that will never rust.' but actual value is 'This decorative basket is made of solid brass to provide a lifetime of superior performance and durability. Ventilated wires are made of heavy gauge solid brass material that will never rust. Highest quality designer finishes provide a decorative accessory that would be a great addition to any bath or shower design. Matte Black, a rich black satin-like finish that makes a bold, dramatic statement Concealed Screw Mounting System Designer Finish will provide corrosion free performance Assembled in the U.S. A. Specification & Documentation Product dimensions, in. (LxHxW): 18.75x2.25x4.125 Box dimensions, in. (LxHxW): 24x8x8 Shipping weight, lbs: 6 Installation Instruction Technical Specification BSK275LA-Installation.PDF BSK275LA-Specification.PDF'
...
- Multiple designer finish options are available (28 finishes). (source: key_differentiators=Part of coordinated Baskets collection; 28 finish options including statement colors)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 78.50% | 80.00% | 80.00% | 70.00% |  |
| 2 | 2 | 76.67% | 76.67% | 76.67% | 76.67% |  |
| 3 | 0 | 76.17% | 76.67% | 76.67% | 73.33% | bing_title must end with Allied Brass |
