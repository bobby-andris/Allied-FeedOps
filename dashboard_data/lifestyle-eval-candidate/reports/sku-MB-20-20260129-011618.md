...
**Generated:** 2026-01-29T01:16:18.126523
**Status:** REJECTED
...
```
Keep towels and robes off the floor and within easy reach with a compact, sturdy robe hook designed for everyday bathroom use. The Malibu robe hook brings a clean, transitional look that pairs easily with a wide range of decor.

Highlights:
- Create instant hanging space by the shower or vanity with a wall-mounted single hook
- Count on a sturdy feel with solid brass construction
- Coordinate your bathroom with the distinctive Malibu robe hooks collection design
- Match your room easily with multiple designer finish options available
- Install with confidence using included color-coordinated mounting hardware

Specs & Installation:
- Product dimensions (L x H x W): 2 x 2 x 2.64 inches
...
- Claim rejected: 'Constructed of solid brass materials.' - Claimed 'The Malibu Robe Hook is constructed of the finest solid brass materials...' but actual value is 'The contemporary minimalist look of the elegant Malibu collection has timeless appeal. The Malibu Robe Hook is constructed of the finest solid brass materials to provide a sturdy hook for your robes and towels. The hook is finished with our designer lifetime finishes to provide unparalleled performance and durability. Contemporary design fits modern styles Available in a wide variety of lifetime designer finishes Color coordinated mounting hardware included Priced To Fit Any Budget Assembled in the USA Limited Lifetime Warranty Specification & Documentation Product dimensions, in. (LxHxW): 2x2x2.64 Box dimensions, in. (LxHxW): 4x6x10 Shipping weight, lbs: 1 Installation Instruction Technical Specification MB-20-Installation.pdf MB-20-Specification.pdf'
...
- Product type: robe hook (Malibu Robe Hook). (source: current_title=Malibu Robe Hook)
...
- Product dimensions are 2 x 2 x 2.64 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 2x2x2.64)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 74.83% | 73.33% | 80.00% | 76.67% |  |
| 2 | 1 | 74.33% | 73.33% | 76.67% | 76.67% |  |
| 3 | 0 | 73.83% | 73.33% | 76.67% | 73.33% |  |
