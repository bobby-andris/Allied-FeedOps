...
**Generated:** 2026-01-30T14:53:12.872556
**Status:** APPROVED
...
```
Guest towel holder stand, 11-inch size, solid brass construction for bathroom vanity countertops; holds hand towels and washcloths with a two-arm design. Countertop/freestanding vertical stand with a heavy base to resist tipping and a felt pad to protect countertop surfaces from scratches. Traditional/classic styling for traditional bathroom hardware and classic bath accessories. No assembly required. Product dimensions: 16.3 in L x 14 in H x 5.5 in W. Weight capacity: 20 lb. Available in a wide variety of lifetime designer finishes. Limited Lifetime Warranty. Allied Brass Carolina collection.
```
...
**Token Usage:** Prompt tokens: 6446, Completion tokens: 1381, Cached tokens: 5632 (87% cache hit)
**Estimated Cost:** $0.025687
...
- Product is a guest towel stand/guest towel holder stand (source: current_title=Carolina Collection Guest Towel Stand)
- Countertop (freestanding) mounting type (source: mounting_type=Countertop)
- Crafted from solid brass materials / brass construction (source: bullet_1=Crafted from the finest solid brass materials)
- Two arms design to hold towels (source: current_description=Guest towel stand has two arms to keep your towels within reach of the sink where they are needed.)
...
- Traditional design style (source: bullet_4=Traditional design with classic design elements)
...
- 16.3 in (source: product_length=16.3 in)
- 14 in (source: product_height=14 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 80.83% | 83.33% | 73.33% | 76.67% |  |
| 2 | 2 | 79.67% | 76.67% | 86.67% | 86.67% |  |
| 3 | 0 | 77.33% | 73.33% | 83.33% | 90.00% |  |
