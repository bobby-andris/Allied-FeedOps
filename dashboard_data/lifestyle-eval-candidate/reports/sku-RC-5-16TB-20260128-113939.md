...
**Generated:** 2026-01-28T11:39:39.437775
**Status:** APPROVED
...
**Title (84 chars):**
```
Glass Shelf 16-Inch Triple Tier With Towel Bar | Solid Brass Hardware | Allied Brass
```

**Description (1048 chars):**
```
Clear counter clutter and keep towels within reach with a wall-mounted glass shelf that adds storage without taking up floor space. This triple-tier design pairs tempered, beveled-edged glass with solid brass hardware and an integrated towel bar for everyday bathroom organization.

Highlights:
- Organize more essentials in one spot with three tiers of glass shelving
- Keep hand towels or decorative towels ready with the integrated towel bar
- Count on durable, secure support with 3/8-inch thick tempered glass and brass construction
- Maintain a clean, finished look with concealed screw mounting hardware
- Coordinate with traditional bathroom hardware and classic bath accessories throughout the space
...
- Included: glass shelf and all installation hardware (#8 x 1 1/4 in screws)
...
- Triple-tier 16 x 5 inch glass shelf includes an integrated towel bar. (source: current_title=16 Inch Triple Tiered Glass Shelf with Integrated Towel Bar)
- Made with 3/8-inch thick tempered, beveled-edged glass. (source: current_description=Featuring tempered, beveled-edged glass and solid brass hardware)
- Glass thickness is 0.38 in (3/8 in). (source: thickness=0.38 in)
- Solid brass hardware/brass construction. (source: material=Brass)
- Wall mount with concealed screw mounting hardware. (source: bullet_3=Concealed screw mounting hardware makes installation easy)
- Glass dimensions are 16 x 5 inches; overall dimensions are 16 in L x 18 in H x 5 in W. (source: bullet_4=Glass Dimensions: 16 x 5 Inches)
- Weight capacity is 6 lb. (source: weight_capacity=6 lb)
- Includes glass shelf and all installation hardware; assembly not required; Limited Lifetime Warranty. (source: included_items=Glass shelf and all installation hardware.)
