...
**Generated:** 2026-01-30T04:20:29.576044
**Status:** APPROVED
...
**Title:** Triple Tiered Glass Shelf
...
**Title (102 chars):**
```
Glass Shelf, 16-Inch Triple Tier Wall Mount, Solid Brass Hardware, 3/8-In Tempered Glass, Allied Brass
```

**Description (623 chars):**
```
Glass shelf with 16 x 5 inch glass dimensions for bathroom vanity storage, featuring a triple tier wall mount design with solid brass hardware and 3/8-in (0.38 in) thick tempered, beveled-edged glass. Contemporary, modern look for modern bathroom hardware and contemporary bath accessories, ideal for minimalist bathroom fixtures where wall mount organization saves space. Concealed screw mounting provides a clean, finished appearance. Includes glass shelf and all installation hardware; uses #8 x 1 1/4" screws. Weight capacity 6 lb. Available in multiple designer finish options. Limited Lifetime Warranty. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6394, Completion tokens: 1395, Cached tokens: 2560 (40% cache hit)
**Estimated Cost:** $0.028479
...
| current_title | Triple Tiered Glass Shelf | current_title |
| current_description | Add space and organization to your bathroom with this simple, contemporary design 3-tier glass vanity shelf. Featuring tempered, beveled-edged glass and solid brass hardware this shelving unit is crafted for durability, strength and style. One of the many coordinating accessories in the Allied Brass collection of products, this subtle glass shelf unit is the perfect complement to your bathroom decor. Crafted from the finest solid brass materials Made with 3/8-in thick tempered glass for safety and strength Concealed screw mounting hardware makes installation easy Glass Dimensions: 16 (22) x 5 Inches Available in a wide variety of lifetime designer finishes Limited Lifetime Warranty Length, in Depth, in Height, in Weight, lbs 16 Inch 16 5.2 13.9 12 22 Inch 22 5.2 13.9 13.6 Installation Instruction Technical Specification NS516-Installation.PDF NS522-Installation.PDF NS516-Specification.PDF NS522-Specification.PDF | current_description |
...
- Claim rejected: 'Available size is 16 Inch.' - Field 'available_sizes' not found in source data
...
- Product type is a triple tiered glass shelf. (source: current_title=Triple Tiered Glass Shelf)
...
- Glass is 3/8-in thick (0.38 in) tempered glass. (source: thickness=0.38 in)
- Tempered, beveled-edged glass. (source: current_description=Featuring tempered, beveled-edged glass)
- Solid brass hardware / brass material. (source: material=Brass)
- Concealed screw mounting hardware. (source: bullet_3=Concealed screw mounting hardware makes installation easy)
- Screw size is #8 x 1 1/4 inches. (source: screw_size=#8 X1 1/4")
...
- Multiple designer finish options available. (source: bullet_5=Available in a wide variety of lifetime designer finishes)
