...
**Generated:** 2026-01-30T05:02:28.272530
**Status:** APPROVED
...
**Title (108 chars):**
```
Toilet Paper Stand, 28-Inch Freestanding Solid Brass European Tissue Holder, Traditional Style, Allied Brass
```

**Description (643 chars):**
```
Toilet paper stand, 28-inch freestanding solid brass toilet tissue holder for bathroom use with European-style hook for quick roll changes. Traditional style floor stand is ideal when wall space is limited and no wall mounting is desired. Brass construction with a heavy base helps prevent tipping and keeps the stand secure. Includes one toilet tissue stand. Product dimensions: 6.75 in L x 26 in H x 5.5 in W. Assembly required. Available in multiple designer finish options. Limited Lifetime Warranty. Assembled in the USA. Great fit for traditional bathroom hardware, classic bath accessories, and heritage bathroom fixtures. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6307, Completion tokens: 1392, Cached tokens: 2560 (40% cache hit)
**Estimated Cost:** $0.028285
...
- Claim rejected: 'Available size is 28 Inch.' - Field 'available_sizes' not found in source data
...
- Product type is a free standing European style toilet tissue holder / toilet tissue stand. (source: current_title=Free Standing European Style Toilet Tissue Holder)
- Freestanding design requires no wall mounting and is useful when wall space is limited. (source: current_description=This toilet tissue stand is a great product when wall space is at a premium.)
- Made of solid brass materials / brass construction. (source: material=Brass)
...
- Includes: toilet tissue stand. (source: included_items=Toilet tissue stand.)
...
- Available in multiple designer finish options (wide variety). (source: bullet_4=Available in a wide variety of lifetime designer finishes)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 82.83% | 83.33% | 83.33% | 80.00% |  |
| 2 | 1 | 78.67% | 76.67% | 80.00% | 86.67% | shopify_title must end with Allied Brass |
| 3 | 0 | 76.17% | 76.67% | 80.00% | 70.00% | shopify_title must end with Allied Brass |
