...
**Generated:** 2026-01-30T15:17:19.787327
**Status:** APPROVED
...
**Title (102 chars):**
```
Toilet Paper Stand, 26-Inch Freestanding Solid Brass Tissue Holder, Contemporary Style -, Allied Brass
```

**Description (589 chars):**
```
Freestanding toilet paper stand, 26 inches high, solid brass construction for bathroom use when wall space is limited. Contemporary, modern hardware look with a sturdy heavy base to help prevent tipping; felt pad helps protect floors. Includes toilet tissue stand with color-coordinated solid brass tissue roller. Freestanding mounting type (no wall mounting required); some assembly required. Corrosion-free and rust-free performance with designer finish options and a Limited Lifetime Warranty. Product dimensions: 5.5 in L x 26 in H x 6 in W. Shipping weight: 6 lbs. Allied Brass TS-25.
```
...
**Token Usage:** Prompt tokens: 6340, Completion tokens: 1372, Cached tokens: 4352 (68% cache hit)
**Estimated Cost:** $0.026495
...
- Product type is a freestanding toilet tissue holder/stand (toilet paper stand). (source: current_title=Freestanding Toilet Tissue Holder)
...
- Material is solid brass / brass construction. (source: bullet_1=Crafted from the finest solid brass materials)
...
| 2 | 0 | 86.67% | 86.67% | 93.33% | 80.00% |  |
| 3 | 1 | 83.83% | 83.33% | 83.33% | 86.67% |  |
