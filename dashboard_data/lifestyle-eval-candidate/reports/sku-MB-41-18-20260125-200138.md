...
**Generated:** 2026-01-25T20:01:38.050696
**Status:** APPROVED
...
**Title (86 chars):**
```
Wall Mount Towel Bar 18-Inch Solid Brass Straight Bar | Malibu Collection Allied Brass
```

**Description (868 chars):**
```
Add sleek, wall-mounted towel storage with the Malibu Collection towel bar, featuring an 18-inch center-to-center straight bar crafted from solid brass.

Highlights:
- Contemporary, designer-forward look for modern baths
...
- Part of the Malibu Collection for matching Malibu coordinating pieces

Specs:
- Category: Towel bar
- Center-to-center: 18-Inch
- Overall length: 20-Inch
- Projection (depth): 3.39-Inch
- Height: 2-Inch
...
Finish options: Available in multiple designer finish options, including statement colors to complement contemporary bath accessories and statement bath accessories.
```
...
- Collection name is Malibu. (source: collection=Malibu)
...
- Shape is a straight bar. (source: shape=straight bar)
- Center-to-center measurement is 18 in. (source: center_to_center=18 in)
- Overall product length is 20 in. (source: product_length=20 in)
...
- Limited Lifetime Warranty is included. (source: bullet_6=Limited Lifetime Warranty)
...
- 3.39-Inch (source: product_width=3.39 in)
...
| 2 | 2 | 96.17% | 96.67% | 93.33% | 96.67% | bing_description missing description term in first 150 chars |
| 3 | 1 | 93.33% | 93.33% | 90.00% | 96.67% | google_description missing description term in first 150 chars; bing_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
