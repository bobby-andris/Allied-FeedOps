...
**Generated:** 2026-01-30T04:52:22.534407
**Status:** APPROVED
...
**Title (104 chars):**
```
Glass Shelf, 16-Inch Double Wall Mount, Solid Brass Hardware & Gallery Rail, Waverly Place, Allied Brass
```

**Description (652 chars):**
```
Glass shelf, 16 x 5 inch double wall-mount bathroom shelf with 3/8-inch (0.38 in) tempered glass, solid brass hardware, and a gallery rail to help keep items in place. Traditional/transitional styling for versatile bath accessories and transitional bathroom hardware layouts. Concealed screw mounting creates a clean finished look and uses wall space efficiently. Ideal for organizing toiletries, bottles, and everyday bath essentials on two tiers. Includes glass shelf and all installation hardware; assembly not required. Weight capacity: 4 lb. Part of the Waverly Place collection for matching Waverly Place coordination. Allied Brass Waverly Place.
```
...
**Token Usage:** Prompt tokens: 6531, Completion tokens: 1558, Cached tokens: 4608 (70% cache hit)
**Estimated Cost:** $0.029209
...
- Product type is a double glass shelf with gallery rail (source: current_title=Waverly Place Collection Double Glass Shelf with Gallery Rail)
...
- Glass is 3/8-inch thick tempered glass (0.38 in) (source: thickness=0.38 in)
...
- Overall size is 16 in length, 5 in depth/projection, 8 in height (source: current_description=Length, in Depth, in Height, in Weight, lbs 16 Inch 16 5 8 10.4)
- Product weight is 10.4 lb (source: product_weight=10.4 lb)
...
- 8 inches (source: product_height=8 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 77.67% | 76.67% | 76.67% | 83.33% |  |
| 2 | 1 | 76.50% | 80.00% | 80.00% | 56.67% | shopify_title missing title anchor in first 70 chars: glass shelf; shopify_title must end with Allied Brass |
| 3 | 2 | 75.17% | 76.67% | 76.67% | 66.67% | shopify_title must end with Allied Brass |
