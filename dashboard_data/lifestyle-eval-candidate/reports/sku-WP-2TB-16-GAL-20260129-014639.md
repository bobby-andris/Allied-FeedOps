...
**Generated:** 2026-01-29T01:46:39.531782
**Status:** APPROVED
...
**Title (88 chars):**
```
Glass Shelf With Towel Bar, 16-Inch, Solid Brass Hardware, Waverly Place, | Allied Brass
```

**Description (1148 chars):**
```
Stop clutter from taking over your vanity by adding wall-mounted storage right where you need it. This 16-inch glass shelf features a solid brass gallery rail to keep items secure, plus an integrated towel bar for convenient towel storage.

Highlights:
- Keep essentials organized in easy reach—double glass shelf design creates more storage in less space
- Prevent items from sliding—solid brass gallery rail adds a secure edge along the shelf
- Add a dedicated towel spot—clever integrated towel bar keeps hand towels ready by the sink
- Built for everyday bathroom use—3/8-inch thick tempered glass paired with solid brass hardware
- Clean look on the wall—concealed screw mounting hardware

Specs & Installation:
- Overall size: 16 in L x 5 in W x 12 in H (5-in projection)
- Glass thickness: 3/8 in (0.38 in) tempered glass
- Weight capacity: 4 lb
- Mounting: wall mount; installation hardware included (screw size #8 x 1 1/4)
- Assembly: not required
- Collection: Waverly Place collection—coordinate with matching Waverly Place pieces for transitional bath accessories and transitional bathroom hardware
...
- Product type is a 16-inch double glass shelf with an integrated towel bar and gallery rail. (source: current_title=16 Inch Gallery Double Glass Shelf with Towel Bar)
...
- Hardware material is brass / solid brass. (source: material=Brass)
- Weight capacity is 4 lb. (source: weight_capacity=4 lb)
- Dimensions are 16 in length, 5 in width, and 12 in height with 5 in projection. (source: product_length=16 in)
- Included items are the glass shelf and all installation hardware; assembly is not required. (source: included_items=Glass shelf and all installation hardware.)
...
| 2 | 1 | 83.83% | 83.33% | 86.67% | 83.33% |  |
| 3 | 2 | 83.83% | 83.33% | 86.67% | 83.33% |  |
