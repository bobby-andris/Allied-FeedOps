...
**Generated:** 2026-01-30T04:03:01.028789
**Status:** APPROVED
...
```
Freestanding coat rack with eight pivoting pegs, 60-inch height, solid brass construction, for organizing coats, hats, and accessories in the bathroom. Floor-standing, no wall mounting required; traditional style with contemporary design elements. Weighted base for stability to reduce tipping; felt pad helps protect floors and surfaces from scratches. Product dimensions: 10 in L x 60 in H x 10 in W. Assembly required. Includes freestanding coat rack. Supports up to 18 lb weight capacity. Available in multiple designer finish options. Fits traditional bathroom hardware, classic bath accessories, and heritage bathroom fixtures themes while keeping storage freestanding. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6438, Completion tokens: 1241, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.026401
...
- Material: brass (solid brass construction) (source: bullet_1=Crafted from the finest solid brass materials)
- Freestanding mounting; no wall mounting required (source: feature_benefits=freestanding design requires no wall mounting)
...
- Product dimensions: 10 in L x 60 in H x 10 in W (source: current_description=Product dimensions, in. (LxHxW): 10x60x10)
- Weight capacity: 18 lb (source: weight_capacity=18 lb)
- Assembly required (source: assembly_required=True)
- Included item: freestanding coat rack (source: included_items=Freestanding coat rack.)
- Available in multiple designer finish options (source: bullet_5=Available in a wide variety of lifetime designer finishes)
