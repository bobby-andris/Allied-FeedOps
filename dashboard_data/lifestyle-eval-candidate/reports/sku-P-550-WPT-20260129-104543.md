...
**Generated:** 2026-01-29T10:45:43.678315
**Status:** APPROVED
...
```
Keep paper towels within easy reach and off the counter with a wall-mounted paper towel holder designed for everyday kitchen use.

Highlights:
- Save counter space with wall-mount installation—ideal beside a sink, prep area, or grill station
- Get an industrial, pipe-style look with the coordinated Pipeline collection design
- Count on an enduring finish with a highly durable powder coat for a clean, decorative appearance
- Install with confidence—mounts firmly and includes color-coordinated mounting hardware

Specs & Installation:
- Collection: Pipeline (matching pipeline, pipe-style accessories)
- Material: Iron
- Mounting: Wall mount
...
- Included: Paper towel holder and all installation hardware (color coordinated)
...
**Token Usage:** Prompt tokens: 6020, Completion tokens: 1585
**Estimated Cost:** $0.032725
...
- Wall mounted paper towel holder from the Pipeline collection. (source: current_title=Pipeline Collection Wall Mounted Paper Towel Holder)
...
- Includes paper towel holder and all installation hardware, with color coordinated mounting hardware included. (source: included_items=Paper towel holder and all installation hardware.)
...
- Multiple designer finish options available, including 19 finish options. (source: key_differentiators=Part of coordinated Pipeline collection; 19 finish options including statement colors)
...
| 3 | 0 | 83.33% | 83.33% | 83.33% | 83.33% | bing_title must end with Allied Brass |
