...
**Generated:** 2026-01-30T04:07:59.573829
**Status:** REJECTED
...
**Title (92 chars):**
```
Glass Shelf, 22-Inch Double Wall Mount With Gallery Rail, Solid Brass Hardware, Allied Brass
```

**Description (674 chars):**
```
Glass shelf with 22 x 5 inch double tempered glass shelves and gallery rail for secure bathroom storage, wall mount design with concealed screw mounting. Uses 3/8 inch (0.38 in) thick tempered glass for safety and strength, with solid brass hardware for durable support. Overall size: 22 in length, 5 in projection/depth, 8 in height. Includes glass shelf and installation hardware; assembly not required. Traditional/transitional styling for transitional bathroom hardware and versatile bath accessories; ideal for matching Waverly Place collection looks and grooved bathroom hardware themes. Weight capacity: 4 lb. Lifetime warranty. Allied Brass Waverly Place collection.
```
...
**Token Usage:** Prompt tokens: 6529, Completion tokens: 1599, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.031572
...
**Verified:** 14/19 claims

### Rejected Claims

- Claim rejected: 'Hardware is made of solid brass' - Claimed 'Tempered glass is 3/8 Inches thick and all of the hardware is made of solid brass...' but actual value is 'Add a flare of style to your décor with this decorative glass shelf. Shelf can be used anywhere in the home for a great space to store your products. Gallery rail will keep your items secure. Tempered glass is 3/8 Inches thick and all of the hardware is made of solid brass and finished with the highest quality materials to provide a lifetime of beauty. Made with 3/8-in thick tempered glass for safety and strength Crafted from the finest solid brass materials Concealed screw mounting hardware makes installation easy Double shelf is an ideal use of space Glass Dimensions: 16 x 5 Inches Gallery rail designed to keep your items in place Length, in Depth, in Height, in Weight, lbs 16 Inch 16 5 8 10.4 22 Inch 22 5 8 12 Installation Instruction Technical Specification WP216GAL-Installation.PDF WP222GAL-Installation.PDF WP216GAL-Specification.PDF WP222GAL-Specification.PDF'
- Claim rejected: 'Lifetime warranty' - Claimed '...
finished with the highest quality materials to provide a lifetime of beauty.' but actual value is 'Add a flare of style to your décor with this decorative glass shelf. Shelf can be used anywhere in the home for a great space to store your products. Gallery rail will keep your items secure. Tempered glass is 3/8 Inches thick and all of the hardware is made of solid brass and finished with the highest quality materials to provide a lifetime of beauty. Made with 3/8-in thick tempered glass for safety and strength Crafted from the finest solid brass materials Concealed screw mounting hardware makes installation easy Double shelf is an ideal use of space Glass Dimensions: 16 x 5 Inches Gallery rail designed to keep your items in place Length, in Depth, in Height, in Weight, lbs 16 Inch 16 5 8 10.4 22 Inch 22 5 8 12 Installation Instruction Technical Specification WP216GAL-Installation.PDF WP222GAL-Installation.PDF WP216GAL-Specification.PDF WP222GAL-Specification.PDF'
...
- Product is a double glass shelf with gallery rail (source: current_title=Waverly Place Collection Double Glass Shelf with Gallery Rail)
- Wall mount installation with concealed screw mounting (source: bullet_3=Concealed screw mounting hardware makes installation easy)
- Glass dimensions are 22 x 5 inches (source: bullet_5=Glass Dimensions: 22 x 5 Inches)
- Tempered glass thickness is 3/8 inch (0.38 in) (source: thickness=0.38 in)
- Overall dimensions: 22 in length, 5 in width/projection, 8 in height (source: product_length=22 in)
- Projection (depth) is 5 in (source: projection=5 in)
- Height is 8 in (source: product_height=8 in)
