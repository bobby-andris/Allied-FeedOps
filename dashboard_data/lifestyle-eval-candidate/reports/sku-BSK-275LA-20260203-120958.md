...
**Generated:** 2026-02-03T12:09:58.990778
**Status:** APPROVED
...
```
This 18.75-inch wall mount shower basket keeps shampoo, soap, and bath essentials organized where you need them. The oval combination design uses ventilated, heavy-gauge solid brass wires that will never rust, helping bottles drain and dry faster. Solid brass construction is built for daily shower use and long-term durability, with a concealed screw mounting system for a clean, finished look. Sized 18.75 in L x 2.25 in H x 4.13 in W (4.13 in projection). Includes basket and all installation hardware. Available in a wide variety of designer finishes and backed by a limited lifetime warranty.
```
...
**Token Usage:** Prompt tokens: 6768, Completion tokens: 1419
**Estimated Cost:** $0.031710
...
- Product width is 4.13 in and projection is 4.13 in. (source: product_width=4.13 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 90.38% | 90.00% | 87.50% | 95.00% |  |
| 2 | 1 | 86.12% | 85.00% | 85.00% | 92.50% |  |
| 3 | 0 | 83.62% | 82.50% | 80.00% | 92.50% |  |
