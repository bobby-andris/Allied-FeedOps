...
**Generated:** 2026-01-29T02:11:00.364608
**Status:** APPROVED
...
**Title (98 chars):**
```
Glass Shelf, 16-Inch Double Wall Mount W/ Gallery Rail, Solid Brass, Waverly Place, | Allied Brass
```

**Description (910 chars):**
```
Keep everyday bathroom essentials organized and off the vanity with a double glass shelf designed for secure, space-smart storage.

Highlights:
- Store more in less wall space with two tiers—double shelf design maximizes vertical storage
- Keep bottles and décor from sliding off—gallery rail helps hold items in place
- Count on strength and safety—3/8-inch thick tempered glass construction
- Enjoy enduring support—solid brass hardware and concealed screw mounting
- Coordinate a cohesive look—designed as part of the Waverly Place collection

Specs & Installation:
- Glass size (each shelf): 16 x 5 Inches
- Overall size: 16 in L x 5 in W x 8 in H; projection 5 in
- Glass thickness: 0.38 in (3/8 in)
- Weight capacity: 4 lb
- Mounting: wall mount; concealed screw mounting hardware; assembly required: false
...
- Hardware made of solid brass (source: current_description=Tempered glass is 3/8 Inches thick and all of the hardware is made of solid brass)
...
- Wall mount installation; assembly required: false; installation hardware included (source: included_items=Glass shelf and all installation hardware.)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 82.83% | 83.33% | 83.33% | 80.00% |  |
| 2 | 1 | 81.33% | 83.33% | 80.00% | 73.33% |  |
