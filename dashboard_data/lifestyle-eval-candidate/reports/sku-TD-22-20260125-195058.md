...
**Generated:** 2026-01-25T19:50:58.556141
**Status:** APPROVED
...
**Title (80 chars):**
```
Retractable Hooks and Garment Rod Wall Mount 2-1/2-Inch Solid Brass Allied Brass
```

**Description (1170 chars):**
```
Add space-saving hanging room with a wall mount retractable hook that pulls out for 2-1/2 inches of usable hanging space, then pushes back in when not needed.

Highlights
- Retractable rod provides 2-1/2" of hanging space for coats, robes, and towels
- Wall-mounted design helps keep items within reach while saving floor space
- Solid brass construction for enduring bathroom accessory performance
- Holds up to 15 lb when installed as directed
- Customizable tip: remove the supplied knob tip and swap in your own cabinet knob to match room hardware
...
- Hardware: 6/32 toggles included; all mounting hardware included
- Drilling required: 3/4" diameter hole through drywall plus three small holes
- Assembly required: No

Style & Finish Options
Designed for traditional bathroom hardware spaces and classic bath accessories. Available in multiple designer finish options, including statement colors to coordinate with heritage bathroom fixtures and wall mount accessories.
```
...
- Option to replace the supplied knob tip with your own cabinet knob. (source: bullet_1=Gives you the option to remove the knob tip supplied with the item and replace it with a cabinet knob of your own, allowing you to match existing ones in the room!)
- Fits standard interior walls. (source: bullet_3=Fits standard interior walls)
- Drilling required: 3/4-inch diameter hole through drywall plus three small holes. (source: bullet_4=Installation does require drilling a 3/4" dia. hole through drywall and 3 small holes around)
...
- Dimensions: 3.75-inch width x 2-inch height x 2-inch length; projection 1 inch. (source: product_width=3.75 in)
...
| 2 | 1 | 75.67% | 76.67% | 73.33% | 73.33% |  |
| 3 | 2 | 75.67% | 76.67% | 66.67% | 80.00% | google_description missing description term in first 150 chars; google_description missing 2 description term(s); found 1; bing_description missing description term in first 150 chars; bing_description missing 2 description term(s); found 1 |
