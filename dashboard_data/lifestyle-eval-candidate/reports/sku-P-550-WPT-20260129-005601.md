...
**Generated:** 2026-01-29T00:56:01.595838
**Status:** REJECTED
...
**Title (105 chars):**
```
Paper Towel Holder, Wall Mount, 15.5-Inch, Pipeline, Brass Paper Towel Holders Collection, | Allied Brass
```

**Description (911 chars):**
```
Keep paper towels right where you need them and free up counter space with a wall-mounted paper towel holder designed for everyday kitchen use.

Highlights:
- Save countertop space with a wall mount design that stores rolls off the work surface
- Add an industrial pipe-fitting look with the Pipeline collection style that suits modern or traditional kitchens
- Count on long-term performance with a durable powder-coated finish engineered for continual service
- Keep your setup looking clean with included color-coordinated mounting screws
...
- Collection: Brass Paper Towel Holders Collection (distinctive design)
```
...
- Claim rejected: 'Mounts firmly and includes color coordinated mounting hardware (screws).' - Claimed 'Paper Towel holder mounts firmly with color coordinating screws... Color coordinated mounting hardware included' but actual value is 'The Pipeline collection is the latest innovation for accessories from the Allied Brass Brand of products. This wall mounted paper towel holder gives the industrial look of pipe fittings while blending aptly with both modern and traditional decor. This accessory is powder coated with lifetime materials to provide a decorative and clean finish. No wonder, this wall mounted paper towel holder gives continual service for years without any trouble. The choice of superior materials makes this item free from corrosion and rust. Paper Towel holder mounts firmly with color coordinating screws and comes with a limited lifetime warranty. Contemporary design with rustic influences Protected using highly durable powder coat Powder coated pipe gives clean finish to this accessory Designer finish will provide Corrosion-free and rust-free performance Provided with a limited lifetime warranty Color coordinated mounting hardware included Specification & Documentation Product dimensions, in. (LxHxW): 15.5x3x4 Box dimensions, in. (LxHxW): 18x6x6 Shipping weight, lbs: 1.3 Installation Instruction Technical Specification P550WPT-Installation.PDF P550WPT-Specification.PDF'
...
- Product is a Pipeline Collection wall mounted paper towel holder. (source: current_title=Pipeline Collection Wall Mounted Paper Towel Holder)
- Pipeline collection design gives an industrial look of pipe fittings and blends with modern and traditional decor. (source: current_description=This wall mounted paper towel holder gives the industrial look of pipe fittings while blending aptly with both modern and traditional decor.)
- Protected using a highly durable powder coat; powder coated pipe gives a clean finish. (source: current_description=Protected using highly durable powder coat Powder coated pipe gives clean finish to this accessory)
- Product dimensions are 15.5 x 3 x 4 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 15.5x3x4)
- Shipping weight is 1.3 lbs. (source: current_description=Shipping weight, lbs: 1.3)
- Available in multiple designer finish options (19 listed finishes). (source: available_finishes=Antique Bronze, Brushed Bronze, Matte Black, Matte Gray, Oil Rubbed Bronze, Polished Chrome, Satin Nickel, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 84.17% | 86.67% | 73.33% | 83.33% |  |
| 2 | 2 | 80.50% | 80.00% | 83.33% | 80.00% |  |
| 3 | 1 | 73.00% | 70.00% | 80.00% | 80.00% |  |
