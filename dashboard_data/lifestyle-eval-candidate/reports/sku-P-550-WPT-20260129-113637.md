...
**Generated:** 2026-01-29T11:36:37.057030
**Status:** APPROVED
...
```
Keep paper towels within easy reach and free up counter space with a wall-mounted holder built for everyday kitchen use. Designed in the Pipeline collection, it brings an authentic pipe-style look that fits industrial and loft-inspired spaces and coordinates with matching Pipeline accessories.

Highlights:
- Save valuable counter space with a wall-mounted design that keeps rolls accessible where you need them
- Add an industrial, pipe-style accent with the Pipeline collection’s bold, urban look
- Get lasting finish protection with a highly durable powder coat on iron construction
- Install with confidence using included, color-coordinated mounting hardware
...
**Token Usage:** Prompt tokens: 6020, Completion tokens: 1610
**Estimated Cost:** $0.033075
...
- Finish is protected using a highly durable powder coat. (source: bullet_2=Protected using highly durable powder coat)
- Dimensions are 15.5 x 3 x 4 inches (L x H x W) with 4-inch projection. (source: current_description=Product dimensions, in. (LxHxW): 15.5x3x4)
...
- Includes paper towel holder and all installation hardware, with color coordinated mounting hardware. (source: included_items=Paper towel holder and all installation hardware.)
- Warranty is a Limited Lifetime Warranty. (source: bullet_5=Limited Lifetime Warranty)
- Part of the Pipeline collection. (source: collection=Pipeline)
- Multiple designer finish options are available (19 finishes listed). (source: available_finishes=Antique Bronze, Brushed Bronze, Matte Black, Matte Gray, Oil Rubbed Bronze, Polished Chrome, Satin Nickel, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 82.83% | 83.33% | 83.33% | 80.00% |  |
| 2 | 2 | 82.83% | 83.33% | 83.33% | 80.00% | bing_title must end with Allied Brass |
