...
**Generated:** 2026-01-29T01:32:59.996624
**Status:** APPROVED
...
**Title (92 chars):**
```
Towel Shelf With Drying Rack, 23-Inch, Solid Brass, Towel Shelves Collection, | Allied Brass
```

**Description (982 chars):**
```
Stop stacking towels on the counter—store and dry multiple towels in one wall-mounted organizer.

Highlights:
- Get more towel storage in less space with a three-tier hotel-style towel shelf and drying rack
- Keep bath towels ready to use with open-bar tiers that promote airflow
- Coordinate your bathroom with a distinctive design in the towel shelves collection
- Choose the look that fits your space with multiple designer finish options available
- Install with confidence using included mounting hardware (some assembly required)

Specs & Installation:
- Product type: Three-tier hotel style towel shelf with drying rack
- Material: Solid brass construction
- Dimensions (L x H x W): 23 x 10 x 9 in.
- Box dimensions (L x H x W): 24 x 6 x 6 in.
...
**Image URL:** https://cdn.shopify.com/s/files/1/0287/8658/9828/products/HTL3-ABR.jpg?v=1616849450
...
| gtin | 013895091275 | gtin |
| upc | 013895091275 | upc |
| main_image_url | https://cdn.shopify.com/s/files/1/0287/8658/9828/products/HTL3-ABR.jpg?v=1616849450 | main_image_url |
...
| design_intent_keywords | towel shelves collection, transitional bathroom hardware, versatile bath accessories | enrichment_keywords |
...
- Product is a three tier hotel style towel shelf with drying rack. (source: current_title=Three Tier Hotel Style Towel Shelf with Drying Rack)
- Material is brass. (source: current_description=This elegant train rack is created from the finest brass materials.)
- Product dimensions are 23 x 10 x 9 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 23x10x9)
- Mounting hardware is included and installation is easy. (source: current_description=Easy installation with included mounting hardware)
...
- Part of a coordinated towel shelves collection with distinctive design and extensive finish options. (source: key_differentiators=Part of coordinated Towel Shelves collection; 28 finish options including statement colors)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 72.33% | 73.33% | 70.00% | 70.00% |  |
| 2 | 2 | 69.67% | 66.67% | 80.00% | 73.33% |  |
| 3 | 0 | 69.50% | 70.00% | 66.67% | 70.00% |  |
