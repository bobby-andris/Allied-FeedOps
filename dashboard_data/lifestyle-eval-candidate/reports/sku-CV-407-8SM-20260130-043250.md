...
**Generated:** 2026-01-30T04:32:50.162081
**Status:** APPROVED
...
**Title (100 chars):**
```
Shower Door Handle, 9-Inch Solid Brass Pull, Smooth Acrylic Accents, Concealed Mount -, Allied Brass
```

**Description (590 chars):**
```
Shower door handle with 9-inch length, solid brass construction, and clear acrylic accents for modern bathroom hardware on glass shower doors. Single-side shower door pull with smooth accents, contemporary style, and concealed screw mounting for a clean, finished look. Designed for shower door mount installation; includes shower door pull and all installation hardware. Product size: 9 in L x 3.9 in H x 1.7 in W; weight 3.2 lb. Ideal for minimalist bathroom fixtures and transparent bathroom accessories within the Clearview collection. Limited lifetime warranty. Allied Brass Clearview.
```
...
**Token Usage:** Prompt tokens: 6422, Completion tokens: 1370, Cached tokens: 4480 (69% cache hit)
**Estimated Cost:** $0.026499
...
- Product is a single-side shower door pull/handle with smooth accents. (source: current_title=Clearview Collection Single Side Shower Door Pull with Smooth Accents)
- Solid brass construction with clear acrylic accents. (source: current_description=Made from high quality solid brass with accents of clear acrylic)
...
- Product dimensions are 9 in L x 3.9 in H x 1.7 in W. (source: product_length=9 in)
- Product height is 3.9 in and width is 1.7 in. (source: product_height=3.9 in)
- Product width is 1.7 in. (source: product_width=1.7 in)
...
- Collection name is Clearview. (source: collection=Clearview)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 78.50% | 80.00% | 76.67% | 73.33% |  |
| 2 | 2 | 77.17% | 76.67% | 83.33% | 73.33% |  |
| 3 | 0 | 79.83% | 83.33% | 76.67% | 66.67% | shopify_title must end with Allied Brass |
