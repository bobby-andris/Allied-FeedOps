...
**Generated:** 2026-01-30T14:48:22.149998
**Status:** APPROVED
...
**Title (93 chars):**
```
Shower Door Handle, 9-Inch Solid Brass Pull, Acrylic Accents, Concealed Mount -, Allied Brass
```

**Description (693 chars):**
```
Shower door handle with 9-inch pull length, 3.9-inch height, and 1.7-inch width for glass shower doors in any bathroom. Solid brass construction with clear acrylic accents delivers a crisp, modern look for contemporary bath accessories and minimalist bathroom fixtures. Shower door mount with concealed screw mounting hardware for a clean, finished appearance; includes shower door pull and all installation hardware. Finish-neutral listing with multiple lifetime designer finish options available. Style: contemporary/modern. Ideal as acrylic bathroom hardware and transparent bathroom accessories to coordinate with other pieces. Limited lifetime warranty. Allied Brass Clearview collection.
```
...
**Token Usage:** Prompt tokens: 6530, Completion tokens: 1440, Cached tokens: 6016 (92% cache hit)
**Estimated Cost:** $0.026323
...
- Claim rejected: 'Solid brass construction' - Claimed 'Made from high quality solid brass with accents of clear acrylic...' but actual value is 'The clean sharp lines of this modern shower door pull fits well with any bathroom décor ranging from modern to traditional. Made from high quality solid brass with accents of clear acrylic and provided with your choice of any of our lifetime designer finishes, the shower door pull is extremely attractive yet highly functional. Ideal for glass shower doors of all sizes and styles, the easy to install shower door pull comes with durable u-shaped pull made from solid brass and all the hardware necessary for installation. Crafted from the Finest Solid Brass Materials Acrylic components subtly accentuate this elegant design Concealed screw mounting hardware installs easily Available in a variety of lifetime designer finishes Easy installation instructions provided Limited lifetime warranty Specification & Documentation Product dimensions, in. (LxHxW): 13x3.9x1.7 Box dimensions, in. (LxHxW): 14x6x6 Shipping weight, lbs: 4'
...
- Product is a single-side shower door pull / shower door handle (source: current_title=Clearview Collection Single Side Shower Door Pull with Smooth Accents)
- Concealed screw mounting hardware (source: bullet_3=Concealed screw mounting hardware makes installation easy)
- Mounting type is shower door mount (source: mounting_type=Shower door mount)
...
- Product length is 9 inches (source: product_length=9 in)
- Product weight is 3.2 lb (source: product_weight=3.2 lb)
...
- Available in multiple lifetime designer finishes (source: bullet_4=Available in a wide variety of lifetime designer finishes)
- Collection is Clearview (source: collection=Clearview)
- Brass (source: material=Brass)
- 3.9-inch (source: product_height=3.9 in)
- 1.7-inch (source: product_width=1.7 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 88.50% | 90.00% | 86.67% | 83.33% |  |
| 2 | 2 | 83.67% | 86.67% | 83.33% | 70.00% |  |
| 3 | 0 | 80.50% | 80.00% | 83.33% | 80.00% |  |
