...
**Generated:** 2026-01-25T15:16:12.155232
**Status:** APPROVED
...
**Title (81 chars):**
```
Freestanding Paper Towel Holder 14-Inch Solid Brass Countertop Stand Allied Brass
```

**Description (967 chars):**
```
Upgrade countertop organization with a freestanding paper towel holder crafted from solid brass with a weighted base to help prevent tipping. Designed for a crisp, contemporary look, this holder keeps paper towels within easy reach without any wall mounting.
...
- Mounting type: Freestanding (countertop)
...
A smart fit for modern bathroom hardware and contemporary bath accessories styling, while working equally well in kitchens for a clean, minimalist countertop setup.
```
...
| statement_finishes | antique pewter, spanish gold, glokzin teal, venetian bronze, fire engine red | enrichment_finishes |
...
| design_intent_keywords | modern bathroom hardware, contemporary bath accessories, minimalist bathroom fixtures, freestanding, antique pewter bathroom hardware, spanish gold bathroom hardware, glokzin teal bathroom hardware, venetian bronze bathroom hardware, fire engine red bathroom hardware, autumn sparkle bathroom hardware | enrichment_keywords |
...
- 14-inch height (source: product_height=14 in)
- 5-inch length and 5-inch width (source: product_length=5 in)
- 5-inch length and 5-inch width (source: product_width=5 in)
- Weighted base helps prevent tipping (source: bullet_2=Solid Brass weighted base prevents tipping)
- Felt pad helps prevent scratching (source: bullet_3=Felt pad will prevent scratching on any surface)
...
- Corrosion-free and rust-free performance (source: bullet_6=Designer finish will provide Corrosion-free and rust-free performance)
...
| 2 | 0 | 85.67% | 86.67% | 80.00% | 86.67% | shopify_description missing 2 description term(s); found 1 |
| 3 | 1 | 82.83% | 83.33% | 83.33% | 80.00% | shopify_title must end with Allied Brass; shopify_description missing 2 description term(s); found 1 |
