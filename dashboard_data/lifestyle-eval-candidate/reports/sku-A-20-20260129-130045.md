...
**Generated:** 2026-01-29T13:00:45.512610
**Status:** APPROVED
...
**Title (78 chars):**
```
Cabinet Pull, 3.9-Inch, Solid Brass, Cabinet Hardware Collection, Allied Brass
```

**Description (994 chars):**
```
Upgrade cabinets and drawers with a distinctive pull that gives you a comfortable, secure grip every day. This cabinet pull is crafted from solid brass and designed to coordinate easily across a cabinet hardware collection for a cohesive look in the kitchen or bathroom.

Highlights:
- Refreshes your space fast with a clean, transitional look that blends modern and traditional elements
- Built for lasting everyday use with solid brass construction
- Installs with confidence since all mounting hardware is included
- Matches your project with multiple designer finish options
- Designed for corrosion-free and rust-free performance

Specs & Installation:
- Product type: Cabinet pull
- Material: Brass
- Mounting type: Cabinet mount
- Dimensions (L x H x W): 3.9 in x 1.6 in x 0.9 in
- Projection: 1 in
- Weight capacity: 2 lb
- Product weight: 0.8 lb
- Included: Cabinet pull and all installation hardware
...
**Token Usage:** Prompt tokens: 5893, Completion tokens: 1379
**Estimated Cost:** $0.029619
...
Primary search term (include naturally in the title; adapt wording to accurately describe THIS product): cabinet pull
Google short title must include: cabinet pull
...
- Cabinet-mount installation with mounting hardware included. (source: included_items=Cabinet pull and all installation hardware.)
- Dimensions are 3.9 in (L) x 1.6 in (H) x 0.9 in (W) with 1 in projection. (source: current_description=Product dimensions, in. (LxHxW): 3.9x1.6x3)
...
| 2 | 0 | 81.83% | 83.33% | 80.00% | 76.67% |  |
| 3 | 2 | 81.83% | 83.33% | 73.33% | 83.33% |  |
