...
**Generated:** 2026-01-29T12:43:00.058251
**Status:** APPROVED
...
**Title (89 chars):**
```
Shower Basket, 18-3/4-Inch Oval Wall Mount, Solid Brass, Baskets Collection, Allied Brass
```

**Description (962 chars):**
```
Stop juggling bottles on the tub ledge—this wall-mounted shower basket keeps daily essentials organized and within easy reach.

Highlights:
- Keep shampoo, conditioner, and soap corralled in one place with an 18-3/4-inch oval basket design
- Maintain a clean, finished look with concealed screw mounting hardware
- Count on rust-free performance in wet areas with solid brass wires and solid brass construction
- Coordinate your space with the Baskets collection, designed for transitional bathroom hardware and versatile bath accessories

Specs & Installation:
- Product type: Oval combination shower basket
- Material: Brass
- Mounting: Wall mount; concealed screw mounting system
- Dimensions (L x H x W): 18.75 x 2.25 x 4.13 in (projection: 4.13 in)
- Product weight: 4.8 lb
- Included: Basket and all installation hardware
- Assembly: No assembly required
- Warranty: Limited Lifetime Warranty
- Finish options: Available in multiple designer finish options
```
...
**Token Usage:** Prompt tokens: 5949, Completion tokens: 1439
**Estimated Cost:** $0.030557
...
| design_intent_keywords | baskets collection, transitional bathroom hardware, versatile bath accessories, wall mount | enrichment_keywords |
...
- Made from brass (solid brass construction). (source: material=Brass)
- Rust proof solid brass wires. (source: bullet_3=Rust Proof Solid Brass Wires)
- Dimensions are 18.75 x 2.25 x 4.13 inches with 4.13-inch projection. (source: current_description=Product dimensions, in. (LxHxW): 18.75x2.25x4.125)
- Product weight is 4.8 lb. (source: product_weight=4.8 lb)
- Includes basket and all installation hardware; no assembly required. (source: included_items=Basket and all installation hardware.)
...
- 18-3/4-Inch (source: product_length=18.75 in)
