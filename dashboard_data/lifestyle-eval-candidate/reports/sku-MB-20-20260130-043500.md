...
**Generated:** 2026-01-30T04:35:00.689883
**Status:** APPROVED
...
```
Robe hook with 2 in L x 2 in H x 2.64 in projection, solid brass construction, wall-mount installation for bathroom robes and towels. Contemporary Malibu Collection design for modern bath accessories and designer bathroom hardware; a statement bath accessory that pairs with matching Malibu pieces and other contemporary bath accessories. Includes color-coordinated mounting hardware; no assembly required. Supports up to 2 lb. Ideal as a space-saving wall-mounted hook near shower, vanity, or closet door for daily towel and robe storage. Finished in lifetime designer finishes; limited lifetime warranty. Allied Brass Malibu collection.
```
...
**Token Usage:** Prompt tokens: 6410, Completion tokens: 1438, Cached tokens: 4480 (69% cache hit)
**Estimated Cost:** $0.027430
...
- Product is a Malibu robe hook. (source: current_title=Malibu Robe Hook)
- Wall mount installation. (source: mounting_type=Wall Mount)
- Made from brass. (source: material=Brass)
- Product dimensions are 2 in L x 2 in H x 2.64 in W. (source: product_length=2 in)
- Product height is 2 in. (source: product_height=2 in)
- Product width is 2.64 in. (source: product_width=2.64 in)
- Projection is 2.64 in. (source: projection=2.64 in)
...
- Product weight is 0.5 lb. (source: product_weight=0.5 lb)
