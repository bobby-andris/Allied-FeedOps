...
**Generated:** 2026-01-30T15:09:07.444063
**Status:** APPROVED
...
**Title (94 chars):**
```
Cabinet Pull, 3-Inch Solid Brass Cabinet-Mount Traditional Handle, 3.9 In Length, Allied Brass
```

**Description (625 chars):**
```
Cabinet pull with 3-inch size, solid brass construction, and cabinet-mount installation for upgrading kitchen or bathroom cabinets and drawers. Overall dimensions: 3.9 in L x 1.6 in H x 0.9 in W with 1 in projection; supports up to 2 lb. Traditional style with contemporary design elements. Includes cabinet pull and all installation hardware; no assembly required. Designer finish options are offered for corrosion-free, rust-free performance, with a limited lifetime warranty. Pairs well with traditional bathroom hardware, classic bath accessories, and heritage bathroom fixtures. Allied Brass decorative cabinet hardware.
```
...
**Token Usage:** Prompt tokens: 6335, Completion tokens: 1550, Cached tokens: 5632 (88% cache hit)
**Estimated Cost:** $0.027858
...
| design_intent_keywords | traditional bathroom hardware, classic bath accessories, heritage bathroom fixtures | enrichment_keywords |
...
- Made of brass (solid brass construction). (source: bullet_1=Crafted from the finest solid brass materials)
- Mounting type is cabinet mount. (source: mounting_type=Cabinet mount)
- Overall dimensions are 3.9 in L x 1.6 in H x 0.9 in W. (source: product_length=3.9 in)
- Overall dimensions are 3.9 in L x 1.6 in H x 0.9 in W. (source: product_height=1.6 in)
- Overall dimensions are 3.9 in L x 1.6 in H x 0.9 in W. (source: product_width=0.9 in)
- Projection is 1 in. (source: projection=1 in)
- Weight capacity is 2 lb. (source: weight_capacity=2 lb)
- Includes cabinet pull and all installation hardware. (source: included_items=Cabinet pull and all installation hardware.)
