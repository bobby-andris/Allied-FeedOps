...
**Generated:** 2026-01-29T00:56:02.560626
**Status:** REJECTED
...
**Title (78 chars):**
```
Paper Towel Holder, Wall Mount, 15.5-Inch, Pipeline Collection, | Allied Brass
```

**Description (883 chars):**
```
Keep paper towels within easy reach while freeing up valuable counter space with a wall-mounted paper towel holder designed for everyday kitchen use.

Highlights:
- Save counter space with wall-mounted installation that keeps a full roll ready at arm’s reach
- Add an industrial pipe-fitting look with the Pipeline Collection’s distinctive design
- Count on lasting performance with a highly durable powder-coated finish
- Coordinate your space with multiple designer finish options, including statement colors
- Install with confidence using color-coordinated mounting screws for a clean, finished look

Specs & Installation:
- Product dimensions (L x H x W): 15.5 x 3 x 4 in.
- Box dimensions (L x H x W): 18 x 6 x 6 in.
- Shipping weight: 1.3 lbs
- Mounting: wall mount
- Warranty: limited lifetime warranty
- Collection: Brass Paper Towel Holders collection (Pipeline Collection)
```
...
- Claim rejected: 'Protected with a highly durable powder coat / powder-coated finish.' - Claimed 'This accessory is powder coated with lifetime materials... Protected using highly durable powder coat' but actual value is 'The Pipeline collection is the latest innovation for accessories from the Allied Brass Brand of products. This wall mounted paper towel holder gives the industrial look of pipe fittings while blending aptly with both modern and traditional decor. This accessory is powder coated with lifetime materials to provide a decorative and clean finish. No wonder, this wall mounted paper towel holder gives continual service for years without any trouble. The choice of superior materials makes this item free from corrosion and rust. Paper Towel holder mounts firmly with color coordinating screws and comes with a limited lifetime warranty. Contemporary design with rustic influences Protected using highly durable powder coat Powder coated pipe gives clean finish to this accessory Designer finish will provide Corrosion-free and rust-free performance Provided with a limited lifetime warranty Color coordinated mounting hardware included Specification & Documentation Product dimensions, in. (LxHxW): 15.5x3x4 Box dimensions, in. (LxHxW): 18x6x6 Shipping weight, lbs: 1.3 Installation Instruction Technical Specification P550WPT-Installation.PDF P550WPT-Specification.PDF'
...
- Product type: wall mounted paper towel holder (Pipeline Collection). (source: current_title=Pipeline Collection Wall Mounted Paper Towel Holder)
- Industrial look inspired by pipe fittings; works with modern and traditional decor. (source: current_description=This wall mounted paper towel holder gives the industrial look of pipe fittings while blending aptly with both modern and traditional decor.)
- Corrosion-free and rust-free performance claim. (source: current_description=The choice of superior materials makes this item free from corrosion and rust.)
- Dimensions: 15.5 x 3 x 4 in (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 15.5x3x4)
- Shipping weight: 1.3 lbs. (source: current_description=Shipping weight, lbs: 1.3)
- Multiple designer finish options available; 19 finish options listed. (source: available_finishes=Antique Bronze, Brushed Bronze, Matte Black, Matte Gray, Oil Rubbed Bronze, Polished Chrome, Satin Nickel, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
