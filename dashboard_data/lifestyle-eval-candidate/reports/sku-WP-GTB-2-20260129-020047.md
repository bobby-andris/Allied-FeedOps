...
**Generated:** 2026-01-29T02:00:47.547681
**Status:** APPROVED
...
**Description (943 chars):**
```
Free up space around the vanity and keep towels within easy reach with a double swing arm towel rail that folds neatly back to the wall when not in use.

Highlights:
- Keep towels separated and accessible: two arms swivel independently for flexible everyday use
- Reduce clutter in smaller bathrooms: space-saving swing-arm design nests close to the wall
- Maintain a clean, finished look: concealed screw mounting hardware
- Built for enduring bathroom use: crafted from solid brass materials
- Coordinate your hardware: available in multiple designer finish options
...
- Part of the Assorted Wall Accessories collection; transitional style that pairs easily with versatile bath accessories.
```
...
- Product is a Waverly Place Collection 2 swing arm towel rail with two swing arms. (source: current_title=Waverly Place Collection 2 Swing Arm Towel Rail)
- Two arms swivel independently and fold close to the wall when not in use. (source: current_description=Each arm swivels independently and snuggles close to the wall when not in use)
- Constructed from solid brass materials. (source: current_description=Created with the finest solid brass materials)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 63.33% | 63.33% | 60.00% | 66.67% |  |
| 2 | 1 | 62.33% | 63.33% | 56.67% | 63.33% |  |
| 3 | 2 | 59.67% | 56.67% | 73.33% | 60.00% |  |
