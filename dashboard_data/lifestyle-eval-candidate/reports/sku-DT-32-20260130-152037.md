...
**Generated:** 2026-01-30T15:20:37.065262
**Status:** APPROVED
...
**Title (95 chars):**
```
Soap Dish, 4.5-Inch Wall-Mount Solid Brass Bathroom Holder, Dottingham Collection, Allied Brass
```

**Description (681 chars):**
```
Wall mounted soap dish, 4.5 in L x 3 in H x 3.5 in W with 5 in projection, solid brass bathroom soap holder designed to keep countertops clean and clutter free. Traditional/transitional styling with concealed screw mounting hardware for a clean look; wall mount installation uses space efficiently. Includes brass soap dish holder and all installation hardware; uses #8 x 1 1/4" screws. Supports up to 2 lb. Product weight 1.6 lb. Ideal for transitional bath accessories and transitional bathroom hardware layouts, including beaded bathroom hardware looks; coordinate matching Dottingham pieces for a unified bathroom. Limited Lifetime Warranty. Allied Brass Dottingham collection.
```
...
**Token Usage:** Prompt tokens: 6432, Completion tokens: 1394, Cached tokens: 6016 (93% cache hit)
**Estimated Cost:** $0.025508
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 89.50% | 90.00% | 93.33% | 83.33% |  |
| 2 | 2 | 89.50% | 90.00% | 93.33% | 83.33% |  |
| 3 | 0 | 88.17% | 86.67% | 93.33% | 90.00% |  |
