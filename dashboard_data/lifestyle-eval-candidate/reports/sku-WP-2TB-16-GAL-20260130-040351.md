...
**Generated:** 2026-01-30T04:03:51.916901
**Status:** APPROVED
...
**Title (100 chars):**
```
Glass Shelf With Towel Bar, 16-Inch Wall Mount, Solid Brass Rail, 3/8In Tempered Glass, Allied Brass
```

**Description (741 chars):**
```
Glass shelf with towel bar, 16-inch wall mount bathroom storage shelf featuring 3/8 in (0.38 in) thick tempered glass and solid brass hardware with a solid brass gallery rail to help keep items secure. Overall size: 16 in L x 5 in projection x 12 in H; supports up to 4 lb. Concealed screw mounting creates a clean, finished look; includes glass shelf and installation hardware (#8 x 1 1/4 in screws). Transitional style accessory for organizing toiletries, decor, and hand towels in the bathroom. Part of the Waverly Place collection for matching Waverly Place, grooved bathroom hardware, and transitional bath accessories / transitional bathroom hardware / versatile bath accessories. Limited Lifetime Warranty. Allied Brass Waverly Place.
```
...
**Token Usage:** Prompt tokens: 6543, Completion tokens: 1537, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.030728
...
- Product is a gallery rail double glass shelf with an integrated towel bar. (source: current_title=Waverly Place Collection Gallery Rail Double Glass Shelf with Towel Bar)
...
- Primary dimension is 16 inches length. (source: product_length=16 in)
- Overall dimensions are 16 in L x 5 in projection x 12 in H. (source: current_description=Length, in Depth, in Height, in Weight, lbs 16 Inch 16 5 12 11.2)
- Weight capacity is 4 lb. (source: weight_capacity=4 lb)
- Included items are the glass shelf and all installation hardware. (source: included_items=Glass shelf and all installation hardware.)
