...
**Generated:** 2026-01-25T15:57:59.797020
**Status:** APPROVED
...
```
Upgrade towel storage with a 30-inch wall mount ladder towel bar crafted from solid brass with four horizontal bars for organized drying and display. From the Carolina Collection, this traditional bathroom hardware piece brings refined, timeless styling while saving space with a vertical ladder shape.

Highlights:
- 4-tier ladder design provides plenty of room for towels at varying heights
- Wall-mounted installation helps conserve floor space in smaller baths
- Crafted of solid brass with a durable designer finish
- Concealed screw mounting for a clean, classic look
- Coordinate with matching Carolina Collection classic bath accessories

Specs:
- Category: Towel bar (vertical ladder)
- Center-to-center: 30 in
- Overall size: 35 in H x 30 in L; projection 3.3 in
...
| statement_finishes | fire engine red, pink, venetian bronze, lavender, mediterranean blue | enrichment_finishes |
...
| design_intent_keywords | carolina collection, matching carolina, traditional bathroom hardware, classic bath accessories, heritage bathroom fixtures, wall mount, fire engine red bathroom hardware, pink bathroom hardware, venetian bronze bathroom hardware, lavender bathroom hardware | enrichment_keywords |
...
- Claim rejected: 'Part of the Carolina collection with traditional styling' - Field 'collection_context' not found in source data
- Claim rejected: 'Solid Brass' - Claimed 'Solid Brass' but actual value is 'Brass'

### Verified Claims

- 4-tier ladder towel bar with four horizontal bars (source: current_title=Carolina Collection 4 Tier 30 Inch Ladder Towel Bar)
...
- Crafted of brass (source: material=Brass)
- Bar diameter is 0.75 inches (source: diameter=0.75 in)
- Overall dimensions are 30 inches long, 35 inches high, with 3.3 inches projection (source: product_height=35 in)
