...
**Generated:** 2026-01-25T15:20:40.265847
**Status:** APPROVED
...
**Title (77 chars):**
```
3-Tier Corner Glass Shelf 8-Inch Wall Mount Solid Brass Hardware Allied Brass
```

**Description (908 chars):**
```
Add corner storage with a 3-tier glass shelf crafted with solid brass hardware and thick tempered glass. This wall-mount corner unit helps keep toiletries organized while preserving open floor space.

Highlights:
- Three-tier corner glass shelf for vertical organization
- 3/8-Inch thick tempered, beveled-edge glass for safety and strength
- Solid brass construction hardware for enduring bathroom use
- Concealed screw mounting for a clean, contemporary look
- Part of the Foxtrot collection for matching Foxtrot and coordinated designer bath accessories

Specs:
- Overall size: 8-Inch L x 8-Inch W x 15-Inch H
- Glass thickness: 0.39 in (3/8-Inch)
- Mounting: Wall mount; installation hardware included (#8 x 1 1/4" screws)
...
| statement_finishes | pink, golden yellow, fire engine red, glokzin teal, autumn sparkle | enrichment_finishes |
...
| design_intent_keywords | foxtrot collection, matching foxtrot, textured bathroom hardware, designer bath accessories, designer bathroom hardware, statement bath accessories, sculptural fixtures, wall mount, pink bathroom hardware, golden yellow bathroom hardware | enrichment_keywords |
...
- Claim rejected: 'Available in a wide variety of designer finishes (28).' - Field 'finish_variety' not found in source data
...
- Three-tier corner glass shelf. (source: current_title=Foxtrot Collection Three Tier Corner Glass Shelf)
...
- Made with 3/8-inch thick tempered, beveled-edge glass. (source: current_description=Featuring tempered, beveled-edged glass and solid brass hardware)
- Crafted from solid brass materials (hardware). (source: bullet_1=Crafted from the finest solid brass materials)
- Overall dimensions: 8 in L x 8 in W x 15 in H. (source: product_height=15 in)
- Glass thickness: 0.39 in. (source: thickness=0.39 in)
- Weight capacity: 2 lb. (source: weight_capacity=2 lb)
- Installation hardware included; screw size #8 x 1 1/4". (source: included_items=Glass shelf and all installation hardware.)
- Assembly not required. (source: assembly_required=False)
- Limited Lifetime Warranty. (source: bullet_6=Limited Lifetime Warranty)
- Belongs to the Foxtrot collection. (source: collection=Foxtrot)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 95.67% | 96.67% | 90.00% | 96.67% |  |
| 2 | 2 | 95.17% | 96.67% | 90.00% | 93.33% | google_description missing description term in first 150 chars; bing_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
| 3 | 1 | 90.50% | 90.00% | 90.00% | 93.33% | google_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
