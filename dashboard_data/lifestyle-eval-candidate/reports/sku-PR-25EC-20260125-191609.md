...
**Generated:** 2026-01-25T19:16:09.898537
**Status:** APPROVED
...
**Title (94 chars):**
```
Under Cabinet paper towel holder 15-Inch Solid Brass Traditional | Prestige Regal Allied Brass
```

**Description (1004 chars):**
```
Upgrade cabinet space with an under-cabinet paper towel holder crafted from solid brass, designed to keep counters clear while staying easy to reach. Part of the prestige regal collection for a coordinated, traditional look.

Highlights:
- Under-cabinet mount helps keep countertops clutter-free
- Solid brass construction for enduring, traditional style
- Left- or right-hand opening for flexible placement
- Concealed screw mounting hardware for a clean install
- Includes paper towel holder and all installation hardware
...
Coordinate with matching prestige regal pieces to complete a classic bath accessories and traditional bathroom hardware look.
```
...
- Under-cabinet paper towel holder (source: current_title=Prestige Regal Under Cabinet Paper Towel Holder)
- Made of brass (solid brass materials) (source: material=Brass)
- Traditional style; part of the Prestige Regal collection (source: collection=Prestige Regal)
- Cabinet mount installation (source: mounting_type=Cabinet mount)
- Left or right hand opening (source: current_description=mounted under the cabinet with a left or right hand opening)
...
- Dimensions: 15 in length x 7 in height x 2.5 in width (source: product_length=15 in)
- Weight: 3.2 lb (source: product_weight=3.2 lb)
...
| 2 | 1 | 85.67% | 86.67% | 86.67% | 80.00% | shopify_title must end with Allied Brass; google_description missing description term in first 150 chars; bing_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
| 3 | 2 | 83.33% | 83.33% | 83.33% | 83.33% | shopify_description missing description term in first 150 chars |
