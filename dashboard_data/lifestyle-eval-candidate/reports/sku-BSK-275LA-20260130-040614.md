...
**Generated:** 2026-01-30T04:06:14.338309
**Status:** APPROVED
...
**Title (81 chars):**
```
Shower Basket, 18.75-Inch Wall Mount Solid Brass Oval Combination -, Allied Brass
```

**Description (622 chars):**
```
Shower basket with 18.75 in length, wall mount installation, and solid brass construction for bathroom shower storage and organization. Oval combination shower basket design with ventilated heavy-gauge solid brass wires for rust-proof performance. Concealed screw mounting system creates a clean, finished look on the wall. Traditional style accessory suited to classic bath accessories and heritage bathroom fixtures, ideal for holding shampoo, soap, and shower essentials while saving floor space. Includes basket and all installation hardware; no assembly required. Covered by a limited lifetime warranty. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6366, Completion tokens: 1461, Cached tokens: 2560 (40% cache hit)
**Estimated Cost:** $0.029354
...
- Wall mount installation with concealed screw mounting system. (source: current_description=Concealed Screw Mounting System)
- Material is brass with solid brass construction. (source: current_description=This decorative basket is made of solid brass)
- Ventilated wires are heavy gauge solid brass and rust proof. (source: current_description=Ventilated wires are made of heavy gauge solid brass material that will never rust.)
- Product dimensions are 18.75 x 2.25 x 4.125 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 18.75x2.25x4.125)
- Product length is 18.75 in. (source: product_length=18.75 in)
- Product height is 2.25 in. (source: product_height=2.25 in)
- Product width is 4.13 in. (source: product_width=4.13 in)
- Projection is 4.13 in. (source: projection=4.13 in)
