...
**Generated:** 2026-01-25T19:41:39.205516
**Status:** APPROVED
...
**Title (89 chars):**
```
Retractable hooks and garment rod Wall Mount 10-Inch Solid Brass Pullout Rod Allied Brass
```

**Description (916 chars):**
```
Add convenient hanging space that disappears when not in use with this retractable hooks and garment rod. The wall mount pullout rod extends to provide a handy place to hang garments or towels, then retracts neatly for a cleaner look—ideal for traditional bathroom hardware, laundry areas, or dressing spaces.

Highlights:
- Retractable pullout design adds hanging space while saving room when retracted
- Installs in an end wall or door frame with concealed screw mounting for a refined look
- Crafted from solid brass for enduring everyday use
- Includes brass rod, rod housing, and installation hardware
- Available in multiple lifetime designer finish options, including statement colors

Specs:
- Projection/Length: 10-Inch
...
- Wall mount installation; installs in an end wall or door frame (source: bullet_3=Retractable rod installs easily in end wall or door frame)
...
- 10-Inch projection/length (source: projection=10 in)
...
- Included: brass rod, rod housing, and installation hardware (source: included_items=Brass rod, rod housing and all installation hardware.)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 88.50% | 90.00% | 83.33% | 86.67% |  |
| 2 | 2 | 88.50% | 90.00% | 83.33% | 86.67% | google_description missing description term in first 150 chars; bing_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
| 3 | 1 | 84.33% | 83.33% | 86.67% | 86.67% | google_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
