...
**Generated:** 2026-01-25T05:34:40.710137
**Status:** APPROVED
...
```
Add sleek, contemporary function with this wall mount towel bar, built from solid brass and sized for an 18-inch center-to-center installation. Part of the Malibu collection, it’s designed to coordinate easily with matching Malibu pieces for a unified bath look.

Highlights:
- Contemporary, straight bar profile for a clean-lined bathroom update
...
| statement_finishes | autumn sparkle, pink, fire engine red, unlacquered brass, glokzin teal | enrichment_finishes |
...
| design_intent_keywords | malibu collection, matching malibu, designer bathroom hardware, contemporary bath accessories, statement bath accessories, sculptural fixtures, wall mount, autumn sparkle bathroom hardware, pink bathroom hardware, fire engine red bathroom hardware | enrichment_keywords |
...
- Claim rejected: 'Wall-mounted installation saves floor space' - Field 'feature_benefits' not found in source data
...
- 18-inch center-to-center (source: center_to_center=18 in)
...
- Overall length: 20 in (source: product_length=20 in)
- Projection: 3.39 in (source: projection=3.39 in)
- Diameter: 0.5 in (source: diameter=0.5 in)
...
| 2 | 2 | 91.50% | 90.00% | 93.33% | 96.67% | google_description missing description term in first 150 chars; bing_description missing description term in first 150 chars |
| 3 | 0 | 91.00% | 90.00% | 90.00% | 96.67% | google_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
