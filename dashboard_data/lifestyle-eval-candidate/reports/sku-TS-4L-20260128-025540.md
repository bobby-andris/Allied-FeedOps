...
**Generated:** 2026-01-28T02:55:40.088411
**Status:** APPROVED
...
**Title (106 chars):**
```
Freestanding Swing Arm Towel Valet 49-Inch Solid Brass | Assorted Free Standing Accessories | Allied Brass
```

**Description (881 chars):**
```
Keep bath towels within reach without drilling into walls—this freestanding 4 pivoting swing arm towel valet creates instant hanging space right where you need it.

Highlights:
- Organize multiple towels at once with 4 pivoting swing arms that spread out for airflow and fold in to save space
- Place it anywhere in the bathroom with a freestanding design that requires no wall mounting
- Enjoy steady, tip-resistant placement thanks to a large weighted base
- Count on enduring materials with solid brass construction designed to resist rust and corrosion
- Coordinate your bathroom look with the Assorted Free Standing Accessories collection and multiple designer finish options

Specs & Installation:
- Product dimensions (L x H x W): 12 in. x 49 in. x 10.5 in.
...
**Image URL:** https://cdn.shopify.com/s/files/1/0287/8658/9828/products/TS4L-ABR.jpg?v=1616858585
...
| gtin | 013895617437 | gtin |
| upc | 013895617437 | upc |
| main_image_url | https://cdn.shopify.com/s/files/1/0287/8658/9828/products/TS4L-ABR.jpg?v=1616858585 | main_image_url |
...
- Large weighted base helps prevent tipping. (source: current_description=Large base is weighted to help prevent tipping.)
- Made of solid brass materials and designed to resist rust/corrosion. (source: current_description=Towel stand is made of the finest solid brass materials so that it will not rust or corrode)
...
- Shipping weight is 17 lbs. (source: current_description=Shipping weight, lbs: 17)
- Belongs to the Assorted Free Standing Accessories collection. (source: collection=Assorted Free Standing Accessories)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 81.00% | 80.00% | 86.67% | 80.00% |  |
| 2 | 0 | 80.00% | 80.00% | 76.67% | 83.33% |  |
| 3 | 2 | 75.83% | 73.33% | 80.00% | 83.33% |  |
