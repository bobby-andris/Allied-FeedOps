...
**Generated:** 2026-01-28T12:05:20.525064
**Status:** APPROVED
...
**Description (898 chars):**
```
Refresh bathroom cabinetry with a small upgrade that makes doors and drawers easier to open and instantly more finished. This 3 inch cabinet pull is part of a coordinated cabinet hardware collection designed to complement transitional bathroom hardware and versatile bath accessories.

Highlights:
- Upgrade daily touchpoints: a decorative pull gives a comfortable, reliable grip on drawers and cabinet doors
- Coordinate the look: designed to pair with matching pieces in the Cabinet Hardware collection
- Built for lasting use: crafted from solid brass construction
- Install with confidence: mounting hardware is included
- Match your space: available in a wide variety of designer finishes
...
- Product type: 3 inch cabinet pull (source: current_title=3 Inch Cabinet Pull)
- Crafted of solid brass materials (source: current_description=Crafted of the Finest Solid Brass Materials)
- Mounting hardware included (source: current_description=All mounting hardware included)
...
- Product dimensions (L x H x W): 3.9 x 1.6 x 3 in. (source: current_description=Product dimensions, in. (LxHxW): 3.9x1.6x3)
- Box dimensions (L x H x W): 3 x 3 x 3 in. (source: current_description=Box dimensions, in. (LxHxW): 3x3x3)
...
| 2 | 2 | 82.33% | 83.33% | 73.33% | 86.67% |  |
| 3 | 0 | 79.00% | 80.00% | 73.33% | 80.00% | bing_title must end with Allied Brass |
