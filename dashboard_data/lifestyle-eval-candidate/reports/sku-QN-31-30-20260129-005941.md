...
**Generated:** 2026-01-29T00:59:41.953060
**Status:** APPROVED
...
**Title (84 chars):**
```
Towel Bar, 30-Inch Center-To-Center, Solid Brass Wall Mount, Que New, | Allied Brass
```

**Description (1001 chars):**
```
Keep bath towels off the counter and within easy reach with a wall-mounted towel bar designed for everyday bathrooms. Part of the Que New collection, it coordinates with matching Que New pieces to create a cohesive look across transitional bath accessories and transitional bathroom hardware.

Highlights:
- Get a cleaner, more organized bathroom: wall-mounted design saves floor space
- Count on enduring strength: brass construction with a straight bar profile
- Maintain a streamlined look: concealed screw mounting hardware
- Coordinate your hardware: designed for the que new collection and matching que new accessories
- Fit your style: multiple designer finish options available

Specs & Installation:
- Center-to-center: 30-Inch
- Overall size: 33 in W x 3 in H; projection: 3 in
- Bar diameter: 0.5 in
- Weight capacity: 10 lb
- Mounting: wall mount; includes mounting plates and all installation hardware (screw size #8 x 1 1/4")
...
- Collection: Que New (source: collection=Que New)
- Material: brass (solid brass construction) (source: material=Brass)
- Mounting type: wall mount (source: mounting_type=Wall mount)
- Center-to-center dimension: 30 in (source: center_to_center=30 in)
- Overall dimensions: 33 in W x 3 in H; projection 3 in (source: product_width=33 in)
- Bar diameter: 0.5 in (source: diameter=0.5 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 92.83% | 93.33% | 90.00% | 93.33% |  |
| 2 | 0 | 91.83% | 93.33% | 90.00% | 86.67% | bing_title must end with Allied Brass |
