...
**Generated:** 2026-01-28T02:43:22.003998
**Status:** REJECTED
...
```
Keep hand towels right where you need them—next to the sink—without drilling into walls. The Carolina Collection guest towel stand adds convenient countertop towel storage with a classic, traditional look.

Highlights:
- Keep towels within easy reach: Two arms hold guest towels, hand towels, or washcloths at the vanity
- Stay stable on the counter: Heavy base is designed to help prevent tipping during everyday use
- Protect countertop surfaces: Felt pad on the bottom helps prevent scratching
- Coordinate a matched bath: Designed to pair with matching Carolina and other traditional bathroom hardware
- Built for lasting use: Crafted from solid brass construction

Specs:
- Overall dimensions (L x H x W): 16.3 x 14 x 5.5 in.
- Box dimensions (L x H x W): 18 x 8 x 8 in.
...
- Claim rejected: 'Felt pad on bottom helps protect countertop surfaces from scratching.' - Claimed 'felt pad on bottom will protect countertop surfaces. Felt pad will prevent scratching on any surface' but actual value is 'This elegantly crafted vanity top guest towel stand will add style and convenience to your bathroom décor. Guest towel stand has two arms to keep your towels within reach of the sink where they are needed. Guest towel stand was designed ideally for hand towels and washcloths. Heavy base will help prevent stand from tipping and felt pad on bottom will protect countertop surfaces. Crafted from the finest solid brass materials Felt pad will prevent scratching on any surface Heavy base will help prevent tipping Traditional design with classic design elements Available in a wide variety of lifetime designer finishes Limited Lifetime Warranty Specification & Documentation Product dimensions, in. (LxHxW): 16.3x14x5.5 Box dimensions, in. (LxHxW): 18x8x8 Shipping weight, lbs: 7'
...
- Guest towel stand has two arms to keep towels within reach of the sink. (source: current_description=Guest towel stand has two arms to keep your towels within reach of the sink where they are needed.)
...
- Overall dimensions are 16.3 x 14 x 5.5 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 16.3x14x5.5)
- Multiple designer finish options are available. (source: finish_variety=Multiple designer finish options available)
- Covered by a Limited Lifetime Warranty. (source: current_description=Limited Lifetime Warranty)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 86.17% | 86.67% | 90.00% | 80.00% |  |
| 2 | 1 | 81.83% | 83.33% | 83.33% | 73.33% | bing_title must end with Allied Brass; shopify_title must end with Allied Brass |
| 3 | 2 | 79.50% | 80.00% | 86.67% | 70.00% | bing_title must end with Allied Brass |
