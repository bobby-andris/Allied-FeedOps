...
**Generated:** 2026-01-25T04:59:02.562133
**Status:** APPROVED
...
**Title (82 chars):**
```
Glass Shelf 16-Inch with Integrated Towel Bar, Wall Mount Solid Brass Allied Brass
```

**Description (1061 chars):**
```
Add storage and hanging space with a 16-Inch glass shelf featuring an integrated towel bar for everyday bathroom organization. Built with 3/8-Inch thick tempered, beveled-edge glass and solid brass hardware, this wall mount design keeps essentials within reach while saving floor space. Part of the Waverly Place Collection, it’s designed to coordinate with matching Waverly Place accessories for a cohesive, transitional bathroom look.

Highlights:
- 16 x 5-Inch glass shelf adds display and storage space
- Integrated towel bar keeps hand towels accessible
- 3/8-Inch thick tempered glass with beveled edges
- Solid brass hardware for a crafted, enduring feel
...
- Style: Traditional (fits transitional bath accessories and transitional bathroom hardware)
```
...
| statement_finishes | fire engine red, unlacquered brass, golden yellow, lavender, spanish gold | enrichment_finishes |
...
**Verified:** 21/24 claims

### Rejected Claims

- Claim rejected: 'Available in 28 designer finishes' - Field 'finish_variety' not found in source data
...
- 16-Inch glass shelf with integrated towel bar (source: current_title=Waverly Place 16 Inch Glass Vanity Shelf with Integrated Towel Bar)
...
- Solid brass hardware (source: bullet_2=Crafted from the finest solid brass materials)
...
- Included: glass shelf and all installation hardware (source: included_items=Glass shelf and all installation hardware.)
- Screw size: #8 x 1 1/4 (source: screw_size=#8 X1 1/4")
...
- unlacquered brass (source: available_finishes=unlacquered brass)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 95.67% | 96.67% | 93.33% | 93.33% |  |
| 2 | 0 | 95.17% | 96.67% | 90.00% | 93.33% | google_description missing description term in first 150 chars; bing_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
| 3 | 2 | 92.83% | 93.33% | 90.00% | 93.33% | google_description missing description term in first 150 chars; bing_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
