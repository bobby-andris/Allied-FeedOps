...
**Generated:** 2026-01-30T15:10:54.662931
**Status:** APPROVED
...
**Title (90 chars):**
```
Glass Shelf, 16-Inch Double Wall Mount W/ Gallery Rail, Solid Brass Hardware, Allied Brass
```

**Description (635 chars):**
```
Glass shelf, 16-inch double wall-mount bathroom shelf with gallery rail, 3/8-in thick tempered glass and solid brass hardware for organized countertop-free storage. Two-tier design provides space for toiletries and decor while the gallery rail keeps items secure. Traditional styling with concealed screw mounting for a clean, finished look. Glass dimensions: 16 x 5 inches; overall size: 16 in L x 5 in projection x 8 in H. Weight capacity: 4 lb. Includes glass shelf and installation hardware; screw size #8 x 1 1/4. Available in multiple designer finish options. Backed by a lifetime warranty. Allied Brass Waverly Place collection.
```
...
**Token Usage:** Prompt tokens: 6558, Completion tokens: 1669, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.032602
...
- Made with 3/8-in (0.38 in) thick tempered glass (source: thickness=0.38 in)
- Solid brass hardware/materials (source: bullet_2=Crafted from the finest solid brass materials)
- Glass dimensions are 16 x 5 inches (source: bullet_5=Glass Dimensions: 16 x 5 Inches)
- Overall dimensions: 16 in length x 5 in width/projection x 8 in height (source: current_description=Length, in Depth, in Height, in Weight, lbs 16 Inch 16 5 8 10.4)
...
- Available in 28 finishes (multiple designer finish options) (source: available_finishes=Antique Brass, Antique Bronze, Brushed Bronze, Matte Black, Antique Copper, Matte Gray, Oil Rubbed Bronze, Polished Brass, Polished Chrome, Antique Pewter, Polished Nickel, Satin Brass, Satin Chrome, Satin Nickel, Unlacquered Brass, Venetian Bronze, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
- Lifetime warranty (source: current_description=finished with the highest quality materials to provide a lifetime of beauty.)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 89.00% | 90.00% | 90.00% | 83.33% |  |
| 2 | 0 | 87.17% | 86.67% | 90.00% | 86.67% |  |
| 3 | 1 | 86.17% | 86.67% | 86.67% | 83.33% |  |
