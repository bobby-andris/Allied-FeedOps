...
**Generated:** 2026-01-29T11:28:49.988452
**Status:** APPROVED
...
```
Stop piling towels and robes on the counter—create organized, wall-mounted storage right where you need it in the bathroom.

Highlights:
- Keep daily essentials within reach with a 6 position multi hook for towels, robes, and more
- Maintain a clean, finished look with concealed screw mounting hardware
- Save space in smaller baths with a wall mount design that keeps items off the floor
- Coordinate your bath with the Mercury Collection for a matching Mercury look across transitional bathroom hardware
- Count on enduring performance with solid brass construction and a corrosion-free, rust-free designer finish
...
**Token Usage:** Prompt tokens: 5992, Completion tokens: 1339
**Estimated Cost:** $0.029232
...
- 6 position multi hook, wall mount design (source: current_title=Mercury Collection 6 Position Tie and Belt Rack)
...
- Dimensions (L x H x W): 15.5 x 3.2 x 4 inches (source: current_description=Product dimensions, in. (LxHxW): 15.5x3.2x4)
- Weight capacity: 2 lb (source: weight_capacity=2 lb)
- Included: Multi hook and all installation hardware (source: included_items=Multi hook and all installation hardware.)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 74.33% | 73.33% | 80.00% | 73.33% |  |
| 2 | 2 | 73.33% | 73.33% | 80.00% | 66.67% |  |
| 3 | 0 | 81.83% | 83.33% | 73.33% | 83.33% | shopify_title must end with Allied Brass |
