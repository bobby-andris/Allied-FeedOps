...
**Generated:** 2026-01-29T13:46:11.755354
**Status:** APPROVED
...
**Title (93 chars):**
```
Toilet Paper Stand, 28-Inch, Solid Brass, Freestanding, Best Sellers Collection, Allied Brass
```

**Description (915 chars):**
```
Need a toilet paper roll holder without drilling into tile or hunting for wall space? This freestanding toilet paper stand brings European-style access to your bathroom with a secure, heavy base.

Highlights:
- Place it anywhere you need it—freestanding design requires no wall mounting
- Change rolls fast—European-style hook makes swapping toilet tissue quick and easy
- Keep it steady on the floor—heavy base is designed to help prevent tipping
- Coordinate your bathroom look—part of the Best Sellers collection with multiple designer finish options
- Built for lasting use—crafted from solid brass and backed by a Limited Lifetime Warranty

Specs & Installation:
- Product type: Freestanding toilet tissue stand (includes toilet tissue stand)
- Material: Brass
- Overall dimensions (L x H x W): 6.75 in x 26 in x 5.5 in
...
**Token Usage:** Prompt tokens: 5892, Completion tokens: 1455
**Estimated Cost:** $0.030681
...
| collection | Best Sellers | collection |
...
| collection_context | Best Sellers (Unknown) - distinctive design | enrichment_collection |
...
| key_differentiators | Part of coordinated Best Sellers collection; 28 finish options including statement colors | enrichment_competitive |
| design_intent_keywords | best sellers collection, transitional bathroom hardware, versatile bath accessories, freestanding | enrichment_keywords |
...
- Product type is a free standing European style toilet tissue holder/stand. (source: current_title=Free Standing European Style Toilet Tissue Holder)
...
- Heavy base is designed to help prevent tipping. (source: bullet_2=Heavy base will help prevent tipping)
...
- Overall dimensions are 6.75 in (L) x 26 in (H) x 5.5 in (W). (source: current_description=Product dimensions, in. (LxHxW): 6.75x26x5.5)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 60.00% | 60.00% | 60.00% | 60.00% |  |
| 2 | 2 | 60.00% | 60.00% | 60.00% | 60.00% |  |
| 3 | 0 | 68.00% | 70.00% | 63.33% | 63.33% | google_description missing 2 description term(s); found 1 |
