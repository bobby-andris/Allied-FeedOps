...
**Generated:** 2026-02-03T11:26:51.526769
**Status:** APPROVED
...
**Title:** Paper Towel Holder - 14-Inch Freestanding Solid Brass Countertop Paper Towel Valet (5 X 14 X 5 In), Contemporary Style, Allied Brass

**Description:** Stop dealing with tipping paper towel stands and cluttered counters—this freestanding countertop paper towel holder keeps a roll stable and always within reach. Available in a wide variety of lifetime...
...
**Title (103 chars):**
```
Paper Towel Holder, 14-Inch Freestanding Solid Brass Countertop Valet, Contemporary Style, Allied Brass
```

**Description (535 chars):**
```
This 14-inch freestanding paper towel holder is crafted from solid brass for steady, everyday countertop use. The 5 x 14 x 5 in paper towel valet keeps a roll within easy reach and stays put while you tear. A weighted base helps prevent tipping, and a felt pad protects kitchen surfaces from scratches. Designed in a crisp contemporary style, it coordinates with a wide variety of lifetime designer finishes. No wall mount installation is required, and assembly is not required. Backed by a limited lifetime warranty from Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6914, Completion tokens: 1277, Cached tokens: 2560 (37% cache hit)
**Estimated Cost:** $0.027737
...
| current_title | Paper Towel Holder - 14-Inch Freestanding Solid Brass Countertop Paper Towel Valet (5 X 14 X 5 In), Contemporary Style, Allied Brass | current_title |
| current_description | Stop dealing with tipping paper towel stands and cluttered counters—this freestanding countertop paper towel holder keeps a roll stable and always within reach. Available in a wide variety of lifetime designer finishes to coordinate with your kitchen. Stays put while you tear: weighted base helps prevent tipping Protects your countertop: felt pad helps prevent scratches Built for daily use: solid brass construction outlasts die-cast zinc alternatives Keeps your counter organized: freestanding design requires no wall mounting Specs Product type: Countertop paper towel holder / paper towel valet Mounting: Freestanding Material: Brass (solid brass construction) Dimensions (L x H x W): 5 x 14 x 5 in Product weight: 4.8 lb Included items: Paper towel holder Warranty: Limited lifetime warranty Complete your kitchen with coordinating pieces in matching finishes. | current_description |
...
| feature_title_keywords | Wall Mount, Freestanding | enrichment_features |
| feature_benefits | wall-mounted installation saves floor space; freestanding design requires no wall mounting | enrichment_features |
...
| design_intent_keywords | modern bathroom hardware, contemporary bath accessories, minimalist bathroom fixtures, wall mount, freestanding | enrichment_keywords |
...
- Product type is a paper towel holder / paper towel valet for the countertop (source: current_description=Product type: Countertop paper towel holder / paper towel valet)
- Freestanding mounting for countertop use (source: mounting_type=Freestanding)
- Made with solid brass construction (source: current_description=Material: Brass (solid brass construction))
- Height is 14 inches (source: product_height=14 in)
- Overall dimensions are 5 x 14 x 5 inches (L x H x W) (source: current_description=Dimensions (L x H x W): 5 x 14 x 5 in)
- Weighted base helps prevent tipping (source: current_description=Stays put while you tear: weighted base helps prevent tipping)
- Felt pad helps prevent scratches on the countertop (source: current_description=Protects your countertop: felt pad helps prevent scratches)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 80.12% | 77.50% | 77.50% | 95.00% |  |
| 2 | 2 | 80.12% | 77.50% | 77.50% | 95.00% |  |
| 3 | 0 | 78.75% | 75.00% | 80.00% | 95.00% |  |
