...
**Generated:** 2026-01-30T04:42:05.621110
**Status:** APPROVED
...
**Title (88 chars):**
```
Vanity Top Soap Dispenser, 7-Inch H Countertop Solid Brass Bathroom Pump -, Allied Brass
```

**Description (661 chars):**
```
Vanity top soap dispenser with 3 in L x 7 in H x 5 in W dimensions, solid brass construction, and countertop mounting for bathroom sinks and vanities. Holds soap, lotion, or hand sanitizer in a generous 5 ounce bottle. Traditional design with classic elements and a space-saving footprint; projection is 4 inches. Includes soap dispenser. Built for daily bathroom use with brass material and a lifetime finish to help prevent rust. Limited lifetime warranty. Coordinates with transitional bath accessories and matching Waverly Place pieces; ideal for versatile bath accessories and transitional bathroom hardware in the Waverly Place collection by Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6387, Completion tokens: 1622, Cached tokens: 4352 (68% cache hit)
**Estimated Cost:** $0.030077
...
- Product type is a vanity top soap dispenser for soap, lotion, or hand sanitizer. (source: current_title=Vanity Top Soap Dispenser)
- Countertop mounting type. (source: mounting_type=Countertop)
- Made of solid brass / brass material. (source: bullet_1=Crafted from the finest solid brass materials)
...
- Included item: soap dispenser. (source: included_items=Soap dispenser.)
...
| 2 | 1 | 80.50% | 80.00% | 76.67% | 86.67% |  |
| 3 | 2 | 77.00% | 80.00% | 76.67% | 63.33% | shopify_title missing title anchor in first 70 chars: vanity top soap dispenser; shopify_title must end with Allied Brass |
