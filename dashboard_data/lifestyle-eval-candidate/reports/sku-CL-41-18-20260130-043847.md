...
**Generated:** 2026-01-30T04:38:47.152710
**Status:** APPROVED
...
**Title (89 chars):**
```
Towel Bar, 18-Inch Wall Mount Solid Brass Straight Bar, Carolina Collection, Allied Brass
```

**Description (662 chars):**
```
Towel bar with 18-inch center-to-center length for bathroom towel storage, featuring wall mount installation and brass construction in a straight bar design. Traditional style hardware with concealed screw mounting for a clean look and efficient use of space. Includes towel bar, mounting plates, and all installation hardware; no assembly required. Bar diameter is 0.75 in and weight capacity is 10 lb. Use as a bathroom towel bar/towel holder to coordinate with traditional bathroom hardware and classic bath accessories; ideal for matching carolina looks and heritage bathroom fixtures. Backed by a Limited Lifetime Warranty. Allied Brass Carolina collection.
```
...
**Token Usage:** Prompt tokens: 6428, Completion tokens: 1358, Cached tokens: 4480 (69% cache hit)
**Estimated Cost:** $0.026341
...
- Center-to-center length is 18 in. (source: center_to_center=18 in)
...
- Concealed screw mounting hardware supports easy installation. (source: bullet_2=Concealed screw mounting hardware makes installation easy)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 79.83% | 83.33% | 83.33% | 60.00% | shopify_title missing title anchor in first 70 chars: towel bar |
| 2 | 1 | 79.83% | 83.33% | 83.33% | 60.00% | shopify_title missing title anchor in first 70 chars: towel bar; shopify_title must end with Allied Brass |
| 3 | 2 | 77.50% | 80.00% | 83.33% | 60.00% | shopify_title missing title anchor in first 70 chars: towel bar; shopify_title must end with Allied Brass |
