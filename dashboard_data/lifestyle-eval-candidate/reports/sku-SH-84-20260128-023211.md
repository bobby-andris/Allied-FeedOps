...
**Generated:** 2026-01-28T02:32:11.287003
**Status:** APPROVED
...
**Title (123 chars):**
```
Towel Stand With 4 Pivoting Swing Arms 49-Inch Solid Brass Freestanding | Assorted Free Standing Accessories | Allied Brass
```

**Description (1029 chars):**
```
Keep towels organized and within reach without drilling into your walls. This freestanding 4 pivoting swing arm towel stand creates flexible hanging space for bath towels and hand towels, with arms that swing for easy access and spacing.

Highlights:
- Separate towels for faster drying: 4 pivoting swing arms spread towels out and rotate for convenient use
- Add storage anywhere in the bathroom: freestanding design requires no wall mounting
- Stay stable on the floor: large, weighted base is designed to help prevent tipping
- Built for enduring daily use: crafted from solid brass materials to resist rust and corrosion
- Coordinate your look: part of the Assorted Free Standing Accessories collection with multiple designer finish options

Specs & Installation:
- Product type: Freestanding towel stand (swing arm style)
...
- Features 4 pivoting arms. (source: current_description=Towel stand has 4 pivoting arms so that you can maximize your space.)
- Large base is weighted to help prevent tipping. (source: current_description=Large base is weighted to help prevent tipping.)
- Made of solid brass materials to resist rust and corrosion. (source: current_description=Towel stand is made of the finest solid brass materials so that it will not rust or corrode)
- Available in a variety of designer finishes. (source: current_description=Available in a variety of lifetime designer finishes)
- Product dimensions are 12 x 49 x 9.25 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 12x49x9.25)
...
- Collection context: Assorted Free Standing Accessories. (source: collection_context=Assorted Free Standing Accessories (Unknown) - distinctive design)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 84.67% | 86.67% | 80.00% | 80.00% |  |
| 2 | 0 | 77.67% | 76.67% | 80.00% | 80.00% |  |
| 3 | 2 | 76.17% | 76.67% | 73.33% | 76.67% |  |
