...
**Generated:** 2026-01-28T11:47:21.951758
**Status:** APPROVED
...
```
Keep towels within reach without giving up wall space—two pivoting arms swing out when you need them and fold close to the wall when you don’t. Designed for organized, flexible bathroom towel storage with a clean, finished look.

Highlights:
- Save space in smaller bathrooms: double swing arms swivel independently and tuck in close to the wall
- Keep towels separated and accessible: two arms pivot for flexible daily use
- Maintain a clean, tailored look: concealed screw mounting hardware
- Built for lasting use: crafted from solid brass

Specs & Installation:
- Product dimensions (L x H x W): 12.5 x 7.1 x 7 inches
- Box dimensions (L x H x W): 18 x 12 x 12 inches
- Shipping weight: 7 lbs
- Wall-mounted; concealed screw mounting hardware included
- Collection context: Assorted Wall Accessories collection
- Style: transitional bathroom hardware with versatile bath accessories
...
- Double swing arm towel rail with independently swiveling arms that tuck close to the wall when not in use (source: current_description=Each arm swivels independently and snuggles close to the wall when not in use)
- Crafted from solid brass materials (source: current_description=Created with the finest solid brass materials)
- Concealed screw mounting hardware for a clean appearance (source: current_description=Concealed screw mounting hardware installs easily)
- Product dimensions: 12.5 x 7.1 x 7 inches (L x H x W) (source: current_description=Product dimensions, in. (LxHxW): 12.5x7.1x7)
- Shipping weight: 7 lbs (source: current_description=Shipping weight, lbs: 7)
- Multiple designer finish options available (28 finish options including statement colors) (source: key_differentiators=Part of coordinated Assorted Wall Accessories collection; 28 finish options including statement colors)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 70.83% | 73.33% | 63.33% | 66.67% |  |
| 2 | 2 | 64.00% | 60.00% | 73.33% | 73.33% |  |
| 3 | 0 | 69.50% | 70.00% | 70.00% | 66.67% | bing_title must end with Allied Brass |
