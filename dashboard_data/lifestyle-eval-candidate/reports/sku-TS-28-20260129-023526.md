...
**Generated:** 2026-01-29T02:35:26.076065
**Status:** APPROVED
...
**Title (97 chars):**
```
Toilet Paper Stand, 26-Inch, Solid Brass, European Style, Best Sellers Collection, | Allied Brass
```

**Description (845 chars):**
```
Need toilet paper storage without drilling into the wall? This freestanding toilet paper stand adds convenient roll access in bathrooms where wall space is limited.

Highlights:
- Keep rolls within easy reach: European style hook design makes changing the roll quick and easy
- Place it anywhere: freestanding toilet paper stand is ideal beside a toilet when you don’t want wall-mounted hardware
- Stay steady on the floor: heavy base is designed to help prevent tipping
- Built for enduring daily use: crafted from solid brass construction
- Coordinate your space: part of the Best Sellers collection for a distinctive, transitional bathroom hardware look

Specs:
- Overall dimensions (L x H x W): 6.75 x 26 x 5.5 inches
...
- Heavy base is designed to help prevent tipping (source: current_description=Heavy base will help prevent tipping)
...
- Overall dimensions: 6.75 x 26 x 5.5 inches (L x H x W) (source: current_description=Product dimensions, in. (LxHxW): 6.75x26x5.5)
...
- Part of the Best Sellers collection (source: collection=Best Sellers)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 52.50% | 50.00% | 56.67% | 60.00% |  |
| 2 | 2 | 56.67% | 56.67% | 53.33% | 60.00% | google_description missing 2 description term(s); found 1 |
| 3 | 1 | 54.83% | 53.33% | 60.00% | 56.67% | google_description missing 2 description term(s); found 1 |
