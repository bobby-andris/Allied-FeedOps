...
**Generated:** 2026-01-30T04:21:17.517237
**Status:** APPROVED
...
```
Toilet paper stand, 28-inch freestanding solid brass toilet tissue holder for bathroom use with European-style hook for fast roll changes and a heavy base to help prevent tipping. Traditional style floor-mounted toilet paper storage solution when wall space is limited; no wall mounting required. Includes one toilet tissue stand. Product dimensions: 6.75 in L x 26 in H x 5.5 in W. Brass construction with multiple designer finish options available and a Limited Lifetime Warranty. Assembled in the USA. Ideal for traditional bathroom hardware, classic bath accessories, and heritage bathroom fixtures. Allied Brass TS-28.
```
...
**Token Usage:** Prompt tokens: 6307, Completion tokens: 1322, Cached tokens: 2560 (40% cache hit)
**Estimated Cost:** $0.027305
...
- Product is a free standing European style toilet tissue holder (toilet tissue stand). (source: current_title=Free Standing European Style Toilet Tissue Holder)
...
- Heavy base will help prevent tipping. (source: bullet_2=Heavy base will help prevent tipping)
...
- Warranty is Limited Lifetime Warranty. (source: bullet_5=Limited Lifetime Warranty)
- Assembled in the USA. (source: bullet_6=Assembled in the USA)
- Product dimensions are 6.75 in L x 26 in H x 5.5 in W. (source: current_description=Product dimensions, in. (LxHxW): 6.75x26x5.5)
- Included items: Toilet tissue stand. (source: included_items=Toilet tissue stand.)
