...
**Generated:** 2026-01-30T04:38:06.298985
**Status:** APPROVED
...
**Title (100 chars):**
```
Toilet Paper Holder W/ Glass Shelf, 8.75-Inch, Wall Mount Solid Brass, Waverly Place -, Allied Brass
```

**Description (664 chars):**
```
Toilet paper holder with glass shelf, 8.75 in L x 4.6 in H x 6 in projection, solid brass construction, wall mount for bathroom organization and space-saving storage. Two-post toilet tissue holder design with integrated glass shelf above the roll to keep small items dry and within reach. Concealed screw mounting hardware for a clean, finished look; includes toilet paper holder and all installation hardware (#8 x 1 1/4 in screws). Traditional/transitional styling for versatile bath accessories and transitional bathroom hardware, ideal for matching Waverly Place and grooved bathroom hardware. Limited lifetime warranty. Allied Brass, Waverly Place collection.
```
...
**Token Usage:** Prompt tokens: 6502, Completion tokens: 1418, Cached tokens: 4480 (68% cache hit)
**Estimated Cost:** $0.027311
...
- Product is a two-post toilet tissue/toilet paper holder with a glass shelf. (source: current_title=Waverly Place Collection Two Post Toilet Tissue Holder with Glass Shelf)
...
- Made from solid brass materials / brass construction. (source: bullet_1=Crafted from the finest solid brass materials)
- Overall dimensions are 8.75 in L x 4.6 in H x 6 in W. (source: current_description=Product dimensions, in. (LxHxW): 8.75x4.6x6)
...
| 3 | 0 | 77.00% | 80.00% | 80.00% | 60.00% | shopify_title missing title anchor in first 70 chars: toilet paper holder; shopify_title must end with Allied Brass |
