...
**Generated:** 2026-01-30T04:18:53.687168
**Status:** APPROVED
...
**Title (109 chars):**
```
Recessed Toilet Paper Holder, 6.125-Inch Square, Solid Brass In-Wall Mount, Carolina Collection, Allied Brass
```

**Description (618 chars):**
```
Recessed toilet paper holder with 6.125 in x 6.125 in faceplate and 4 in projection, made from brass for bathroom use. In-wall recessed mounting creates a built-in, space-saving toilet tissue holder profile with a clean look. Traditional style accessory with concealed screw mounting hardware. Includes recessed toilet paper holder and all installation hardware. Product dimensions: 6.125 in L x 6.125 in H x 4 in W (projection 4 in). Shipping weight 2.4 lb. Covered by a limited lifetime warranty. Coordinates with traditional bathroom hardware and classic bath accessories in the Carolina collection by Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6418, Completion tokens: 1461, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.029445
...
- Product dimensions are 6.125 in L x 6.125 in H x 4 in W. (source: current_description=Product dimensions, in. (LxHxW): 6.125x6.125x4)
...
- Available finishes include multiple designer finish options (28 listed). (source: available_finishes=Antique Brass, Antique Bronze, Brushed Bronze, Matte Black, Antique Copper, Matte Gray, Oil Rubbed Bronze, Polished Brass, Polished Chrome, Antique Pewter, Polished Nickel, Satin Brass, Satin Chrome, Satin Nickel, Unlacquered Brass, Venetian Bronze, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
