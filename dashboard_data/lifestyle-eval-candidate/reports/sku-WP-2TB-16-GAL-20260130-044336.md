...
**Generated:** 2026-01-30T04:43:36.359415
**Status:** APPROVED
...
**Title (102 chars):**
```
Glass Shelf With Towel Bar, 16-Inch Wall Mount Solid Brass Gallery Rail, Waverly Place -, Allied Brass
```

**Description (642 chars):**
```
Glass shelf with towel bar, 16-inch wall mount bathroom shelf with 3/8-in (0.38 in) tempered glass and solid brass hardware for organized storage and hanging towels. Double shelf design with a solid brass gallery rail helps keep items secure. Traditional/transitional look for versatile bath accessories and transitional bathroom hardware updates. Concealed screw mounting creates a clean, finished appearance. Includes glass shelf and all installation hardware; uses #8 x 1 1/4" screws. Shelf depth/projection 5 in, height 12 in, weight capacity 4 lb, product weight 11.2 lb. Limited Lifetime Warranty. Allied Brass Waverly Place collection.
```
...
**Token Usage:** Prompt tokens: 6543, Completion tokens: 1492, Cached tokens: 6144 (93% cache hit)
**Estimated Cost:** $0.026962
...
- Product width/projection (depth) is 5 in. (source: product_width=5 in)
- Product height is 12 in. (source: product_height=12 in)
- Weight capacity is 4 lb. (source: weight_capacity=4 lb)
- Product weight is 11.2 lb. (source: product_weight=11.2 lb)
...
| 2 | 1 | 81.00% | 80.00% | 80.00% | 86.67% |  |
| 3 | 2 | 81.00% | 80.00% | 80.00% | 86.67% | shopify_title must end with Allied Brass |
