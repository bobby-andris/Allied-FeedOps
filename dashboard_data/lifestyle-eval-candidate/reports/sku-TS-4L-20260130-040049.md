...
**Generated:** 2026-01-30T04:00:49.535998
**Status:** APPROVED
...
**Title (120 chars):**
```
Freestanding 4 Pivoting Swing Arm Towel Valet, 49-Inch Solid Brass Stand, Traditional Bathroom Accessory -, Allied Brass
```

**Description (570 chars):**
```
Freestanding 4 pivoting swing arm towel valet, 49-inch tall (12 in L x 10.5 in W) solid brass towel stand for bathroom towel storage and drying. This floor-standing towel valet uses a heavy weighted base to help prevent tipping and includes a felt pad to help prevent surface scratching. Traditional style accessory for classic bath accessories and heritage bathroom fixtures; freestanding design requires no wall mounting. Some assembly required. Includes towel stand. Backed by a limited lifetime warranty and offered in multiple designer finish options. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6387, Completion tokens: 1218, Cached tokens: 2560 (40% cache hit)
**Estimated Cost:** $0.025989
...
- Freestanding mounting type; requires no wall mounting. (source: mounting_type=Freestanding)
- Made of brass / solid brass materials. (source: material=Brass)
- Overall dimensions are 12 in (L) x 49 in (H) x 10.5 in (W). (source: current_description=Product dimensions, in. (LxHxW): 12x49x10.5)
