...
**Generated:** 2026-01-30T04:18:04.695018
**Status:** APPROVED
...
**Title (98 chars):**
```
Vanity Top Toilet Tissue Holder, 5.5-Inch Solid Brass Countertop Stand, Modern Style, Allied Brass
```

**Description (640 chars):**
```
Vanity top toilet tissue holder with 5.5 in L x 6 in H x 5 in W dimensions, solid brass construction, and a weighted base for stable countertop placement in the bathroom where wall space is limited. Contemporary/modern design for modern bathroom hardware and contemporary bath accessories; ideal for minimalist bathroom fixtures and clean vanity styling. Countertop (freestanding) mount with felt pad to help prevent surface scratching. Space-saving toilet paper holder for standard tissue rolls; includes vanity top toilet tissue holder. Product weight 4 lb; ships assembled (no assembly required). Limited lifetime warranty. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6283, Completion tokens: 1599, Cached tokens: 2560 (40% cache hit)
**Estimated Cost:** $0.031141
...
- Countertop mounting type (freestanding vanity top use). (source: mounting_type=Countertop)
- Made of solid brass / brass construction. (source: current_description=Made of solid brass and provided with a lifetime finish to insure products will never rust.)
...
- Product dimensions are 5.5 in (L) x 6 in (H) x 5 in (W). (source: current_description=Product dimensions, in. (LxHxW): 5.5x6x5)
- Product length is 5.5 in. (source: product_length=5.5 in)
- Product height is 6 in. (source: product_height=6 in)
- Product width is 5 in. (source: product_width=5 in)
- Product weight is 4 lb. (source: product_weight=4 lb)
- No assembly required. (source: assembly_required=False)
- Included item is Vanity Top Toilet Tissue Holder. (source: included_items=Vanity Top Toilet Tissue Holder.)
- Warranty is limited lifetime. (source: bullet_6=Limited Lifetime Warranty)
- Available in a wide variety of lifetime designer finishes (28 listed finishes). (source: available_finishes=Antique Brass, Antique Bronze, Brushed Bronze, Matte Black, Antique Copper, Matte Gray, Oil Rubbed Bronze, Polished Brass, Polished Chrome, Antique Pewter, Polished Nickel, Satin Brass, Satin Chrome, Satin Nickel, Unlacquered Brass, Venetian Bronze, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
