...
**Generated:** 2026-01-30T05:01:38.745826
**Status:** APPROVED
...
**Title (91 chars):**
```
Glass Shelf, 16-Inch Wall Mount 3-Tier Tempered Glass, Solid Brass Hardware -, Allied Brass
```

**Description (625 chars):**
```
Glass shelf, 16 x 5 inch wall mount triple-tier bathroom vanity shelf with 3/8-in (0.38 in) thick tempered, beveled-edge glass and brass hardware for organized countertop and wall storage. Contemporary, modern design for modern bathroom hardware and contemporary bath accessories; a clean fit for minimalist bathroom fixtures. Concealed screw mounting hardware creates a finished look and keeps fasteners hidden. Includes glass shelf and all installation hardware; uses #8 x 1 1/4 in screws. Weight capacity: 6 lb. Assembly required: no. Available in multiple designer finish options. Limited Lifetime Warranty. Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6394, Completion tokens: 1396, Cached tokens: 2560 (40% cache hit)
**Estimated Cost:** $0.028494
...
- Product is a triple-tiered glass shelf. (source: current_title=Triple Tiered Glass Shelf)
...
| 3 | 2 | 83.83% | 83.33% | 83.33% | 86.67% | shopify_title must end with Allied Brass |
