...
**Generated:** 2026-01-29T12:39:44.070969
**Status:** APPROVED
...
**Title (81 chars):**
```
Grab Bar, 60-Inch 3-Post Wall Mount, Iron Pipe, Pipeline Collection, Allied Brass
```

**Description (939 chars):**
```
Create a safer, more accessible bathroom with an extended-length grab bar that provides secure support where you need it most.

Highlights:
- Steadier support along a longer span with a 3-post design that adds a third center bracket for stability
- Accessibility-ready performance with an ADA compliant grab bar design for everyday confidence
- Industrial, pipe-style look that complements loft bathroom fixtures and industrial bathroom hardware
- Enduring finish protection with a highly durable powder coat finish for corrosion-free, rust-free performance
- Easy to coordinate with matching Pipeline collection pipe-style bath accessories and pipe-style accessories

Specs & Installation:
- Collection: Pipeline
- Mounting: Wall mount
- Material: Iron Pipe
- Dimensions (L x H x W): 63 in x 3 in x 3.58 in (projection 3.58 in)
...
**Token Usage:** Prompt tokens: 6062, Completion tokens: 1582
**Estimated Cost:** $0.032757
...
- Product is an extended length 3-post grab bar from the Pipeline collection. (source: current_title=Pipeline Extended 3 Post Grab Bar - 60 inch)
- ADA compliant grab bar design. (source: bullet_2=ADA Compliant)
- Three-post design includes a third center bracket for stability. (source: bullet_3=Bars feature a third center bracket to ensure stability)
...
- Product dimensions are 63 x 3 x 3.58 inches with 3.58-inch projection. (source: current_description=Product dimensions, in. (LxHxW): 63x3x3.58)
