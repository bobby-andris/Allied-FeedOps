...
**Generated:** 2026-01-29T12:24:52.090965
**Status:** APPROVED
...
**Title (88 chars):**
```
Vanity Top Soap Dispenser, 7-Inch H X 5-Inch W, Solid Brass, Waverly Place, Allied Brass
```

**Description (1043 chars):**
```
Clear sink clutter and keep soap, lotion, or hand sanitizer within easy reach with a vanity top soap dispenser designed for everyday bathroom use.

Highlights:
- Keep counters cleaner with a space-saving, countertop-mounted dispenser
- Refill less often with a generous 5-ounce bottle capacity
- Count on enduring use with solid brass construction
- Coordinate your bath with the Waverly Place collection for matching Waverly Place pieces and a cohesive look
- Fits transitional bath accessories and transitional bathroom hardware styling for a versatile bath accessories update

Specs & Installation:
- Product type: Vanity top dispenser for soap, lotion, or hand sanitizer
- Mounting type: Countertop
- Material: Brass
- Capacity: 5 oz
- Dimensions (L x H x W): 3 in x 7 in x 5 in
- Projection: 4 in
...
**Token Usage:** Prompt tokens: 5938, Completion tokens: 1561
**Estimated Cost:** $0.032246
...
- Vanity top dispenser for soap, lotion, or hand sanitizer (source: current_description=Add a stylish touch to your bathroom with this elegant Vanity Top Dispenser for Soap, Lotion or Hand Sanitizer.)
...
- Countertop mounting (source: mounting_type=Countertop)
- Dimensions: 3 in L x 7 in H x 5 in W (source: current_description=Product dimensions, in. (LxHxW): 3x7x5)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 86.17% | 86.67% | 83.33% | 86.67% |  |
| 2 | 0 | 85.67% | 86.67% | 83.33% | 83.33% |  |
