...
**Generated:** 2026-01-25T19:20:53.127042
**Status:** APPROVED
...
**Description (812 chars):**
```
Upgrade countertop organization with a freestanding paper towel holder crafted from solid brass and designed with a weighted base to help prevent tipping. Ideal for modern bathroom hardware and contemporary bath accessories looks where clean lines and functional, minimalist styling matter.

Highlights:
- Freestanding design requires no wall mounting for easy placement on a counter
- Solid brass construction for a substantial, crafted feel
...
Specs:
- Overall size: 14-Inch H x 5-Inch W x 5-Inch L
- Weight: 4.8 lb
- Material: Brass
...
- Freestanding paper towel holder for countertop placement (no wall mounting). (source: mounting_type=Freestanding)
...
- Overall size: 14-Inch high and 5-Inch by 5-Inch footprint. (source: product_height=14 in)
- Length and width are 5 inches each. (source: product_length=5 in)
- No assembly required. (source: assembly_required=False)
- Limited Lifetime Warranty. (source: bullet_5=Limited Lifetime Warranty)
- Available in a wide variety of lifetime designer finishes (multiple options including statement colors). (source: bullet_4=Available in a wide variety of lifetime designer finishes)
...
| 2 | 0 | 85.67% | 86.67% | 83.33% | 83.33% | shopify_description missing 2 description term(s); found 1 |
| 3 | 1 | 85.17% | 86.67% | 83.33% | 80.00% | shopify_title must end with Allied Brass |
