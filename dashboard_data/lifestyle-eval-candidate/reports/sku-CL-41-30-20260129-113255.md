...
**Generated:** 2026-01-29T11:32:55.522291
**Status:** APPROVED
...
**Title (95 chars):**
```
Towel Bar, 30-Inch Center-To-Center, Solid Brass, Wall Mount, Carolina Collection, Allied Brass
```
...
Highlights:
- Keep towels organized and accessible with a straight bar design sized for a full bath towel
- Maintain a clean, finished look with concealed screw mounting hardware
- Save space in the bathroom with a wall mount installation
- Coordinate classic bath accessories with the Carolina Collection for a matching Carolina look
- Choose the look you want with multiple designer finish options available

Specs & Installation:
- Product type: towel bar
- Collection/style: Carolina Collection; traditional bathroom hardware
...
**Token Usage:** Prompt tokens: 5979, Completion tokens: 1359
**Estimated Cost:** $0.029489
...
- Product type is a towel bar in the Carolina Collection. (source: current_title=Carolina Collection Towel Bar)
...
- Center-to-center measurement is 30 inches and bar diameter is 0.75 inches. (source: center_to_center=30 in)
...
- Available in multiple designer finishes and covered by a Limited Lifetime Warranty. (source: bullet_6=Limited Lifetime Warranty)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 89.00% | 90.00% | 90.00% | 83.33% |  |
| 2 | 0 | 88.50% | 90.00% | 86.67% | 83.33% |  |
| 3 | 2 | 91.33% | 93.33% | 90.00% | 83.33% | bing_title must end with Allied Brass |
