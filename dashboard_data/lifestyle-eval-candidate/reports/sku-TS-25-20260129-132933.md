...
**Generated:** 2026-01-29T13:29:33.897368
**Status:** APPROVED
...
**Title (115 chars):**
```
Toilet Paper Stand, 26-Inch Freestanding Solid Brass Tissue Holder, Freestanding Toilet Paper Holders, Allied Brass
```

**Description (1000 chars):**
```
Need a toilet paper roll within easy reach but don’t have wall space for a holder? This freestanding toilet paper stand adds convenient roll storage with a stable footprint and a clean, transitional look.

Highlights:
- Place it anywhere in the bathroom—freestanding design requires no wall mounting
- Stay steady on the floor—heavy solid brass base is designed to help prevent tipping
- Protect your floors—felt pad helps prevent scratching on tile, wood, and other surfaces
- Built for everyday use—solid brass construction resists rust and corrosion for lasting performance
- Coordinate the look—part of the freestanding toilet paper holders collection with multiple designer finish options

Specs & Installation:
- Product type: Freestanding toilet tissue stand (toilet paper stand)
- Material: Solid brass
- Overall size: 5.5 in L x 26 in H x 6 in W
- Mounting: Freestanding (no wall mount)
...
**Token Usage:** Prompt tokens: 5917, Completion tokens: 1408
**Estimated Cost:** $0.030067
...
- Product is a freestanding toilet tissue stand/toilet paper stand. (source: current_title=Freestanding Toilet Tissue Holder)
- Overall dimensions are 5.5 in L x 26 in H x 6 in W. (source: current_description=Product dimensions, in. (LxHxW): 5.5x26x6)
- Made of solid brass material. (source: current_description=Made of Solid Brass Materials that can never rust)
...
- Heavy base is designed to help prevent tipping. (source: bullet_4=Heavy solid brass base will help prevent tipping)
- Available in multiple designer finishes. (source: bullet_3=Available in a wide variety of lifetime designer finishes)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 81.83% | 83.33% | 73.33% | 83.33% |  |
| 2 | 2 | 81.00% | 80.00% | 83.33% | 83.33% |  |
| 3 | 1 | 74.83% | 73.33% | 73.33% | 83.33% |  |
