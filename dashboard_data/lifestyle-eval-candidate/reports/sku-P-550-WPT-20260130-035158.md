...
**Generated:** 2026-01-30T03:51:58.841785
**Status:** APPROVED
...
```
Wall mounted paper towel holder, 15.5 in L x 3 in H x 4 in W, powder coated iron construction for kitchen paper towel storage and easy tear-off access. Industrial pipe-style accessories look inspired by pipe fittings; wall mount installation saves counter space and keeps a roll within reach at prep and cleanup zones. Includes color coordinated mounting hardware (screw size #8 x 1 1/4) and installs without assembly required. Designed for corrosion-free and rust-free performance with a highly durable powder coat finish. Weight capacity 250 lb. Includes paper towel holder and all installation hardware. Pipeline collection, Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6469, Completion tokens: 1380, Cached tokens: 5632 (87% cache hit)
**Estimated Cost:** $0.025713
...
- Includes paper towel holder and all installation hardware. (source: included_items=Paper towel holder and all installation hardware.)
- Mounting screw size is #8 X1 1/4". (source: screw_size=#8 X1 1/4")
- Weight capacity is 250 lb. (source: weight_capacity=250 lb)
- Has a limited lifetime warranty. (source: bullet_5=Limited Lifetime Warranty)
- Protected using a highly durable powder coat. (source: bullet_2=Protected using highly durable powder coat)
- Pipeline collection name applies to this product. (source: collection=Pipeline)
- Design style is industrial. (source: style=Industrial)
