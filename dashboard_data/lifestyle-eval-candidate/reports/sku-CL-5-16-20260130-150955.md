...
**Generated:** 2026-01-30T15:09:55.631989
**Status:** APPROVED
...
**Title (97 chars):**
```
Triple Glass Shelf, 16 X 5 In, Wall Mount Solid Brass Hardware, Carolina Collection, Allied Brass
```

**Description (653 chars):**
```
Triple glass shelf with 16 x 5 inch glass dimensions, wall mount installation, and solid brass hardware for bathroom storage and display. Three-tier wall-mounted glass shelf keeps toiletries organized while saving space. Traditional style with thick 0.38 in beveled-edge glass and concealed screw mounting for a clean look. Includes glass shelf and all installation hardware; uses #8 x 1 1/4 in screws. Weight capacity 6 lb. Ideal for classic bath accessories, heritage bathroom fixtures, and traditional bathroom hardware. Match with coordinating pieces from the Carolina collection for a unified look. Limited Lifetime Warranty. Allied Brass Carolina.
```
...
**Token Usage:** Prompt tokens: 6427, Completion tokens: 1359, Cached tokens: 4480 (69% cache hit)
...
- Uses #8 x 1 1/4 in screws. (source: screw_size=#8 X1 1/4")
- Traditional style. (source: style=Traditional)
- Brass material / brass hardware. (source: material=Brass)
...
| 2 | 2 | 85.83% | 83.33% | 93.33% | 90.00% |  |
| 3 | 0 | 84.33% | 83.33% | 86.67% | 86.67% |  |
