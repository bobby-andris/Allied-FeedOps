...
**Generated:** 2026-01-29T01:44:13.919635
**Status:** APPROVED
...
**Description (848 chars):**
```
Stop piling coats and towels on chairs—create a dedicated spot for everyday items with a freestanding coat rack that requires no wall mounting.

Highlights:
- Keep essentials organized: eight pivoting pegs separate coats, hats, and accessories for quick grab-and-go use
- Place it anywhere: freestanding design needs no wall mounting, ideal for bathrooms, dressing areas, or guest spaces
- Stay stable on the floor: weighted base is designed to prevent tipping during daily use
- Protect finished floors: felt pad helps prevent scratching on tile, wood, or other surfaces
- Coordinate your look: available in a wide variety of lifetime designer finishes within the Assorted Free Standing Accessories collection

Specs & Installation:
- Product dimensions: 10 in. L x 60 in. H x 10 in. W
...
- Felt pad designed to prevent scratching on any surface. (source: current_description=Felt pad will prevent scratching on any surface)
- Available in a wide variety of lifetime designer finishes. (source: current_description=Available in a wide variety of lifetime designer finishes)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 69.00% | 70.00% | 63.33% | 70.00% |  |
| 2 | 0 | 63.00% | 60.00% | 70.00% | 70.00% |  |
