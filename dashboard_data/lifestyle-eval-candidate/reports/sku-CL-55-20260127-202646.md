...
**Generated:** 2026-01-27T20:26:46.872792
**Status:** APPROVED
...
```
Keep paper towels within easy reach and stop the roll from sliding around your counter. This freestanding paper towel holder from the Carolina collection stores one roll upright for a space-saving footprint and stable, one-hand tearing.

Highlights:
- Tear off sheets cleanly without tipping over thanks to a weighted base
- Protect countertops during everyday use with a felt pad on the base
- Coordinate your kitchen look with the Carolina collection and matching Carolina pieces
- Enjoy enduring construction crafted from solid brass
- Choose a look that fits your space with multiple designer finish options

Specs & Installation:
- Product type: Countertop paper towel holder stand
- Mounting: Freestanding (no wall mounting); no assembly required
- Overall size: 6.5-Inch L x 6.5-Inch W x 14.4-Inch H; projection 6.5-Inch
- Weight capacity: 5 lb; product weight: 4 lb
- Material: Brass
...
- Claim rejected: 'Overall dimensions are 6.5 in L x 6.5 in W x 14.4 in H.' - Field 'product_dimensions' not found in source data
...
- Solid brass construction is stated in product bullets. (source: bullet_1=Crafted from the finest solid brass materials)
- Space-saving upright countertop design. (source: current_description=The roll in the stand sits upright on the counter top allowing for space saving.)
- Weighted base provides stability. (source: current_description=It has a weight in the base to keep the unit stable as you tear off the sheets.)
- Felt pad prevents scratching. (source: bullet_4=Felt pad will prevent scratching on any surface)
...
- 14.4-Inch (source: product_height=14.4 in)
