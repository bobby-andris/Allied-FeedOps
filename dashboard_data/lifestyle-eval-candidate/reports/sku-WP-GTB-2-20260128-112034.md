...
**Generated:** 2026-01-28T11:20:34.180359
**Status:** REJECTED
...
**Title (85 chars):**
```
Swing Arm Towel Rail 12.5-Inch Solid Brass | Assorted Wall Accessories | Allied Brass
```

**Description (935 chars):**
```
Keep towels within reach without crowding your bathroom—two pivoting arms swing out when you need them and fold close to the wall when you don’t.

Highlights:
- Save space in smaller bathrooms with a double swing-arm design that nests near the wall
- Hang and separate towels easily with two arms that swivel independently
- Maintain a clean, finished look with concealed screw mounting hardware
- Coordinate your room with the Assorted Wall Accessories collection and its distinctive, transitional bathroom hardware styling
- Choose a look that fits your décor with multiple designer finish options available

Specs & Installation:
- Product type: 2 swing arm towel rail
- Material: solid brass construction
- Overall dimensions (L x H x W): 12.5 x 7.1 x 7 inches
- Mounting: wall-mounted with concealed screw hardware
- Collection: Assorted Wall Accessories
- Finish options: available in 28 finish options including statement colors
```
...
- Claim rejected: 'Arms pivot for flexibility and nest close to the wall when not in use.' - Claimed 'Each arm swivels independently and snuggles close to the wall when not in use... Arms pivot for optimum flexibility and convenience' but actual value is 'Designed with multi-use and modernity in mind, this space saving double arm towel bar is an ideal addition for your bathroom and/or kitchen. Each arm swivels independently and snuggles close to the wall when not in use - excellent to keep your bathroom and/or kitchen organized! Created with the finest solid brass materials Concealed screw mounting hardware installs easily Arms pivot for optimum flexibility and convenience Space saving for bathrooms with limited room Available in 15 designer finishes Specification & Documentation Product dimensions, in. (LxHxW): 12.5x7.1x7 Box dimensions, in. (LxHxW): 18x12x12 Shipping weight, lbs: 7'
...
- 2 swing arm towel rail with two arms that swivel independently. (source: current_title=Waverly Place Collection 2 Swing Arm Towel Rail)
...
- Available in 28 finish options including statement colors. (source: key_differentiators=Part of coordinated Assorted Wall Accessories collection; 28 finish options including statement colors)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 61.00% | 60.00% | 63.33% | 63.33% |  |
| 2 | 1 | 71.83% | 73.33% | 70.00% | 66.67% | google_description missing 2 description term(s); found 1 |
| 3 | 2 | 62.33% | 63.33% | 60.00% | 60.00% | bing_title must end with Allied Brass; google_description missing 2 description term(s); found 1 |
