...
**Generated:** 2026-01-25T19:18:25.052091
**Status:** APPROVED
...
**Title (100 chars):**
```
Freestanding paper towel holder 18-Inch Solid Brass Weighted Base | Traditional Style | Allied Brass
```

**Description (823 chars):**
```
Add a refined, freestanding paper towel holder to keep countertops organized—crafted from solid brass with an 18-Inch height and a weighted base for stability. Designed in a traditional style that pairs well with traditional bathroom hardware and classic bath accessories while fitting beautifully into kitchen décor.
...
- Material: Brass
- Style: Traditional
- Overall size: 5.5-Inch L x 5.5-Inch W x 18-Inch H
...
- Material is solid brass. (source: material=Brass)
- Freestanding design requires no wall mounting. (source: mounting_type=Freestanding)
- Overall height is 18 inches. (source: product_height=18 in)
- Base helps prevent tipping due to a weighted design. (source: bullet_2=Solid Brass weighted base prevents tipping)
...
- Dimensions are 5.5 inches long by 5.5 inches wide. (source: product_length=5.5 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 85.17% | 86.67% | 80.00% | 83.33% |  |
| 2 | 0 | 83.33% | 83.33% | 83.33% | 83.33% |  |
| 3 | 2 | 85.67% | 86.67% | 83.33% | 83.33% | google_description missing 2 description term(s); found 1; shopify_description missing 2 description term(s); found 1 |
