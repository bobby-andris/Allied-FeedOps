...
**Generated:** 2026-01-30T04:47:32.889636
**Status:** APPROVED
...
**Title (100 chars):**
```
Glass Shelf, 22-Inch Double Tempered Glass With Solid Brass Gallery Rail, Wall Mount -, Allied Brass
```

**Description (614 chars):**
```
Glass shelf with 22 x 5 inch double tempered glass shelves and solid brass gallery rail for bathroom storage and display. Wall-mount design uses concealed screw mounting hardware for a clean, finished look and space-saving installation. Made with 3/8-inch (0.38 in) thick tempered glass for safety and strength; solid brass hardware with traditional/transitional styling. Ideal for organizing toiletries and décor while keeping items secure with the gallery rail. Includes glass shelf and all installation hardware; assembly not required. Weight capacity 4 lb. Part of the Waverly Place collection by Allied Brass.
```
...
**Token Usage:** Prompt tokens: 6529, Completion tokens: 1470, Cached tokens: 6016 (92% cache hit)
**Estimated Cost:** $0.026742
...
- Glass dimensions: 22 x 5 inches (source: bullet_5=Glass Dimensions: 22 x 5 Inches)
...
- 3/8-inch (0.38 in) thick tempered glass (source: thickness=0.38 in)
- Tempered glass for safety and strength (source: bullet_1=Made with 3/8-in thick tempered glass for safety and strength)
- Solid brass hardware/material (source: current_description=Tempered glass is 3/8 Inches thick and all of the hardware is made of solid brass and finished with the highest quality materials to provide a lifetime of beauty.)
...
- Overall dimensions: 22 in length, 5 in depth/projection, 8 in height (source: current_description=Length, in Depth, in Height, in Weight, lbs 16 Inch 16 5 8 10.4 22 Inch 22 5 8 12)
- Collection: Waverly Place (source: collection=Waverly Place)
...
- 8 in (source: product_height=8 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 78.17% | 76.67% | 76.67% | 86.67% |  |
| 2 | 1 | 77.17% | 76.67% | 76.67% | 80.00% |  |
| 3 | 0 | 75.67% | 76.67% | 80.00% | 66.67% | shopify_title must end with Allied Brass |
