...
**Generated:** 2026-01-26T00:30:52.630741
**Status:** APPROVED
...
```
Add space-saving towel storage with this 24-Inch wall mount towel bar crafted from solid brass. Part of the Mambo Collection, it helps create a matching Mambo look with designer bath accessories.

Highlights:
- Wall-mounted installation saves floor space and keeps towels within easy reach
- Solid brass construction helps prevent rusting in bathroom environments
- Concealed screw mounting for a clean, finished appearance
- Coordinates with the Mambo Collection for matching mambo and designer bathroom hardware styling
- Multiple designer finish options available to complement statement bath accessories

Specs:
- Category: Towel Bars
- Bar style/shape: Straight bar
...
- Assembly: No
- Included: Towel bar, mounting plates, and installation hardware (screw size #8 x 1 1/4")
...
- 24-Inch wall mount towel bar (source: center_to_center=24 in)
...
| 2 | 0 | 93.33% | 93.33% | 93.33% | 93.33% | google_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
| 3 | 1 | 91.00% | 90.00% | 90.00% | 96.67% | google_description missing description term in first 150 chars; bing_description missing description term in first 150 chars; shopify_description missing description term in first 150 chars |
