...
**Generated:** 2026-01-29T01:15:02.297566
**Status:** APPROVED
...
**Title (72 chars):**
```
Robe Hook, Solid Brass, 2 X 2.64-Inch, Malibu Collection, | Allied Brass
```

**Description (876 chars):**
```
Keep towels and robes off the floor and within easy reach with a sturdy, space-saving robe hook designed for everyday bathroom use.

Highlights:
- Create instant hanging space by adding a compact wall-mounted hook near the shower, vanity, or closet
- Count on lasting strength with solid brass construction for a sturdy place to hang robes and towels
- Coordinate a cohesive look with the Malibu robe hooks collection for transitional bathroom hardware
- Match your décor with multiple designer finish options for versatile bath accessories
...
- Includes mounting hardware (color-coordinated)
...
- Material: solid brass construction (source: current_description=constructed of the finest solid brass materials)
- Product dimensions (L x H x W): 2 x 2 x 2.64 in. (source: current_description=Product dimensions, in. (LxHxW): 2x2x2.64)
- Box dimensions (L x H x W): 4 x 6 x 10 in. (source: current_description=Box dimensions, in. (LxHxW): 4x6x10)
- Shipping weight: 1 lb (source: current_description=Shipping weight, lbs: 1)
- Includes color coordinated mounting hardware (source: current_description=Color coordinated mounting hardware included)
...
- Multiple designer finish options available (28 finishes listed) (source: available_finishes=Antique Brass, Antique Bronze, Brushed Bronze, Matte Black, Antique Copper, Matte Gray, Oil Rubbed Bronze, Polished Brass, Polished Chrome, Antique Pewter, Polished Nickel, Satin Brass, Satin Chrome, Satin Nickel, Unlacquered Brass, Venetian Bronze, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
