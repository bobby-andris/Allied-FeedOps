...
**Generated:** 2026-01-29T12:28:25.719592
**Status:** APPROVED
...
**Title (119 chars):**
```
Freestanding Coat Rack With Eight Pivoting Pegs, 60-Inch, Solid Brass, Assorted Free Standing Accessories, Allied Brass
```

**Description (1053 chars):**
```
Stop piling towels, robes, and clothing on chairs—create an organized drop zone with a freestanding coat rack that needs no wall mounting. This freestanding coat rack with eight pivoting pegs keeps everyday items separated and easy to grab while adding a distinctive, transitional look.

Highlights:
- Keep items organized and accessible: eight pivoting pegs separate coats, hats, robes, and accessories
- Place it anywhere without drilling: freestanding design works in the bathroom or dressing area
- Stay stable on the floor: weighted base is designed to prevent tipping
- Protect your surfaces: felt pad helps prevent scratching on tile, wood, or other flooring
- Built for enduring use: solid brass construction

Specs & Installation:
- Overall dimensions: 10 in L x 60 in H x 10 in W
...
**Token Usage:** Prompt tokens: 6036, Completion tokens: 1445
**Estimated Cost:** $0.030793
...
- Weighted base designed to prevent tipping (source: bullet_3=Weighted base will keep this item stable to prevent tipping)
- Felt pad helps prevent scratching (source: bullet_4=Felt pad will prevent scratching on any surface)
- Overall dimensions are 10 in L x 60 in H x 10 in W (source: current_description=Product dimensions, in. (LxHxW): 10x60x10)
...
- Part of the Assorted Free Standing Accessories collection (source: key_differentiators=Part of coordinated Assorted Free Standing Accessories collection; 28 finish options including statement colors)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 72.83% | 73.33% | 70.00% | 73.33% |  |
| 2 | 0 | 70.00% | 70.00% | 70.00% | 70.00% |  |
| 3 | 1 | 62.83% | 63.33% | 60.00% | 63.33% |  |
