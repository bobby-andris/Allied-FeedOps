...
**Generated:** 2026-01-29T01:24:59.770607
**Status:** APPROVED
...
**Title (127 chars):**
```
Toilet Paper Holder With Glass Shelf, Covered, Solid Brass, Wall Mount, Waverly Place, Glass Shelves Collection, | Allied Brass
```

**Description (972 chars):**
```
Keep toilet tissue within easy reach while adding a convenient spot for small bathroom essentials. This covered toilet paper holder includes a glass shelf above the roll and a clean wall-mount design for efficient use of space.

Highlights:
- Store essentials right where you need them—integrated glass shelf sits above the tissue holder
- Keep the roll protected—covered design shields tissue from moisture and dust
- Create a clean, finished look—concealed screw mounting hardware
- Build a coordinated bathroom—designed as part of the Glass Shelves collection with a distinctive transitional style
- Match your hardware—available in multiple designer finish options

Specs & Installation:
- Product dimensions (L x H x W): 8.75 x 4.6 x 6 inches
- Wall-mounted installation; concealed screw mounting hardware
- Material: solid brass hardware with glass shelf
- Box dimensions (L x H x W): 18 x 12 x 6 inches
...
- Covered toilet paper holder with glass shelf above the roll (source: current_title=Waverly Place Collection Two Post Toilet Tissue Holder with Glass Shelf)
...
- Available in multiple designer finish options (28 finishes listed) (source: available_finishes=Antique Brass, Antique Bronze, Brushed Bronze, Matte Black, Antique Copper, Matte Gray, Oil Rubbed Bronze, Polished Brass, Polished Chrome, Antique Pewter, Polished Nickel, Satin Brass, Satin Chrome, Satin Nickel, Unlacquered Brass, Venetian Bronze, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Golden Yellow, Flat Troll Blue, Sea Foam Green, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
- Product dimensions are 8.75 x 4.6 x 6 inches (L x H x W) (source: current_description=Product dimensions, in. (LxHxW): 8.75x4.6x6)
- Box dimensions are 18 x 12 x 6 inches (L x H x W) (source: current_description=Box dimensions, in. (LxHxW): 18x12x6)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 83.33% | 83.33% | 83.33% | 83.33% |  |
| 2 | 0 | 81.00% | 80.00% | 83.33% | 83.33% |  |
| 3 | 2 | 67.67% | 66.67% | 66.67% | 73.33% |  |
