...
**Generated:** 2026-01-30T04:50:40.300516
**Status:** APPROVED
...
**Title (86 chars):**
```
Cabinet Pull, 3 Inch, Solid Brass Cabinet-Mount Traditional Style Handle, Allied Brass
```

**Description (569 chars):**
```
Cabinet pull, 3 inch size, solid brass cabinet-mount hardware for updating kitchen or bathroom cabinets and drawers. Traditional style with a contemporary-meets-traditional profile; sized at 3.9 in L x 1.6 in H x 0.9 in W with 1 in projection. Includes cabinet pull and all installation hardware; no assembly required. Supports up to 2 lb. Finish options include multiple designer finishes for coordinating with traditional bathroom hardware, classic bath accessories, and heritage bathroom fixtures. Limited lifetime warranty. Allied Brass decorative cabinet hardware.
```
...
**Token Usage:** Prompt tokens: 6308, Completion tokens: 1484
**Estimated Cost:** $0.031815
...
- Product is a cabinet pull. (source: current_title=3 Inch Cabinet Pull)
...
- Dimensions are 3.9 in (L) x 1.6 in (H) x 0.9 in (W). (source: current_description=Product dimensions, in. (LxHxW): 3.9x1.6x3)
- Product length is 3.9 in. (source: product_length=3.9 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 72.00% | 70.00% | 73.33% | 80.00% |  |
| 2 | 1 | 74.33% | 73.33% | 73.33% | 80.00% | shopify_description missing 2 description term(s); found 1 |
| 3 | 0 | 73.33% | 73.33% | 73.33% | 73.33% | shopify_title must end with Allied Brass |
