...
**Generated:** 2026-01-30T03:56:22.825306
**Status:** APPROVED
...
```
Robe hook with 2 in L x 2 in H x 2.64 in projection for bathroom robe and towel hanging. Wall mount design in brass (solid brass construction) with contemporary style for modern bath accessories and designer bathroom hardware. Includes color coordinated mounting hardware; uses screw size 6. Supports up to 2 lb. Finish-neutral MasterSKU with multiple designer finish options available (28 finishes listed) for matching Malibu decor and statement bath accessories. Part of the Malibu collection with coordinated pieces for a unified look. Limited lifetime warranty. Allied Brass Malibu.
```
...
**Token Usage:** Prompt tokens: 6410, Completion tokens: 1343, Cached tokens: 2560 (39% cache hit)
**Estimated Cost:** $0.027779
...
- Product dimensions are 2 in L x 2 in H x 2.64 in W. (source: current_description=Product dimensions, in. (LxHxW): 2x2x2.64)
- Projection is 2.64 in. (source: projection=2.64 in)
- Weight capacity is 2 lb. (source: weight_capacity=2 lb)
- Color coordinated mounting hardware is included. (source: bullet_3=Color coordinated mounting hardware included)
...
- Contemporary style/design. (source: style=Contemporary)
...
- Screw size is 6. (source: screw_size=6)
