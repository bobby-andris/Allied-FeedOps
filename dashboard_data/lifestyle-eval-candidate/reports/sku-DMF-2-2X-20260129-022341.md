...
**Generated:** 2026-01-29T02:23:41.494683
**Status:** REJECTED
...
**Title (101 chars):**
```
Freestanding Makeup Mirror, 8-Inch Double-Sided 2X/1X, Solid Brass, Traditional Style, | Allied Brass
```

**Description (1126 chars):**
```
Get a clear, close-up view for makeup and shaving without wall mounting. This freestanding, floor standing make-up mirror features an 8-inch diameter, double-faced mirror with 2X magnification on one side and 1X on the other for quick, full-face checks.

Highlights:
- See details clearly: double-sided mirror with 2X magnification on one side and 1X on the opposite side
- Place it anywhere in the bathroom: freestanding floor design with adjustable height
- Stay steady during daily routines: heavy solid brass base designed to help prevent tipping
- Protect countertops and floors: felt pad on the base helps prevent scratching
- Coordinate with classic bath accessories: traditional styling for heritage bathroom fixtures and traditional bathroom hardware looks

Specs & Installation:
- Mirror size: 8-Inch diameter
- Material: solid brass construction
- Mounting type: freestanding (no wall mounting)
- Product dimensions: 10.5 in L x 10.5 in W
- Product weight: 13.6 lb
- Assembly required: yes
- Included: make-up mirror
- Finish options: available in a wide variety of lifetime designer finishes (including 25 options)
```
...
- Available in a wide variety of lifetime designer finishes (25 options). (source: available_finishes=Antique Brass, Antique Bronze, Brushed Bronze, Matte Black, Antique Copper, Matte Gray, Oil Rubbed Bronze, Polished Brass, Polished Chrome, Antique Pewter, Polished Nickel, Satin Brass, Satin Chrome, Satin Nickel, Unlacquered Brass, Venetian Bronze, Matte White, Spanish Gold, Autumn Sparkle, Glokzin Teal, Shaded Beige, Fire Engine Red, Lavender, Mediterranean Blue, Pink)
- Product dimensions are 10.5 in long by 10.5 in wide and weight is 13.6 lb. (source: product_weight=13.6 lb)
...
| 2 | 1 | 73.33% | 73.33% | 73.33% | 73.33% |  |
| 3 | 2 | 75.67% | 76.67% | 73.33% | 73.33% | shopify_title must end with Allied Brass |
