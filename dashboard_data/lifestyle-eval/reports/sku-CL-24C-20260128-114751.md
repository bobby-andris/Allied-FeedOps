...
**Generated:** 2026-01-28T11:47:51.056582
**Status:** REJECTED
...
**Description (783 chars):**
```
Free up elbow room around the toilet with a recessed toilet paper holder that sits neatly in the wall for a built-in look.

Highlights:
- Save space in tight layouts with an in-wall recessed design that keeps the roll close and streamlined
- Keep a clean, finished appearance with concealed screw mounting hardware
- Coordinate your bathroom with the traditional, classic styling of the Carolina Collection
- Match your bath décor easily with multiple designer finish options available

Specs & Installation:
- Product dimensions (L x H x W): 6.125 x 6.125 x 4 inches
- Box dimensions (L x H x W): 10 x 6 x 4 inches
- Shipping weight: 2.4 lbs
- Mounting: recessed, in-wall installation; concealed screw mounting
...
- Claim rejected: 'Recessed in-wall design saves space and creates a streamlined, built-in appearance.' - Claimed 'The recessed in wall design of this toilet paper holder makes efficient use of your space...' but actual value is 'The recessed in wall design of this toilet paper holder makes efficient use of your space while our exclusive design adds a finishing touch. The simple and elegant design of this toilet tissue holder will coordinate with any bathroom project. This finely crafted accessory is easy to install with coordinating hardware that matches the designer finish of the product. In-wall design saves space and looks great Traditional design with classic design elements Concealed screw mounting hardware installs easily Designer Finish will provide corrosion free performance All mounting hardware included Products are provided with a limited lifetime warranty Specification & Documentation Product dimensions, in. (LxHxW): 6.125x6.125x4 Box dimensions, in. (LxHxW): 10x6x4 Shipping weight, lbs: 2.4'
- Claim rejected: 'Concealed screw mounting hardware is included and installs easily.' - Claimed 'Concealed screw mounting hardware installs easily... All mounting hardware included' but actual value is 'The recessed in wall design of this toilet paper holder makes efficient use of your space while our exclusive design adds a finishing touch. The simple and elegant design of this toilet tissue holder will coordinate with any bathroom project. This finely crafted accessory is easy to install with coordinating hardware that matches the designer finish of the product. In-wall design saves space and looks great Traditional design with classic design elements Concealed screw mounting hardware installs easily Designer Finish will provide corrosion free performance All mounting hardware included Products are provided with a limited lifetime warranty Specification & Documentation Product dimensions, in. (LxHxW): 6.125x6.125x4 Box dimensions, in. (LxHxW): 10x6x4 Shipping weight, lbs: 2.4'
- Claim rejected: 'Brass' - Field 'material' not found in source data

### Verified Claims

- Product is a recessed (in-wall) toilet paper holder in the Carolina Collection. (source: current_title=Carolina Collection Recessed Toilet Paper Holder)
...
- Multiple designer finish options are available (28 finish options). (source: key_differentiators=Part of coordinated Carolina collection; 28 finish options including statement colors)
...
| 2 | 1 | 75.67% | 76.67% | 76.67% | 70.00% |  |
| 3 | 2 | 75.67% | 76.67% | 73.33% | 73.33% | bing_title must end with Allied Brass |
