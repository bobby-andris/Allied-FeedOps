...
**Generated:** 2026-01-28T11:26:43.476265
**Status:** REJECTED
...
**Title (96 chars):**
```
Swing Arm Towel Rail 12.5-Inch Solid Brass Double Arm | Assorted Wall Accessories | Allied Brass
```

**Description (1006 chars):**
```
Keep towels within reach without giving up wall space. This double swing arm towel rail stores close to the wall when not in use and pivots out when you need it.

Highlights:
- Save space in smaller bathrooms: two arms swivel independently and fold in neatly
- Keep towels organized for daily routines: double-arm design separates hand towels and washcloths
- Enjoy flexible placement: pivoting arms position towels where you want them
- Maintain a clean look on the wall: concealed mounting hardware
- Coordinate with your décor: multiple designer finish options available

Specs & Installation:
- Product type: 2 swing arm towel rail (double arm towel bar)
- Material: solid brass
- Mounting: wall-mounted with concealed screw mounting hardware
- Overall dimensions (L x H x W): 12.5 x 7.1 x 7 inches
- Box dimensions (L x H x W): 18 x 12 x 12 inches
- Shipping weight: 7 lbs
- Collection/design context: Assorted Wall Accessories collection; transitional bathroom hardware for versatile bath accessories
```
...
**Image URL:** https://cdn.shopify.com/s/files/1/0287/8658/9828/products/WPGTB2-ABR.jpg?v=1640772129
...
| category | Towel Rail | category |
| collection | Assorted Wall Accessories | collection |
...
| gtin | 013895955423 | gtin |
| upc | 013895955423 | upc |
| main_image_url | https://cdn.shopify.com/s/files/1/0287/8658/9828/products/WPGTB2-ABR.jpg?v=1640772129 | main_image_url |
| collection_context | Assorted Wall Accessories (Unknown) - distinctive design | enrichment_collection |
...
| key_differentiators | Part of coordinated Assorted Wall Accessories collection; 28 finish options including statement colors | enrichment_competitive |
| design_intent_keywords | assorted wall accessories collection, transitional bathroom hardware, versatile bath accessories | enrichment_keywords |
...
- assorted wall accessories collection
...
- Claim rejected: 'Double swing arm towel rail with arms that swivel independently and fold close to the wall when not in use.' - Claimed 'Designed with multi-use and modernity in mind, this space saving double arm towel bar... Each arm swivels independently and snuggles close to the wall when not in use' but actual value is 'Designed with multi-use and modernity in mind, this space saving double arm towel bar is an ideal addition for your bathroom and/or kitchen. Each arm swivels independently and snuggles close to the wall when not in use - excellent to keep your bathroom and/or kitchen organized! Created with the finest solid brass materials Concealed screw mounting hardware installs easily Arms pivot for optimum flexibility and convenience Space saving for bathrooms with limited room Available in 15 designer finishes Specification & Documentation Product dimensions, in. (LxHxW): 12.5x7.1x7 Box dimensions, in. (LxHxW): 18x12x12 Shipping weight, lbs: 7'
...
- Made from solid brass materials. (source: current_description=Created with the finest solid brass materials)
- Concealed screw mounting hardware. (source: current_description=Concealed screw mounting hardware installs easily)
- Product dimensions are 12.5 x 7.1 x 7 inches (L x H x W). (source: current_description=Product dimensions, in. (LxHxW): 12.5x7.1x7)
...
- Part of the Assorted Wall Accessories collection. (source: collection=Assorted Wall Accessories)
...
| 2 | 1 | 62.83% | 63.33% | 60.00% | 63.33% | bing_title must end with Allied Brass; google_description missing 2 description term(s); found 1 |
| 3 | 2 | 61.00% | 60.00% | 63.33% | 63.33% | google_description missing 2 description term(s); found 1 |
