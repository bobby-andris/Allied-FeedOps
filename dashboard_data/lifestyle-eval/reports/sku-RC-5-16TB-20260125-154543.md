...
**Generated:** 2026-01-25T15:45:43.324672
**Status:** APPROVED
...
```
Add organized storage with a wall mount glass shelf featuring three tiers and an integrated towel bar—crafted with solid brass hardware and 3/8-inch tempered glass. Designed for traditional bathroom hardware looks, this shelf keeps daily essentials and display items neatly within reach while saving floor space.

Highlights:
- Triple-tier glass shelf design adds vertical storage and organization
- Integrated towel bar provides a convenient spot for hand towels
- 3/8-inch thick tempered, beveled-edge glass for safety and strength
- Solid brass hardware with concealed screw mounting for a clean finish
- Coordinates with classic bath accessories and heritage bathroom fixtures

Specs:
- Glass dimensions: 16 x 5 Inches
- Overall dimensions: 16-Inch L x 5-Inch W x 18-Inch H
- Weight capacity: 6 lb
- Mounting: Wall mount; concealed hardware included (#8 x 1 1/4" screws)
...
| statement_finishes | antique pewter, autumn sparkle, unlacquered brass, golden yellow, glokzin teal | enrichment_finishes |
...
| design_intent_keywords | traditional bathroom hardware, classic bath accessories, heritage bathroom fixtures, wall mount, antique pewter bathroom hardware, autumn sparkle bathroom hardware, unlacquered brass bathroom hardware, golden yellow bathroom hardware, glokzin teal bathroom hardware, venetian bronze bathroom hardware | enrichment_keywords |
...
- 3/8-inch thick tempered glass with beveled edge (source: current_description=Featuring tempered, beveled-edged glass and solid brass hardware this shelf is crafted for durability, strength and style.)
...
| 2 | 2 | 90.50% | 90.00% | 90.00% | 93.33% |  |
| 3 | 0 | 92.83% | 93.33% | 90.00% | 93.33% | shopify_description missing description term in first 150 chars; shopify_description missing 2 description term(s); found 1 |
