...
**Generated:** 2026-01-28T02:27:58.026437
**Status:** REJECTED
...
**Title (82 chars):**
```
Paper Towel Holder Wall Mount 15.5-Inch | Brass Paper Towel Holders | Allied Brass
```

**Description (990 chars):**
```
Free up countertop space and keep paper towels within easy reach at the prep sink or cooking zone. This wall mount paper towel holder adds an industrial pipe-fitting look that works with transitional kitchens and coordinating versatile accessories.

Highlights:
- Keep towels ready where you use them most—wall-mounted installation saves valuable counter space
- Add an industrial accent—Pipeline-inspired pipe fitting design blends with modern and traditional decor
- Enjoy a clean, decorative look—protected with a highly durable powder coat finish
- Count on lasting performance—materials resist corrosion and rust for continual service
- Install with a matched look—includes color coordinated mounting hardware

Specs & Installation:
- Mounting: Wall mount
- Dimensions (L x H x W): 15.5 x 3 x 4 in.
- Shipping weight: 1.3 lbs
- Hardware: Color coordinating screws included
- Warranty: Limited lifetime warranty
- Finish options: Multiple designer finish options available (19 finishes)
```
...
- Claim rejected: 'Includes color coordinated mounting hardware and screws.' - Claimed 'Paper Towel holder mounts firmly with color coordinating screws... Color coordinated mounting hardware included' but actual value is 'The Pipeline collection is the latest innovation for accessories from the Allied Brass Brand of products. This wall mounted paper towel holder gives the industrial look of pipe fittings while blending aptly with both modern and traditional decor. This accessory is powder coated with lifetime materials to provide a decorative and clean finish. No wonder, this wall mounted paper towel holder gives continual service for years without any trouble. The choice of superior materials makes this item free from corrosion and rust. Paper Towel holder mounts firmly with color coordinating screws and comes with a limited lifetime warranty. Contemporary design with rustic influences Protected using highly durable powder coat Powder coated pipe gives clean finish to this accessory Designer finish will provide Corrosion-free and rust-free performance Provided with a limited lifetime warranty Color coordinated mounting hardware included Specification & Documentation Product dimensions, in. (LxHxW): 15.5x3x4 Box dimensions, in. (LxHxW): 18x6x6 Shipping weight, lbs: 1.3 Installation Instruction Technical Specification P550WPT-Installation.PDF P550WPT-Specification.PDF'
...
- Wall mounted paper towel holder with an industrial pipe-fitting look that blends with modern and traditional decor. (source: current_description=This wall mounted paper towel holder gives the industrial look of pipe fittings while blending aptly with both modern and traditional decor.)
- Protected with a highly durable powder coat finish. (source: current_description=Protected using highly durable powder coat)
- Resists corrosion and rust. (source: current_description=The choice of superior materials makes this item free from corrosion and rust.)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 75.33% | 73.33% | 83.33% | 76.67% |  |
| 2 | 0 | 76.33% | 73.33% | 83.33% | 83.33% | bing_title must end with Allied Brass |
| 3 | 1 | 73.50% | 70.00% | 83.33% | 80.00% | bing_title must end with Allied Brass |
