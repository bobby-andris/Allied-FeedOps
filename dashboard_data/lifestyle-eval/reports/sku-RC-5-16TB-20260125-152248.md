...
**Generated:** 2026-01-25T15:22:48.506502
**Status:** APPROVED
...
**Title (90 chars):**
```
Wall Mount Glass Shelf 16-Inch with Integrated Towel Bar Solid Brass Hardware Allied Brass
```

**Description (1077 chars):**
```
Upgrade everyday storage with a wall mount glass shelf designed for refined, traditional bathroom hardware. This 16-Inch shelf combines 3/8-Inch thick tempered, beveled-edge glass with solid brass hardware and a convenient integrated towel bar.

Highlights:
- Adds wall-mounted storage while helping keep counters clearer
- Integrated towel bar keeps hand towels within easy reach
- 3/8-Inch thick tempered glass with beveled edges for strength and a polished look
- Crafted from solid brass materials for enduring bathroom use
- Concealed screw mounting hardware for a clean, classic finish
...
Design notes:
A timeless choice for classic bath accessories and heritage bathroom fixtures. Available in 28 designer finishes, including statement colors such as Mediterranean Blue, Golden Yellow, Pink, Glokzin Teal, and Venetian Bronze.
```
...
| statement_finishes | mediterranean blue, golden yellow, pink, glokzin teal, venetian bronze | enrichment_finishes |
...
| design_intent_keywords | traditional bathroom hardware, classic bath accessories, heritage bathroom fixtures, wall mount, mediterranean blue bathroom hardware, golden yellow bathroom hardware, pink bathroom hardware, glokzin teal bathroom hardware, venetian bronze bathroom hardware, fire engine red bathroom hardware | enrichment_keywords |
...
- Claim rejected: 'Available in 28 designer finishes including Mediterranean Blue, Golden Yellow, Pink, Glokzin Teal, and Venetian Bronze' - Field 'finish_variety' not found in source data
...
- Wall mount glass shelf with integrated towel bar (source: current_title=16 Inch Triple Tiered Glass Shelf with Integrated Towel Bar)
...
| 2 | 0 | 95.17% | 96.67% | 93.33% | 90.00% | shopify_title must end with Allied Brass; shopify_description missing description term in first 150 chars |
| 3 | 1 | 91.00% | 90.00% | 90.00% | 96.67% | shopify_description missing 2 description term(s); found 1 |
