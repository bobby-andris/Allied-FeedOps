...
**Generated:** 2026-01-25T15:52:11.292472
**Status:** APPROVED
...
**Title (106 chars):**
```
Retractable hooks and garment rod Wall Mount 2-1/2-Inch Traditional Brass Wall Hook | 15 lb | Allied Brass
```

**Description (1046 chars):**
```
Add space-saving hanging room with a wall mount retractable hook that pulls out to provide 2-1/2 inches of hanging space, then pushes back in when not in use—ideal for traditional bathroom hardware and classic bath accessories.

Highlights:
- Retractable rod extends for 2-1/2 inches of hanging space and retracts flush when not in use
- Holds up to 15 lb for coats, robes, or towels
- Solid brass construction for an enduring, traditional look
- Customizable tip: remove the supplied knob tip and replace it with your own cabinet knob
- Fits standard interior walls; all mounting hardware included
...
- Product weight: 1 lb
- Hardware: 6/32 toggles

Installation:
- Requires drilling a 3/4-inch diameter hole through drywall and 3 small holes around

Finish options:
- Available in 28 designer finishes, including statement colors such as antique pewter, lavender, sea foam green, autumn sparkle, and fire engine red.
```
...
| statement_finishes | antique pewter, lavender, sea foam green, autumn sparkle, fire engine red | enrichment_finishes |
...
| design_intent_keywords | traditional bathroom hardware, classic bath accessories, heritage bathroom fixtures, wall mount, antique pewter bathroom hardware, lavender bathroom hardware, sea foam green bathroom hardware, autumn sparkle bathroom hardware, fire engine red bathroom hardware, unlacquered brass bathroom hardware | enrichment_keywords |
...
- Claim rejected: 'Available in 28 designer finishes including statement colors.' - Field 'finish_variety' not found in source data
...
- All mounting hardware included (6/32 toggles). (source: bullet_6=All mounting hardware included)
- Overall dimensions: 2 in L x 2 in H x 3.75 in W; projection 1 in. (source: product_width=3.75 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 2 | 74.67% | 76.67% | 63.33% | 76.67% |  |
| 2 | 0 | 73.67% | 76.67% | 60.00% | 73.33% |  |
| 3 | 1 | 69.00% | 70.00% | 70.00% | 63.33% |  |
