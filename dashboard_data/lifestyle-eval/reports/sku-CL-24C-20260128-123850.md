...
**Generated:** 2026-01-28T12:38:50.121155
**Status:** APPROVED
...
**Title (72 chars):**
```
Recessed Toilet Paper Holder 6.125-Inch Square | Carolina | Allied Brass
```

**Description (1006 chars):**
```
Free up elbow room around the toilet with a built-in look that keeps the paper right where you need it. This recessed toilet paper holder from the Carolina collection brings traditional bathroom hardware styling to a clean, in-wall installation for a finished, coordinated bath.

Highlights:
- Save space at the toilet area with an in-wall recessed design for a streamlined profile
- Keep the wall looking clean with concealed screw mounting hardware
- Coordinate a cohesive bath with the Carolina collection, designed for classic bath accessories and heritage bathroom fixtures
- Install with confidence: coordinating mounting hardware is included for easier setup

Specs & Installation:
- Product dimensions (L x H x W): 6.125 x 6.125 x 4 in.
- Box dimensions (L x H x W): 10 x 6 x 4 in.
- Shipping weight: 2.4 lbs
- Mounting: recessed/in-wall with concealed screw mounting; all mounting hardware included
...
- All mounting hardware included. (source: current_description=All mounting hardware included)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 76.67% | 76.67% | 76.67% | 76.67% |  |
| 2 | 0 | 75.17% | 76.67% | 76.67% | 66.67% | bing_title must end with Allied Brass; shopify_title must end with Allied Brass |

### Generation Errors

- Candidate 2: 1 validation error for Candidate
shopify_meta_description
  Value error, Shopify meta description must be <= 160 characters (155 recommended for full visibility) [type=value_error, input_value='Recessed toilet paper ho...ited lifetime warranty.', input_type=str]
