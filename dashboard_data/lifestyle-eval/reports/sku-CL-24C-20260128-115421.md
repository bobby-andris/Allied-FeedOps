...
**Generated:** 2026-01-28T11:54:21.407560
**Status:** REJECTED
...
**Title (91 chars):**
```
Recessed Toilet Paper Holder 6.125-Inch Square In-Wall | Carolina Collection | Allied Brass
```

**Description (997 chars):**
```
Free up space around the toilet and keep your bathroom looking built-in and finished with a recessed toilet paper holder.

Highlights:
- Save space in smaller baths: recessed in-wall design sits flush for a streamlined look
- Keep the focus on your décor: concealed screw mounting hardware creates a clean, finished appearance
- Coordinate a classic bath: designed to pair with the Carolina collection for matching Carolina traditional bathroom hardware
- Fits a wide range of bathroom styles: simple, elegant profile complements classic bath accessories and heritage bathroom fixtures
- Install with confidence: includes mounting hardware and is designed for easy installation

Specs & Installation:
- Product dimensions (L x H x W): 6.125 x 6.125 x 4 inches
- Box dimensions (L x H x W): 10 x 6 x 4 inches
- Shipping weight: 2.4 lbs
- Mounting: in-wall recessed; concealed screw mounting hardware
...
- Multiple designer finish options are available (28 options). (source: key_differentiators=Part of coordinated Carolina collection; 28 finish options including statement colors)
...
| 2 | 0 | 72.50% | 70.00% | 80.00% | 76.67% | bing_title must end with Allied Brass |
