...
**Generated:** 2026-01-28T11:32:51.639012
**Status:** APPROVED
...
```
Update cabinets and drawers with a pull that feels solid in hand and keeps your bathroom storage easy to use every day. This 3 inch cabinet pull is part of the coordinated Cabinet Hardware collection, designed for a transitional look that suits both updated and classic spaces.

Highlights:
- Get a secure, comfortable grip for daily use with a solid brass pull
- Refresh vanities and built-ins with a distinctive, versatile design
- Coordinate a cohesive look across your space as part of a cabinet hardware collection
- Install with confidence—mounting hardware is included

Specs & Installation:
- Product type: Cabinet pull
- Material: Solid brass
- Overall dimensions (L x H x W): 3.9 x 1.6 x 3 in.
...
| 2 | 1 | 73.83% | 73.33% | 73.33% | 76.67% |  |
| 3 | 0 | 71.00% | 70.00% | 70.00% | 76.67% |  |
