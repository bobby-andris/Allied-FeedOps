...
**Generated:** 2026-01-28T02:52:36.681118
**Status:** APPROVED
...
**Title (97 chars):**
```
Towel Shelf 23-Inch Three Tier Hotel Style Drying Rack Solid Brass | Towel Shelves | Allied Brass
```

**Description (842 chars):**
```
Keep folded towels and daily bath linens organized in one space-saving wall display. This three tier hotel-style towel shelf adds storage above and a drying rack below for efficient bathroom organization.

Highlights:
- Gain instant vertical storage for clean towels with a three-tier shelf design
- Dry or hang bath linens conveniently with the integrated drying rack
- Count on enduring bathroom performance with solid brass construction
- Coordinate your look with the towel shelves collection and multiple designer finish options
- Fits transitional bathroom hardware style for versatile bath accessories in guest baths and primary baths

Specs & Installation:
- Overall dimensions: 23 in L x 10 in H x 9 in W
- Shipping weight: 7 lbs
- Wall-mounted installation; mounting hardware included
...
- Three tier hotel style towel shelf with drying rack (train rack design). (source: current_title=Three Tier Hotel Style Towel Shelf with Drying Rack)
- Made from brass materials (solid brass construction). (source: current_description=This elegant train rack is created from the finest brass materials.)
- Mounting hardware included for easy installation. (source: current_description=Easy installation with included mounting hardware)
...
- Part of a coordinated Towel Shelves collection. (source: key_differentiators=Part of coordinated Towel Shelves collection; 28 finish options including statement colors)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 78.00% | 80.00% | 76.67% | 70.00% |  |
| 2 | 2 | 75.17% | 76.67% | 76.67% | 66.67% |  |
| 3 | 1 | 72.83% | 73.33% | 73.33% | 70.00% |  |
