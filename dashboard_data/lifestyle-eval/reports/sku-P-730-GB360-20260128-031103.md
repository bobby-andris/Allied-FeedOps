...
**Generated:** 2026-01-28T03:11:03.212862
**Status:** APPROVED
...
**Title (82 chars):**
```
Grab Bar 60-Inch Extended 3-Post ADA Compliant | Pipeline Grab Bars | Allied Brass
```

**Description (911 chars):**
```
Create a safer, more accessible bathroom with an extended-length grab bar that provides steady support where you need it most.

Highlights:
- Gain added stability along a longer span with an extended 60-inch grab bar design
- Feel secure with a 3-post configuration that adds a third center bracket for stability
- Coordinate your space easily with the Pipeline look, designed to complement transitional bathroom hardware
- Choose a finish that suits your bathroom décor with multiple designer finish options available
- Ideal for everyday support in the shower, tub area, or along the bathroom wall for caregivers, seniors, and accessible design

Specs & Installation:
- Product type: Extended 3-post bathroom grab bar
- Collection: Pipeline / grab bars collection
- Length: 60-Inch (overall product dimensions: 63 in. L x 3 in. H x 3.58 in. W)
...
- Product is a Pipeline extended 3 post grab bar in a 60-inch size. (source: current_title=Pipeline Extended 3 Post Grab Bar - 60 inch)
- ADA Compliant grab bar with a third center bracket for stability. (source: current_description=ADA Compliant Bars feature a third center bracket to ensure stability)
- Overall product dimensions are 63 in. L x 3 in. H x 3.58 in. W. (source: current_description=Product dimensions, in. (LxHxW): 63x3x3.58)
- Box dimensions are 64 in. x 6 in. x 8 in. (source: current_description=Box dimensions, in. (LxHxW): 64x6x8)
- Shipping weight is 6 lbs. (source: current_description=Shipping weight, lbs: 6)
- Multiple designer finish options are available, including 19 finish choices. (source: key_differentiators=Part of coordinated Grab Bars collection; 19 finish options including statement colors)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 82.33% | 83.33% | 83.33% | 76.67% |  |
| 2 | 2 | 82.33% | 83.33% | 83.33% | 76.67% | bing_title must end with Allied Brass |
| 3 | 0 | 71.83% | 73.33% | 66.67% | 70.00% | bing_title must end with Allied Brass |
