...
**Generated:** 2026-01-28T11:45:50.595462
**Status:** REJECTED
...
**Description (736 chars):**
```
Keep toilet paper within easy reach when wall space is limited—right on the vanity top or counter.

Highlights:
- Save wall space with a freestanding vanity top toilet tissue holder designed for compact bathrooms
- Add enduring style with solid brass construction
- Keep a coordinated look with the Vanity Top Accessories collection, suited to transitional bathroom hardware
- Match your space with multiple designer finish options, from versatile bath accessories to statement colors
- Buy with confidence thanks to a limited lifetime warranty
...
- Box dimensions are 12 x 10 x 6 in (L x H x W) (source: current_description=Box dimensions, in. (LxHxW): 12x10x6)
- Shipping weight is 5 lbs (source: current_description=Shipping weight, lbs: 5)
- Available in multiple designer finish options (28 finishes including statement colors) (source: key_differentiators=Part of coordinated Vanity Top Accessories collection; 28 finish options including statement colors)
