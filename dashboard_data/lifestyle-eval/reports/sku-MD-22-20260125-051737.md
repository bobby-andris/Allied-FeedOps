...
**Generated:** 2026-01-25T05:17:37.404978
**Status:** APPROVED
...
**Title (110 chars):**
```
Retractable hooks and garment rod Wall Mount 2-Inch Solid Brass Hook | 2-1/2-Inch Hanging Space | Allied Brass
```

**Description (997 chars):**
```
Add space-saving hanging storage with a retractable hooks and garment rod designed for crisp, modern bathroom hardware. This wall mount solid brass hook pulls out to provide 2-1/2 inches of hanging space, then pushes back in to stay out of the way.

Highlights:
- Retractable rod provides 2-1/2" of hanging space when extended
- Wall-mounted installation helps save floor space
- Holds up to 15 lb for towels, robes, coats, and everyday items
...
- Installation: Drill a 3/4" diameter hole through drywall plus three small holes around it; uses 6/32 toggles
- Assembly required: No
- Finish options: available in 28 designer finishes including statement colors such as unlacquered brass, antique pewter, fire engine red, pink, and autumn sparkle
```
...
| statement_finishes | unlacquered brass, antique pewter, fire engine red, pink, autumn sparkle | enrichment_finishes |
...
| design_intent_keywords | modern bathroom hardware, contemporary bath accessories, minimalist bathroom fixtures, wall mount, unlacquered brass bathroom hardware, antique pewter bathroom hardware, fire engine red bathroom hardware, pink bathroom hardware, autumn sparkle bathroom hardware, venetian bronze bathroom hardware | enrichment_keywords |
...
- Claim rejected: 'Available in 28 designer finishes including statement colors like unlacquered brass, antique pewter, fire engine red, pink, and autumn sparkle.' - Field 'finish_variety' not found in source data
...
- Supplied knob tip can be removed and replaced with a cabinet knob of your choice. (source: bullet_1=Gives you the option to remove the knob tip supplied with the item and replace it with a cabinet knob of your own, allowing you to match existing ones in the room!)
- Overall dimensions: 3.75 inches wide x 2 inches high x 2 inches long; 1 inch projection. (source: product_width=3.75 in)
...
| 2 | 2 | 72.83% | 73.33% | 66.67% | 76.67% |  |
| 3 | 0 | 72.33% | 73.33% | 73.33% | 66.67% |  |
