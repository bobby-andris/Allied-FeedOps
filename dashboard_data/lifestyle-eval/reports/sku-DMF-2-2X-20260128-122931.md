...
**Generated:** 2026-01-28T12:29:31.637698
**Status:** REJECTED
...
**Title (91 chars):**
```
Makeup Mirror 8-Inch Freestanding Floor Stand Solid Brass 2X/1X Double-Sided | Allied Brass
```

**Description (1292 chars):**
```
Get a clear, close-up view for makeup or shaving without sacrificing a full-face check. This freestanding, floor-standing make-up mirror features double-sided mirror glass with 2X magnification on one side and 1X on the other for everyday grooming at a comfortable angle—an easy fit for traditional bathroom hardware and classic bath accessories.

Highlights:
- See fine details for precise grooming: 2X magnification on one side for close-up applications
- Check your overall look instantly: 1X mirror on the opposite side for an all-around view
- Place it anywhere in the bathroom: freestanding floor stand design requires no wall mounting
- Feel steady during use: heavy solid brass base is designed to help prevent tipping
- Protect countertops and floors: felt pad helps prevent scratching on surfaces

Specs & Installation:
- Product type: Freestanding floor standing make-up mirror
- Mirror: 8-Inch diameter, double faced mirror glass
- Magnification: 2X on one side, 1X on the other
- Material: Brass construction
- Overall dimensions (L x W): 10.5 in x 10.5 in
- Weight: 13.6 lb
- Included: Make-up mirror
- Assembly: Required
- Finish options: Available in a wide variety of designer finishes, including 25 options and statement colors to coordinate with heritage bathroom fixtures.
```
...
- Claim rejected: 'Freestanding floor standing make-up mirror with double-sided glass and 2X magnification on one side and 1X on the other.' - Claimed 'Elegantly and efficiently designed, this floor standing 2 sided magnification mirror is an easy solution for your daily make-up or shaving routine. The dual-sided mirror features a clear magnification for those close-up applications on one side and a 1x magnification on the opposite side for a quick all around check at any angle.' but actual value is 'Elegantly and efficiently designed, this floor standing 2 sided magnification mirror is an easy solution for your daily make-up or shaving routine.  The dual-sided mirror features a clear magnification for those close-up applications on one side and a 1x magnification on the opposite side for a quick all around check at any angle.  With classic accents, this free-standing vanity mirror is the crowning touch to your bathroom accessories.'
...
- Brass construction. (source: material=Brass)
- Heavy solid brass base designed to help prevent tipping and felt pad helps prevent scratching. (source: bullet_4=Heavy solid brass base will help prevent tipping)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 75.17% | 76.67% | 76.67% | 66.67% |  |
| 2 | 2 | 77.17% | 76.67% | 80.00% | 76.67% | google_description missing 2 description term(s); found 1; bing_description missing 2 description term(s); found 1 |
| 3 | 0 | 74.67% | 76.67% | 76.67% | 63.33% | bing_title must end with Allied Brass; shopify_title must end with Allied Brass |
