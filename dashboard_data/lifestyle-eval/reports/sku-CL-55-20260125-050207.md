...
**Generated:** 2026-01-25T05:02:07.643771
**Status:** APPROVED
...
```
Add classic, space-saving countertop storage with this freestanding paper towel holder in solid brass. The upright stand keeps a roll ready to use while a weighted base helps keep it stable as you tear sheets—no wall mounting required.

Highlights:
- Freestanding countertop paper towel holder for simple placement and everyday convenience
- Crafted from solid brass for an enduring, traditional look
- Space-saving upright design helps keep counters organized
...
- Finish options: Available in 28 designer finishes, including statement colors such as Venetian Bronze, Spanish Gold, Lavender, Pink, and Mediterranean Blue
```
...
| statement_finishes | venetian bronze, spanish gold, lavender, pink, mediterranean blue | enrichment_finishes |
...
| design_intent_keywords | carolina collection, matching carolina, traditional bathroom hardware, classic bath accessories, heritage bathroom fixtures, freestanding, venetian bronze bathroom hardware, spanish gold bathroom hardware, lavender bathroom hardware, pink bathroom hardware | enrichment_keywords |
...
- Overall height is 14.4 inches (source: product_height=14.4 in)
- Base footprint is 6.5 inches by 6.5 inches (source: product_length=6.5 in)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 1 | 84.67% | 86.67% | 83.33% | 76.67% |  |
| 2 | 0 | 84.17% | 86.67% | 80.00% | 76.67% |  |
| 3 | 2 | 84.17% | 86.67% | 80.00% | 76.67% |  |
