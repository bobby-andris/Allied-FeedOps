...
**Generated:** 2026-01-28T11:51:50.593023
**Status:** APPROVED
...
**Description (761 chars):**
```
Keep toilet paper within easy reach when wall space is limited—this vanity top toilet tissue holder adds convenient, countertop-ready storage with a distinctive look.

Highlights:
- Save space on tight bathroom layouts with a freestanding vanity-top design
- Count on long-term durability with solid brass construction
- Keep a coordinated look across the bath as part of the vanity top accessories collection
- Match your decor with multiple designer finish options for transitional bathroom hardware
- Enjoy confidence in your purchase with a limited lifetime warranty

Specs & Installation:
- Product dimensions (L x H x W): 5.5 x 6 x 5 inches
- Assembled in the USA
- Warranty: Limited lifetime
- Finish: Available in a variety of lifetime designer finishes
```
...
- Product type: vanity top toilet tissue holder (source: current_title=Vanity Top Toilet Tissue Holder)
- Solid brass construction (source: current_description=Made of solid brass)
...
- Multiple finish options available (28 finish options including statement colors) (source: key_differentiators=Part of coordinated Vanity Top Accessories collection; 28 finish options including statement colors)
