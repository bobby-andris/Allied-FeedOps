...
**Generated:** 2026-01-28T02:39:36.830580
**Status:** APPROVED
...
**Title (79 chars):**
```
Towel Ring 6-Inch Solid Brass With Concealed Mount | Towel Rings | Allied Brass
```

**Description (863 chars):**
```
Keep a hand towel within easy reach and your vanity area looking pulled together with a clean, space-saving towel ring.

Highlights:
- Create an organized bathroom look with a compact 6-inch ring sized for decorative or daily-use hand towels
- Enjoy enduring, everyday performance with solid brass construction
- Maintain a crisp, finished appearance with concealed screw mounting hardware
- Coordinate your space with the Towel Rings collection for a cohesive set of versatile bath accessories
- Choose the look you want with multiple designer finish options available

Specs & Installation:
- Product type: Bathroom towel ring
- Material: Solid brass
- Mounting: Concealed screw, wall-mounted
- Diameter/overall dimensions (L x H x W): 6 x 6 x 6 inches
...
**Image URL:** https://cdn.shopify.com/s/files/1/0287/8658/9828/products/FT16-ABR.jpg?v=1616850527
...
| collection | Towel Rings | collection |
...
| gtin | 013895044394 | gtin |
| upc | 013895044394 | upc |
| main_image_url | https://cdn.shopify.com/s/files/1/0287/8658/9828/products/FT16-ABR.jpg?v=1616850527 | main_image_url |
| collection_context | Towel Rings (Unknown) - distinctive design | enrichment_collection |
...
| key_differentiators | Part of coordinated Towel Rings collection; 28 finish options including statement colors | enrichment_competitive |
| design_intent_keywords | towel rings collection, transitional bathroom hardware, versatile bath accessories | enrichment_keywords |
...
- Claim rejected: 'Six inches in diameter and dimensions are 6 x 6 x 6 inches.' - Claimed 'ideal six inches in diameter... Product dimensions, in. (LxHxW): 6x6x6' but actual value is 'The contemporary motif from this elegant collection has timeless appeal. Towel ring is constructed of solid brass and is an ideal six inches in diameter. It is ideal for displaying your favorite decorative towels or for providing the space for daily use. Made of the Finest Solid Brass Materials Concealed screw mounting hardware installs easily Available in a variety of designer finishes Assembled in the U.S.A. Specification & Documentation Product dimensions, in. (LxHxW): 6x6x6 Box dimensions, in. (LxHxW): 10x6x4 Shipping weight, lbs: 2 Installation Instruction Technical Specification FT16-Installation.PDF FT16-Specification.PDF'
...
- Product is a towel ring. (source: category=Towel Rings)
- Foxtrot Towel Ring name. (source: current_title=Foxtrot Towel Ring)
- Constructed of solid brass. (source: current_description=Towel ring is constructed of solid brass)
- Concealed screw mounting hardware. (source: current_description=Concealed screw mounting hardware installs easily)
- Available in a variety of designer finishes. (source: current_description=Available in a variety of designer finishes)
- Assembled in the U.S.A. (source: current_description=Assembled in the U.S.A.)
- Box dimensions are 10 x 6 x 4 inches and shipping weight is 2 lbs. (source: current_description=Box dimensions, in. (LxHxW): 10x6x4 Shipping weight, lbs: 2)
- Multiple designer finish options available. (source: finish_variety=Multiple designer finish options available)
- Concealed mounting hardware creates a clean, finished appearance. (source: feature_benefits=concealed mounting hardware creates a clean, finished appearance)
...
| 3 | 1 | 74.33% | 73.33% | 80.00% | 73.33% | bing_title must end with Allied Brass |
