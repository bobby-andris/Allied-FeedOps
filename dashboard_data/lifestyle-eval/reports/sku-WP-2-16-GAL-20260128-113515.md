...
**Generated:** 2026-01-28T11:35:15.472737
**Status:** APPROVED
...
**Title (87 chars):**
```
Glass Shelf 16-Inch Double With Gallery Rail Solid Brass | Waverly Place | Allied Brass
```

**Description (1092 chars):**
```
Get countertop-clearing storage right where you need it in the bathroom. This wall-mounted double glass shelf adds two levels of organization, with a gallery rail to keep items from sliding off.

Highlights:
- Keep daily essentials secure—gallery rail is designed to hold items in place
- Organize more in less space—double shelf design maximizes vertical storage
- Add strength and peace of mind—3/8-inch thick tempered glass
- Built for lasting installation—solid brass hardware with concealed screw mounting
- Fits real bathroom routines—ideal for perfumes, skincare, or guest toiletries

Specs & Installation:
- Glass dimensions (each shelf): 16 x 5 inches
- Overall size: 16 inches L x 5 inches W x 8 inches H; projection: 5 inches
- Weight capacity: 4 lb
- Materials: tempered glass shelf with brass hardware
- Mounting: wall mount; concealed screw hardware
- Assembly: not required
- In the box: glass shelf and all installation hardware (screw size: #8 x 1 1/4-inch)
- Designer finish options available to coordinate with transitional bath accessories in the Waverly Place collection.
```
...
- Product is a 16-inch double glass shelf with a gallery rail. (source: current_title=Waverly Place 16 Inch Double Glass Shelf with Gallery Rail)
- Glass is 3/8-inch thick tempered glass. (source: bullet_1=Made with 3/8-in thick tempered glass for safety and strength)
...
- Mounting uses concealed screw hardware and is wall mounted. (source: bullet_3=Concealed screw mounting hardware makes installation easy)
- Hardware material is brass. (source: material=Brass)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 76.67% | 76.67% | 80.00% | 73.33% |  |
| 2 | 2 | 80.00% | 80.00% | 80.00% | 80.00% | bing_title must end with Allied Brass |
| 3 | 1 | 76.17% | 76.67% | 70.00% | 80.00% | bing_title must end with Allied Brass |
