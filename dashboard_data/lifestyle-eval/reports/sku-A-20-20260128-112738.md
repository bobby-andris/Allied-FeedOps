...
**Generated:** 2026-01-28T11:27:38.463934
**Status:** APPROVED
...
```
Refresh your bathroom cabinetry with a distinctive pull that makes doors and drawers easier to open and ties the room together.

Highlights:
- Upgrade everyday usability with a 3 inch cabinet pull sized for comfortable grip
- Coordinate your space with a piece designed for the Cabinet Hardware collection
- Choose the look you want with multiple designer finish options available
- Count on lasting construction crafted from solid brass materials
- Install with confidence using included mounting hardware
...
A versatile choice for transitional bathroom hardware and other versatile bath accessories where small updates make a big visual difference.
```
...
- Product dimensions: 3.9 x 1.6 x 3 in. (L x H x W) (source: current_description=Product dimensions, in. (LxHxW): 3.9x1.6x3)
- Box dimensions: 3 x 3 x 3 in. (L x H x W) (source: current_description=Box dimensions, in. (LxHxW): 3x3x3)
- Shipping weight: 1 lb (source: current_description=Shipping weight, lbs: 1)
- Part of the Cabinet Hardware collection context (source: collection=Cabinet Hardware)
...
|------|----------:|---------:|-------:|-----:|--------:|-------------------|
| 1 | 0 | 82.33% | 83.33% | 73.33% | 86.67% |  |
| 2 | 1 | 80.50% | 80.00% | 80.00% | 83.33% |  |
| 3 | 2 | 75.17% | 76.67% | 63.33% | 80.00% | google_description missing 2 description term(s); found 1 |
