...
**Generated:** 2026-01-25T05:14:21.542944
**Status:** APPROVED
...
**Title (77 chars):**
```
Retractable hooks and garment rod 10-Inch Wall Mount Solid Brass Allied Brass
```

**Description (1049 chars):**
```
Add space-saving hanging storage with this retractable hooks and garment rod, designed to extend when you need it and retract when not in use. Crafted from solid brass with concealed screw mounting hardware for a clean, traditional look in bathrooms, laundry areas, and dressing spaces.

Highlights:
- Pullout rod extends to create a convenient place to hang garments or towels
- Retracts to help keep your wall area clear when not in use
- Wall-mount installation in an end wall or door frame
- Solid brass construction for enduring everyday use
- Concealed screw mounting hardware for a refined finish

Specs:
- Style: Traditional
- Material: Brass
- Mounting: Wall mount
- Size: 10-Inch projection; overall dimensions 10-Inch L x 2-Inch W x 1.9-Inch H
- Weight capacity: 10 lb
- Depth required to retract: 10 inches of wall depth
- Included: Brass rod, rod housing, and all installation hardware
- Assembly: No assembly required
- Finish options: Available in 28 designer finishes, including statement colors
...
| statement_finishes | venetian bronze, sea foam green, autumn sparkle, lavender, fire engine red | enrichment_finishes |
...
| design_intent_keywords | traditional bathroom hardware, classic bath accessories, heritage bathroom fixtures, wall mount, venetian bronze bathroom hardware, sea foam green bathroom hardware, autumn sparkle bathroom hardware, lavender bathroom hardware, fire engine red bathroom hardware, glokzin teal bathroom hardware | enrichment_keywords |
...
- Retractable pullout garment rod extends for hanging garments or towels and retracts when not in use. (source: current_description=Enjoy the convenience of this pull out garment rod in many places around your home. Rod installs in an end wall or door frame and retracts when not in use. When the rod is extended it provides a handy place to hang your garments or towels.)
...
- Wall-mount installation in an end wall or door frame. (source: bullet_3=Retractable rod installs easily in end wall or door frame)
- 10-inch projection and overall dimensions 10 in L x 2 in W x 1.9 in H. (source: projection=10 in)
- Weight capacity is 10 lb. (source: weight_capacity=10 lb)
- Includes brass rod, rod housing, and installation hardware. (source: included_items=Brass rod, rod housing and all installation hardware.)
...
| 2 | 0 | 88.50% | 90.00% | 83.33% | 86.67% | google_description missing 2 description term(s); found 1 |
| 3 | 1 | 86.17% | 86.67% | 83.33% | 86.67% | google_description missing description term in first 150 chars; google_description missing 2 description term(s); found 1; shopify_description missing description term in first 150 chars |
